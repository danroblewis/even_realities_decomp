...

{
  ...
  if (iVar1 == 0) {
    iVar1 = write_ble_uart_packet_extended_length_marker_type5(param_1,0xf);
    uVar2 = 0;
    if (((((iVar1 != 0) && (iVar1 = call_with_parameters(param_1,"image",5), iVar1 != 0)) &&
         (iVar1 = write_ble_uart_packet_32bit_unsigned(param_1,param_2 >> 1), iVar1 != 0)) &&
      ...
      if (((((iVar1 != 0) && (iVar1 = call_with_parameters(param_1,"hash",4), iVar1 != 0)) &&
           ((iVar1 = write_ble_uart_packet_string_with_validation(param_1,&local_64), iVar1 != 0 &&
            (((iVar1 = call_with_parameters(param_1,"bootable",8), iVar1 != 0 &&
              (iVar1 = write_ble_uart_packet_byte_with_type7_header
                                 (param_1,((local_68 ^ 0x10) << 0x1b) >> 0x1f), iVar1 != 0)) &&
             (iVar1 = call_with_parameters(param_1,"pending",7), iVar1 != 0)))))) &&
          ((iVar1 = write_ble_uart_packet_byte_with_type7_header(param_1,(param_3 << 0x1e) >> 0x1f),
           iVar1 != 0 && (iVar1 = call_with_parameters(param_1,"confirmed",9), iVar1 != 0)))) &&
         ((iVar1 = write_ble_uart_packet_byte_with_type7_header(param_1,(param_3 << 0x1d) >> 0x1f),
          iVar1 != 0 &&
          (((iVar1 = call_with_parameters(param_1,"active",6), iVar1 != 0 &&
            (iVar1 = write_ble_uart_packet_byte_with_type7_header(param_1,param_3 & 1), iVar1 != 0))
           && ((iVar1 = call_with_parameters(param_1,"permanent",9), iVar1 != 0 &&
               (iVar1 = write_ble_uart_packet_byte_with_type7_header
                                  (param_1,(param_3 << 0x1c) >> 0x1f), iVar1 != 0)))))))) {
        uVar2 = write_ble_uart_packet_extended_length_marker_type7(param_1,0xf);
      }
    }
    uVar2 = uVar2 & 1;
  }
