/*
 * Function: FUN_0005e6d4
 * Entry:    0005e6d4
 * Prototype: undefined FUN_0005e6d4()
 */


void FUN_0005e6d4(uint param_1,code *param_2,undefined4 param_3)

{
  ...
  if (param_2 == (code *)0x0) {
    ...
    FUN_0007e2ec("WEST_TOPDIR/zephyr/subsys/bluetooth/host/keys.c",0xa0);
  }
