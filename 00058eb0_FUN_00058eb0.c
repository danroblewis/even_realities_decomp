/*
 * Function: FUN_00058eb0
 * Entry:    00058eb0
 * Prototype: undefined FUN_00058eb0()
 */


undefined4 FUN_00058eb0(undefined4 param_1,undefined4 param_2,int param_3)
  ...
  if (iVar1 != 0) {
    ...
    if (piVar2 != (int *)0x0) {
      while( true ) {
        ...
        if (uStack_20 <= uVar4) {
          uVar3 = FUN_000585f0(piVar2,param_2,param_3);
          return uVar3;
        }
