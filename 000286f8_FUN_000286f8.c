/*
 * Function: FUN_000286f8
 * Entry:    000286f8
 * Prototype: undefined FUN_000286f8()
 */


void FUN_000286f8(undefined4 param_1)
...
LAB_0002884a:
      ...
      if (**(char **)(iVar1 + 0x100c) == '\x01') {
        uVar3 = get_work_mode();
        FUN_00027448(uVar3,0xe,0);
        FUN_0007cdb6(param_1,0);
      }
      else if (**(char **)(iVar1 + 0x100c) == '\x05') {
        uVar3 = get_work_mode();
        FUN_00027448(uVar3,0xf,0);
      }
    }
    if (DAT_20018d97 != '\0') {
      FUN_0007cb8e(2000);
