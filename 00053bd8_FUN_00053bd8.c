/*
 * Function: FUN_00053bd8
 * Entry:    00053bd8
 * Prototype: undefined FUN_00053bd8()
 */
...

{
  ...
  uVar6 = FUN_00056908((uint)uVar1,1);
  ...
  if (iVar2 == 0) {
    ...
    FUN_00080ea2(&DAT_00088138,0x1840,&local_30);
    return;
  }
  piVar5 = (int *)(iVar2 + 4);
  if (*pcVar4 == '\x1a') {
    if (*(char *)(iVar2 + 3) == '\x01') {
      uVar6 = FUN_00080e6a(piVar5,0x400);
      uVar3 = (undefined4)((ulonglong)uVar6 >> 0x20);
      if (-1 < (int)uVar6 << 0x15) {
