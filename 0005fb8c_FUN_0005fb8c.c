/*
 * Function: FUN_0005fb8c
 * Entry:    0005fb8c
 * Prototype: undefined FUN_0005fb8c()
 */


uint FUN_0005fb8c(int param_1,undefined4 param_2)
    ...
    if (*(char *)(iVar2 + 0x51) == '\0') {
      ...
      *(undefined1 *)((int)puVar3 + 0x51) = 1;
      if (-1 < (int)((uint)*(byte *)(puVar3 + 0x14) << 0x1f)) {
        uVar1 = FUN_0005fb30(puVar3);
        return uVar1 & (int)uVar1 >> 0x1f;
      }
      puVar3[4] = 0;
      puVar3[2] = &LAB_000837a8_1;
      puVar3[3] = 3;
      iStack_38 = FUN_0004b908(*puVar3,puVar3 + 1);
      if (iStack_38 < 0) {
