    ...
    case 0:
      ...
      case (char *)0x6:
        if (*(char *)(conn_handle + 0xc) != '\0') {
          validate_and_process_ble_characteristics_with_callback_execution_and_parameter
                    (conn_handle);
        }
      case (char *)0x3:
      case (char *)0x4:
      ...
      do {
        ...
        if (*(int *)(conn_handle + 0x1c) == 0) {
          ...
          *(undefined4 *)(conn_handle + 0x1c) = uVar5;
          ...
          InstructionSynchronizationBarrier(0xf);
          validate_and_process_ble_characteristics_with_validation_and_state_management
                    (conn_handle,puVar4,uVar5,uVar3);
        }
        else {
