/*
 * Function: FUN_0004e2b4
 * Entry:    0004e2b4
 * Prototype: undefined FUN_0004e2b4(undefined param_1, undefined param_2, undefined param_3, undefined param_4, undefined4 param_5, undefined param_6, undefined4 param_7)
 */


undefined4
FUN_0004e2b4(int *param_1,int param_2,int param_3,uint param_4,uint param_5,int param_6,int param_7)

{
  ...
  if (((param_1 != (int *)0x0) && (param_2 != 0)) && (param_3 != 0)) {
    ...
    local_28 = 2;
    FUN_0004d944(&DAT_000880d8,0x1040,&local_28,0);
  }
  return 0xfffffff2;
}
