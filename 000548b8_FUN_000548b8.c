/*
 * Function: FUN_000548b8
 * Entry:    000548b8
 * Prototype: undefined FUN_000548b8()
 */
...

{
  ...
  local_48 = 0x1000006;
  local_3c = (char *)uVar2;
  FUN_00080ea2(&DAT_00088138,0x34c0,&local_48);
  uVar2 = (uint)DAT_20002071;
  pcStack_38 = (char *)FUN_00053344(uVar2);
  local_30 = (uint)DAT_20002074;
  local_3c = "LMP: version %s (0x%02x) subver 0x%04x";
  local_2c = 0x200;
  local_40 = 0x1000005;
  local_34 = uVar2;
  FUN_00080ea2(&DAT_00088138,0x2cc0,&local_40);
  return;
}
