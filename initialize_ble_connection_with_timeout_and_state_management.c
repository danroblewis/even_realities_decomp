/*
 * Function: initialize_ble_connection_with_timeout_and_state_management
 * Entry:    000730e8
 * Prototype: undefined initialize_ble_connection_with_timeout_and_state_management(undefined param_1, undefined param_2, undefined param_3, undefined param_4, undefined4 param_5)
 */


void initialize_ble_connection_with_timeout_and_state_management
...

{
    ...
    if ((*(uint *)(param_1 + 0xf0) & 1) == 0) {
      ...
      *(undefined4 *)(param_1 + 0xf0) = uVar1;
      ...
      if ((param_5 != (int *)0x0) && (*param_5 != 0)) {
        get_ble_uart_protocol_error_code(param_1);
      }
  ...
  trigger_system_service_call("WEST_TOPDIR/zephyr/kernel/work.c",uVar1);
}
