/*
 * Function: cleanup_ble_connection_state_complete
 * Entry:    000742b4
 * Prototype: undefined cleanup_ble_connection_state_complete()
 */


void cleanup_ble_connection_state_complete
...

{
  ...
  if (iVar3 == 0) {
    ...
    if (*(int *)(param_1 + 8) != 0) {
      remove_ble_connection_from_active_list(param_1);
    }
