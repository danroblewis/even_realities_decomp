/*
 * Function: FUN_0004e6a8
 * Entry:    0004e6a8
 * Prototype: undefined FUN_0004e6a8()
 */


int FUN_0004e6a8(int param_1,undefined4 param_2,undefined4 param_3,undefined4 param_4)

{
  ...
  while( true ) {
    if (&PTR_LAB_00051fd8_1_00088328 < ppuVar3) {
      ...
      FUN_0007e2ec("WEST_TOPDIR/zephyr/subsys/settings/src/settings.c",0xf4);
    }
