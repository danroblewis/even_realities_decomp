/*
 * Function: FUN_00052d58
 * Entry:    00052d58
 * Prototype: undefined FUN_00052d58()
 */


undefined4 FUN_00052d58(int param_1,undefined4 param_2,code *param_3,undefined4 param_4)

{
  ...
  if (DAT_200020d4 << 0x1f < 0) {
    if (param_1 == 0) {
      ...
      local_28 = 2;
      FUN_0004d944(&DAT_00088178,0x1040,&local_28,0);
      return 0xfffffffe;
    }
    ...
    if (iVar3 == 0) {
      ...
      if (DAT_200020d4 << 0x1c < 0) {
        ...
        local_28 = 2;
        FUN_0004d944(&DAT_00088178,0x1080,&local_28);
      }
      else {
        ...
        if (uVar4 < 7) {
          ...
          local_28 = 2;
          FUN_0004d944(&DAT_00088178,0x1040,&local_28,uVar5 >> 0x1f);
      ...
      if (iStack_48 < 0) {
        ...
        local_50 = 3;
        FUN_0004d944(&DAT_00088178,0x1840,&local_50,0);
      }
      else {
