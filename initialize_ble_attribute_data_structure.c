/*
 * Function: initialize_ble_attribute_data_structure
 * Entry:    0005c3c4
 * Prototype: undefined initialize_ble_attribute_data_structure()
 */


int initialize_ble_attribute_data_structure(int param_1,int *param_2)
...
LAB_0005c3e4:
  ...
  puVar2 = (undefined1 *)find_ble_characteristic_by_handle();
  ...
  iVar3 = initialize_ble_attribute_data(param_1,param_2);
  if (iVar3 != 0) {
    if (*(int *)(puVar2 + 8) != 0) {
      return iVar3;
    }
    initialize_ble_characteristic_value_buffer(puVar2);
    return iVar3;
  }
LAB_0005c4ae:
