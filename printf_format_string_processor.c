/*
 * Function: printf_format_string_processor
 * Entry:    00076ed4
 * Prototype: undefined printf_format_string_processor()
 */


/* WARNING: Removing unreachable block (ram,0x0007707c) */

int printf_format_string_processor(int param_1,undefined *param_2,byte *param_3,uint *param_4)

{
  ...
  if (((-1 < (int)((uint)*(ushort *)(param_2 + 0xc) << 0x1c)) || (*(int *)(param_2 + 0x10) == 0)) &&
     (iVar1 = handle_buffer_status_with_memory_allocation_and_validation(param_1,param_2),
     iVar1 != 0)) {
    if ((-1 < *(int *)(param_2 + 100) << 0x1f) &&
       (-1 < (int)((uint)*(ushort *)(param_2 + 0xc) << 0x16))) {
...
LAB_000770da:
    ...
    if (iVar1 == 0) {
      iVar1 = format_integer_for_printf_with_padding(param_1,&local_88,param_2,0x86cb7,&local_8c);
    }
    else {
      iVar1 = format_float_for_printf_with_precision(param_1,&local_88,param_2,0x86cb7,&local_8c);
    }
