...

{
  ...
  if (HARDWARE_CONFIGURATION_AND_INTERRUPT_MANAGER == '\x03') {
    HARDWARE_INTERRUPT_COMPLETION_BUFFER = 2;
  }
  else {
    if (HARDWARE_CONFIGURATION_AND_INTERRUPT_MANAGER == '\x04') {
      HARDWARE_INTERRUPT_COMPLETION_BUFFER = 3;
    ...
    HARDWARE_INTERRUPT_COMPLETION_BUFFER = 1;
  }
...
LAB_00066cd8:
  ...
  HARDWARE_INTERRUPT_COMPLETION_BUFFER = 0;
  return;
}
