/*
 * Function: FUN_0004d594
 * Entry:    0004d594
 * Prototype: undefined FUN_0004d594()
 */
...

{
  ...
  if (iVar1 != 0) {
    ...
    while( true ) {
      if (&DAT_000882b0 < puVar4) {
        ...
        FUN_0007e2ec("WEST_TOPDIR/zephyr/subsys/logging/log_core.c",0x1c5);
      }
  ...
  if (0 < DAT_2000a0d4) {
    ...
    if (uVar2 != 0 || uVar2 < bVar5) {
      FUN_0004d4a8(DAT_200056a4,uVar2 - !bVar5);
    }
  }
