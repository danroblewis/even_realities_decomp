        ...
        if (iVar3 == 0) {
          ...
          if (iVar4 < 0) {
            ...
            if ((uint)(param_6 - param_4) < uVar18) {
              ...
              FUN_0007d53a(DAT_2000a034,local_2cc,iVar4,iVar1,local_2f0,uVar8 + param_5);
              iVar3 = FUN_00043e58(*puVar16,*puVar17);
              uVar11 = local_2d4 + iVar3;
              uVar18 = uVar11;
            }
            else {
              FUN_0007d53a(DAT_2000a034,local_2cc,iVar4,iVar1,local_2f0 + uVar11,uVar8 + param_5);
              iVar3 = FUN_00043e58(*puVar16,*puVar17);
