...

{
  ...
  if (iVar2 == 0) {
    ...
    if (iVar2 == 0) {
      ...
      iVar2 = FUN_00058eb0(param_1,0x1b,*(ushort *)(param_3 + 0xc) + 2);
      if (iVar2 != 0) {
        ...
        *puVar4 = param_2;
        ...
        if (param_1 == 0) {
          ...
          if (iVar2 != 0) {
            iVar1 = FUN_0005858c();
            if (iVar1 == 0) {
              FUN_0005833c(*(undefined4 *)(iVar2 + 0x18));
              FUN_0005f24c(iVar2);
              uVar3 = 0xffffff80;
            }
            else {
...
LAB_00059a5a:
        ...
        FUN_0007e2ec("WEST_TOPDIR/zephyr/subsys/bluetooth/host/att.c",uVar3);
      }
