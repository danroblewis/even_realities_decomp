/*
 * Function: calculate_audio_buffer_size_by_sample_rate
 * Entry:    00068ecc
 * Prototype: undefined calculate_audio_buffer_size_by_sample_rate()
 */


int calculate_audio_buffer_size_by_sample_rate(int param_1,int param_2)
