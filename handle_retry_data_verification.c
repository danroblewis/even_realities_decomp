/*
 * Function: handle_retry_data_verification
 * Entry:    00022834
 * Prototype: undefined handle_retry_data_verification()
 */


int handle_retry_data_verification(undefined4 param_1,undefined4 param_2,undefined4 param_3)
