...

{
  ...
  local_38 = 0;
  uVar21 = 0;
  iVar4 = FUN_0000ef12(&LAB_000aa08e_1);
...
LAB_00013f9a:
  ...
  if (*local_3c == 0x30) {
    if ((local_3c[1] & 0xdf) == 0x58) {
      uVar5 = FUN_00078110(puVar3,&local_3c,&DAT_00098754,&local_34,&local_38,local_64,&DAT_20002d84
                          );
      uVar5 = uVar5 & 7;
      if (uVar5 != 0) {
        if (uVar5 == 6) {
        ...
        if (local_38 != 0) {
          FUN_00087648(local_30,0x35);
          FUN_00078654(puVar3,local_38);
        }
        switch(uVar5) {
        case 1:
        case 5:
...
LAB_0001422c:
    ...
    if (uVar5 != 0x69) {
      ...
      if ((!bVar22) || (iVar4 = FUN_0008738e(&local_3c,&DAT_000bba18), iVar4 == 0)) {
LAB_00013ff6:
        if (param_2 == (undefined4 *)0x0) {
          return 0;
        }
      ...
      if ((*local_3c != 0x28) ||
         (iVar4 = FUN_000873b6(&local_3c,&DAT_00098740,local_30), uVar21 = local_30[0], iVar4 != 5))
      {
        uVar21 = FUN_00013e50(&LAB_000a8ea0);
      }
      goto LAB_00014036;
    }
LAB_00014292:
    iVar4 = FUN_0008738e(&local_3c,"nf");
    if (iVar4 == 0) goto LAB_00013ff6;
    local_3c = local_3c + -1;
    iVar4 = FUN_0008738e(&local_3c,"inity");
    if (iVar4 == 0) {
      local_3c = local_3c + 1;
    }
  }
...
LAB_000142f2:
      ...
      if ((int)uVar5 < 0x17) {
        ...
        iVar16 = 0xf - iVar16;
        uVar26 = FUN_0000d8f8((&DAT_00088908)[iVar16 * 2],(&DAT_0008890c)[iVar16 * 2],uVar21,uVar24)
        ;
        uVar25 = *(ulonglong *)(&DAT_00088908 + (uVar5 - iVar16) * 2);
      }
      uVar21 = FUN_0000d8f8((int)uVar26,(int)((ulonglong)uVar26 >> 0x20),(int)uVar25,
                            (int)(uVar25 >> 0x20));
      goto LAB_00014036;
    }
    uVar26 = FUN_0000d8f8((int)uVar25,(int)(uVar25 >> 0x20),
                          *(undefined4 *)(&UNK_000888c0 + iVar15 * 8),
                          *(undefined4 *)(&UNK_000888c4 + iVar15 * 8));
    uVar29 = FUN_0000d804(iVar19);
    uVar25 = FUN_0000d58c((int)uVar26,(int)((ulonglong)uVar26 >> 0x20),(int)uVar29,
...
LAB_0001437e:
        ...
        do {
          if ((int)(uVar21 << 0x1f) < 0) {
            uVar27 = FUN_0000d8f8((int)uVar27,(int)(uVar27 >> 0x20),*puVar20,puVar20[1]);
            bVar22 = true;
          }
          uVar21 = (int)uVar21 >> 1;
          puVar20 = puVar20 + 2;
        ...
        iVar19 = FUN_0000ddc8((int)uVar25,(int)(uVar25 >> 0x20),0,0);
        if (iVar19 != 0) goto LAB_0001437e;
      }
      iVar19 = FUN_00078728(puVar3,local_70,local_84,iVar16,local_80);
      if (iVar19 != 0) {
        iVar6 = iVar6 - iVar4;
        if (-1 < (int)uVar5) {
          iVar6 = 0;
        ...
        while( true ) {
          ...
          uVar21 = (uint)uVar25;
          local_80 = FUN_000785d4(puVar3,*(undefined4 *)(iVar19 + 4));
          if (local_80 == 0) break;
          memcpy(local_80 + 0xc,iVar19 + 0xc,(*(int *)(iVar19 + 0x10) + 2) * 4);
          local_38 = FUN_00078ce0(uVar21,puVar3,&local_34,local_30);
          if (local_38 == 0) break;
          local_84 = FUN_000787bc(puVar3,1);
          if (local_84 == 0) {
LAB_000145b8:
            local_84 = 0;
            break;
          ...
          if (0 < iVar6) {
            local_84 = FUN_0007893c(puVar3,local_84,iVar6);
            if (local_84 == 0) goto LAB_000145b8;
            iVar7 = FUN_000787e8(puVar3,local_84,local_38);
            if (iVar7 == 0) break;
            FUN_00078654(puVar3,local_38);
            local_38 = iVar7;
          }
          if ((0 < iVar15) && (local_38 = FUN_000789f0(puVar3,local_38,iVar15), local_38 == 0))
          break;
          if (((0 < (int)uVar5) && (local_80 = FUN_0007893c(puVar3,local_80,uVar11), local_80 == 0))
             || ((0 < iVar16 && (local_80 = FUN_000789f0(puVar3,local_80,iVar16), local_80 == 0))))
          {
            local_80 = 0;
            break;
          }
          if (((0 < iVar4) && (local_84 = FUN_000789f0(puVar3,local_84,iVar4), local_84 == 0)) ||
             (local_7c = FUN_00078ac8(puVar3,local_38,local_80), local_7c == 0)) break;
          iVar16 = *(int *)(local_7c + 0xc);
          *(undefined4 *)(local_7c + 0xc) = 0;
          iVar4 = FUN_000875ae(local_7c,local_84);
          if (iVar4 < 0) {
            if (((iVar16 == 0 && uVar21 == 0) && ((uVar25 & 0xfffff00000000) == 0)) &&
               ((0x6b00000 < (uVar14 & 0x7ff00000) &&
                ((*(int *)(local_7c + 0x14) != 0 || (1 < *(int *)(local_7c + 0x10))))))) {
              local_7c = FUN_000789f0(puVar3,local_7c,1);
              iVar4 = FUN_000875ae(local_7c,local_84);
...
LAB_000147f8:
            lVar28 = FUN_0000d8f8((int)uVar25,(int)(uVar25 >> 0x20),0,0x39500000);
            uVar21 = (uint)lVar28;
            if (lVar28 == 0) {
LAB_00014772:
              *puVar3 = 0x22;
...
LAB_0001483a:
              ...
              uVar24 = FUN_000870ea(uVar21,uVar14,local_88);
              uVar25 = FUN_0000d588(uVar21,uVar14,uVar24,extraout_s1_00);
              iVar4 = FUN_0000ddc8((int)uVar25,(int)(uVar25 >> 0x20),0,0);
...
LAB_0001486c:
            uVar24 = FUN_000870ea(uVar21,uVar14,local_88);
            uVar25 = FUN_0000d58c(uVar21,uVar14,uVar24,extraout_s1);
            goto LAB_00014886;
          }
          uVar24 = FUN_000875e4(local_7c,local_84);
          iVar4 = FUN_0000ddf0(uVar24,extraout_s1_01,0,0x40000000);
          if (iVar4 == 0) {
            uVar26 = FUN_0000d8f8(uVar24,extraout_s1_01,0,0x3fe00000);
...
LAB_0001493a:
            ...
            if (uVar21 == 0) {
              if ((uVar25 & 0xfffff00000000) == 0) {
                iVar4 = FUN_0000dddc(uVar24,extraout_s1_01,0,0x3ff00000);
                if (iVar4 == 0) {
                  uVar26 = FUN_0000d8f8(uVar24,extraout_s1_01,0,0x3fe00000);
                }
                else {
          ...
          if (uVar18 == 0x7fe00000) {
            uVar24 = FUN_00078bf8(uVar21);
            uVar29 = FUN_0000d8f8(uVar24,extraout_s1_02,local_78,iStack_74);
            uVar29 = FUN_0000d58c((int)uVar29,(int)((ulonglong)uVar29 >> 0x20),uVar21,
                                  uVar14 + 0xfcb00000);
            ...
            if ((local_88 != 0) && (uVar18 < 0x6a00001)) {
              iVar15 = FUN_0000ddf0(local_78,iVar4,0xffc00000,0x41dfffff);
              if (iVar15 != 0) {
                iVar4 = FUN_0000dea8(local_78,iVar4);
                if (iVar4 == 0) {
                  iVar4 = 1;
                }
                uVar29 = FUN_0000d804(iVar4);
            ...
            uVar24 = FUN_00078bf8(uVar21);
            uVar29 = FUN_0000d8f8((int)uVar26,iStack_74,uVar24,extraout_s1_03);
            uVar25 = FUN_0000d58c((int)uVar29,(int)((ulonglong)uVar29 >> 0x20),uVar21,uVar14);
LAB_00014a44:
            uVar21 = (uint)uVar25;
            uVar24 = (undefined4)((ulonglong)uVar26 >> 0x20);
            if ((local_88 == 0) && (uVar18 == ((uint)(uVar25 >> 0x20) & 0x7ff00000))) {
              FUN_0000ec34((int)uVar26,uVar24);
              uVar29 = float_divide_64bit();
              uVar26 = FUN_0000d588((int)uVar26,uVar24,(int)uVar29,(int)((ulonglong)uVar29 >> 0x20))
              ;
              uVar8 = (undefined4)((ulonglong)uVar26 >> 0x20);
              uVar24 = (undefined4)uVar26;
              if (((uVar25 & 0xfffff00000000) == 0 && uVar21 == 0) && iVar16 == 0) {
                iVar4 = FUN_0000dddc(uVar24,uVar8,0x94a03595,0x3fcfffff);
              }
              else {
                iVar4 = FUN_0000dddc(uVar24,uVar8,0x94a03595,0x3fdfffff);
                if (iVar4 != 0) goto LAB_0001441e;
                iVar4 = FUN_0000de18(uVar24,uVar8,0x35afe535,0x3fe00000);
              }
              if (iVar4 != 0) goto LAB_0001441e;
            }
          }
          FUN_00078654(puVar3,local_38);
          FUN_00078654(puVar3,local_80);
          FUN_00078654(puVar3,local_84);
          FUN_00078654(puVar3,local_7c);
        }
        uVar21 = 0;
        *puVar3 = 0x22;
LAB_0001441e:
...
LAB_0001439c:
      uVar11 = uVar21 & 0xf;
      if (uVar11 != 0) {
        uVar25 = FUN_0000d8f8((&DAT_00088908)[uVar11 * 2],(&DAT_0008890c)[uVar11 * 2],(int)uVar25,
                              (int)(uVar25 >> 0x20));
      }
      ...
      if ((int)(uVar21 & 0xfffffff0) < 0x135) {
        ...
        uVar26 = FUN_0000d8f8((&DAT_000888e0)[local_88 * 2],(&DAT_000888e4)[local_88 * 2],
                              (int)uVar25,(int)(uVar25 >> 0x20) + -0x3500000);
