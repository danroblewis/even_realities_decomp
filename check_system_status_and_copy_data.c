/*
 * Function: check_system_status_and_copy_data
 * Entry:    00036ed8
 * Prototype: undefined check_system_status_and_copy_data()
 */


void check_system_status_and_copy_data(void)
