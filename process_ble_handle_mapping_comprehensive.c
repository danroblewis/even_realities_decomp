/*
 * Function: process_ble_handle_mapping_comprehensive
 * Entry:    0005aa84
 * Prototype: undefined process_ble_handle_mapping_comprehensive(undefined param_1, undefined param_2, undefined param_3, undefined param_4, undefined2 param_5, undefined4 param_6, undefined4 param_7)
 */


void process_ble_handle_mapping_comprehensive
               (uint param_1,undefined4 param_2,undefined4 param_3,undefined4 param_4,short param_5,
...

{
  ...
  if (param_1 <= DAT_2000ff3c) {
    piVar3 = &BT_CONNECTION_CALLBACK_LIST_END;
    uVar6 = 1;
    while( true ) {
