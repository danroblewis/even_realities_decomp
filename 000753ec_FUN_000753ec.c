/*
 * Function: FUN_000753ec
 * Entry:    000753ec
 * Prototype: undefined FUN_000753ec()
 */


void FUN_000753ec(int param_1,int param_2,undefined4 param_3)
...
switchD_00075418_caseD_0:
    iVar7 = FUN_0007205c(&DAT_2000b4a0);
    if (iVar7 == 0) {
...
LAB_000754e4:
    ...
    InstructionSynchronizationBarrier(0xf);
    iVar7 = FUN_00072040(&DAT_2000b4a0);
    param_2 = param_2 + -1;
    if (iVar7 == 0) {
      DEBUG_PRINT2("ASSERTION FAIL [%s] @ %s:%d\n","z_spin_lock_valid(l)",
