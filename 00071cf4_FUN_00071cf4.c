/*
 * Function: FUN_00071cf4
 * Entry:    00071cf4
 * Prototype: undefined FUN_00071cf4()
 */


void FUN_00071cf4(int param_1,undefined4 *param_2)

{
  ...
  if (iVar2 == 0) {
    ...
    if ((*(int *)(param_1 + 0x18) == 0) && (iVar2 = FUN_000744a4(param_1), iVar2 != 0)) {
