/*
 * Function: handle_ble_characteristic_read_request
 * Entry:    0005c22c
 * Prototype: undefined handle_ble_characteristic_read_request()
 */


undefined4 handle_ble_characteristic_read_request(int param_1,int *param_2)
