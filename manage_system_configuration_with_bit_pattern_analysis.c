/*
 * Function: manage_system_configuration_with_bit_pattern_analysis
 * Entry:    0007a720
 * Prototype: undefined manage_system_configuration_with_bit_pattern_analysis(undefined param_1, undefined param_2, undefined param_3, undefined param_4, undefined4 param_5, undefined4 param_6)
 */
...
int manage_system_configuration_with_bit_pattern_analysis
              (uint *param_1,int param_2,int param_3,int *param_4,uint *param_5,int param_6,
              int param_7)

{
  ...
  *param_5 = 0;
  if (param_3 == 0) {
    iVar1 = configure_system_with_parameter_validation_and_state_management
                      (param_1,param_2,1,&local_48,param_7);
  ...
  do {
    *param_5 = local_50;
    if (local_50 == 0) {
LAB_0007a954:
      iVar1 = analyze_bit_pattern_with_sequence_detection
                        (param_6,local_50,*(undefined4 *)(param_2 + 0x14));
      if ((iVar1 == 0) &&
         (iVar1 = analyze_bit_pattern_with_threshold_validation
                            (param_6,local_50,*(undefined4 *)(param_2 + 0x18),0x400), iVar1 == 0))
      break;
      *param_5 = 0;
    }
    else {
      uVar3 = 0;
      reset_sha256_context_state_with_system_parameter_updates();
      iVar4 = param_6;
      uVar2 = local_50;
      if (param_1 != (uint *)0x0) {
        while (param_2 != 0) {
          ...
          iVar1 = validate_sha256_parameter_with_bit_manipulation(param_2,&local_48);
          if ((iVar1 != 0) ||
             (iVar1 = select_sha256_parameter_with_switch_logic(local_48,param_2), iVar1 != 0))
          goto LAB_0007a7ba;
          if (local_48 == 8) {
            _DAT_5084510c = 3;
          }
