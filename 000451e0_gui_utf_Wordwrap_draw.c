...

{
  ...
  local_302 = 0;
  local_300 = 0;
  puVar3 = (ushort *)FUN_000478d8(param_2,&local_302);
  local_2fc = 0;
  local_2f8 = 0;
  if (param_10 == 0) {
...
LAB_00045458:
                  ...
                  for (local_314 = uVar18; (int)local_314 <= (int)uVar16; local_314 = local_314 + 1)
                  {
                    ...
                    if (iVar4 == 0) {
                      iVar4 = FUN_00043e58(*puVar5,puVar5[1]);
...
LAB_00045314:
            iVar4 = FUN_00043e58(*puVar17,puVar17[1]);
            ...
            if (uVar9 < uVar15) {
              ...
              FUN_0007d53a(DAT_2000a034,local_2cc,local_2fc / 2,local_2f8,param_4,uVar12 + param_5);
              iVar4 = FUN_00043e58(*puVar17,puVar17[1]);
              uVar15 = iVar4 + local_2fc;
              uVar19 = uVar15;
            }
            else {
              FUN_0007d53a(DAT_2000a034,local_2cc,local_2fc / 2,local_2f8,param_4 + uVar19,
                           uVar12 + param_5);
              iVar4 = FUN_00043e58(*puVar17,puVar17[1]);
