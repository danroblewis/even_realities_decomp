/*
 * Function: configure_device_memory_parameters
 * Entry:    00062ad8
 * Prototype: undefined configure_device_memory_parameters()
 */


undefined4 configure_device_memory_parameters(int param_1,undefined4 *param_2)
...
LAB_00062b02:
  ...
  if (pcVar4 == (char *)0x9600) {
    ...
    if (pcVar4 == (char *)&POINTER_TO_4007FE5_DATA) {
      pcVar4 = (char *)0x13a9000;
    }
    else if (&POINTER_TO_4007FE5_DATA < pcVar4) {
