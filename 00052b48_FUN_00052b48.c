/*
 * Function: FUN_00052b48
 * Entry:    00052b48
 * Prototype: undefined FUN_00052b48()
 */
...
LAB_0005ad5c:
    ...
    FUN_0007e2ec("WEST_TOPDIR/zephyr/subsys/bluetooth/host/gatt.c",uVar6);
  }
  if (DAT_200028bc == 0) {
    DEBUG_PRINT2("ASSERTION FAIL [%s] @ %s:%d\n","svc->attr_count",
  ...
  local_44[0] = 0;
  local_42 = 0x1800;
  iVar3 = FUN_00080d3e(*DAT_200028b8,local_44);
  if (iVar3 == 0) {
    return 0xffffff88;
  }
  local_40._0_2_ = (ushort)local_40 & 0xff00;
  local_40 = CONCAT22(0x1801,(ushort)local_40);
  iVar3 = FUN_00080d3e(*DAT_200028b8,&local_40);
  if (iVar3 == 0) {
    return 0xffffff88;
  }
  FUN_00073b1c();
