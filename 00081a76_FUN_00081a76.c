/*
 * Function: FUN_00081a76
 * Entry:    00081a76
 * Prototype: undefined FUN_00081a76()
 */


void FUN_00081a76(undefined4 param_1,int param_2,int param_3)

{
  ...
  FUN_000573ac(param_2);
  if (param_3 == 0) {
    iVar2 = FUN_00081a4e(param_1,uVar1);
    if (iVar2 != 0) {
