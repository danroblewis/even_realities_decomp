/*
 * Function: validate_data_structures_and_calculate_offset
 * Entry:    0007f460
 * Prototype: undefined validate_data_structures_and_calculate_offset()
 */


int validate_data_structures_and_calculate_offset
