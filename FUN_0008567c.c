/*
 * Function: FUN_0008567c
 * Entry:    0008567c
 * Prototype: undefined FUN_0008567c(undefined param_1, undefined param_2, undefined param_3, undefined param_4, undefined4 param_5)
 */


undefined4 FUN_0008567c(int param_1,int param_2,int param_3,int param_4,undefined4 param_5)

{
  ...
  *(short *)(iVar7 + 0x38) = (short)param_4;
  ...
  for (iVar10 = 0; iVar10 < param_4; iVar10 = iVar10 + 1) {
    ...
    uVar3 = FUN_000855e6(piVar2,uVar4);
