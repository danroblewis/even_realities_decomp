/*
 * Function: FUN_00055734
 * Entry:    00055734
 * Prototype: undefined FUN_00055734(undefined param_1, undefined param_2, undefined param_3, undefined param_4, undefined4 param_5, undefined4 param_6)
 */


int FUN_00055734(undefined1 *param_1,int param_2,undefined4 param_3,undefined4 param_4,int param_5,
                undefined4 param_6)

{
  ...
  *param_1 = DAT_2000206f;
  iVar6 = FUN_00055454(param_1,*(undefined4 *)(puVar3 + 4),iVar6,(int)&local_4c + 1);
  if (iVar6 != 0) {
    return iVar6;
  }
  if (iVar8 == 0) {
...
LAB_000557f6:
  ...
  if ((*(int *)(puVar3 + 4) << 0x1f < 0) && (iVar2 = FUN_000556b0(param_1,&local_54), iVar2 != 0)) {
    if (iVar2 != -0xc) {
      return iVar2;
    }
    if (iVar8 != 0) {
