/*
 * Function: FUN_000531d8
 * Entry:    000531d8
 * Prototype: undefined FUN_000531d8()
 */


undefined4 FUN_000531d8(int param_1,undefined4 param_2,int param_3,int param_4)

{
  ...
  puVar7 = &DAT_20005d38;
  puStack_1c = &DAT_20005d38;
  iStack_18 = param_3;
  if (param_1 == 0) {
    DEBUG_PRINT2("ASSERTION FAIL [%s] @ %s:%d\n","dwork != ((void *)0)",
                 "WEST_TOPDIR/zephyr/kernel/work.c",0x3de,&DAT_20005d38);
    uVar6 = 0x3de;
