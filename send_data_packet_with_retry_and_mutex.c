/*
 * Function: send_data_packet_with_retry_and_mutex
 * Entry:    000256dc
 * Prototype: undefined send_data_packet_with_retry_and_mutex()
 */


int send_data_packet_with_retry_and_mutex
...

{
  ...
  if (param_4 == 0) {
    ...
    while( true ) {
      ...
      param_1 = param_4;
      iVar1 = format_and_send_data_packet(iVar3,*(undefined2 *)(iVar3 + 8),param_2,param_3);
      mutex_unlock(uVar5);
      if (iVar1 == 0) break;
      iVar4 = iVar4 + -1;
      if (iVar4 == 0) {
