/*
 * Function: FUN_00056f4c
 * Entry:    00056f4c
 * Prototype: undefined FUN_00056f4c()
 */


undefined4 FUN_00056f4c(int param_1,undefined1 *param_2)

{
  ...
  *param_2 = *(undefined1 *)(param_1 + 2);
  ...
  if (8 < uVar5) {
    ...
    FUN_0007e2ec("WEST_TOPDIR/zephyr/subsys/bluetooth/host/conn.c",0x9b0);
  }
