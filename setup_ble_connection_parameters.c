/*
 * Function: setup_ble_connection_parameters
 * Entry:    00081adc
 * Prototype: undefined setup_ble_connection_parameters()
 */


int setup_ble_connection_parameters(undefined4 param_1,undefined4 param_2)

{
  ...
  if (iVar1 == 0) {
    ...
    *puVar2 = *puVar4;
    ...
    puVar2[2] = puVar4[2];
    puVar2[3] = puVar4[3];
    iVar3 = handle_ble_connection_state_transition_with_validation(param_1,5,iVar1,0,0,param_2);
    if (iVar3 != 0) {
