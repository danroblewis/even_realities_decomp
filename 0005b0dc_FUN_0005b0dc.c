/*
 * Function: FUN_0005b0dc
 * Entry:    0005b0dc
 * Prototype: undefined FUN_0005b0dc()
 */


bool FUN_0005b0dc(int param_1,undefined4 *param_2,uint param_3,undefined4 param_4)
  ...
  if (param_1 == 0) {
    ...
    if (param_2 != (undefined4 *)0x0) {
      if (*(char *)(param_1 + 0xd) == '\a') {
        ...
        iVar2 = FUN_00080d3e(*param_2,&local_1c);
        if (iVar2 == 0) {
          if ((*(byte *)(param_2[3] + 6) & 0x30) == 0) {
            return false;
          }
          param_2 = (undefined4 *)FUN_0005b0b8(param_2);
          if (param_2 == (undefined4 *)0x0) {
            DEBUG_PRINT2("ASSERTION FAIL [%s] @ %s:%d\n","attr",
        ...
        iVar2 = FUN_00080d3e(*param_2,&local_1c);
        if ((iVar2 != 0) &&
           (param_2 = (undefined4 *)FUN_0005b0b8(param_2), param_2 == (undefined4 *)0x0)) {
          DEBUG_PRINT2("ASSERTION FAIL [%s] @ %s:%d\n","attr",
        ...
        do {
          ...
          iVar2 = FUN_00080d3e(*param_2,&local_28);
          if (iVar2 == 0) {
LAB_0005b1ca:
            local_1c._0_2_ = (ushort)local_1c & 0xff00;
            local_1c = CONCAT22(0x2902,(ushort)local_1c);
            ...
            iVar2 = FUN_000814e6(param_1,*puVar4,puVar4 + 1);
            if (iVar2 == 0) {
              return false;
            }
