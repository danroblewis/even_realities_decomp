/*
 * Function: process_data_with_validation_and_compression
 * Entry:    00050e64
 * Prototype: undefined process_data_with_validation_and_compression()
 */


/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */

void process_data_with_validation_and_compression(int *param_1,int param_2,undefined4 param_3)

{
  ...
  do {
    ...
    if (iVar5 != 0) {
      iVar2 = *param_1;
      iVar1 = extract_float_exponent(iVar2);
      iVar5 = extract_float_exponent(iVar5 + iVar2 + -1);
      if (iVar1 != iVar5) {
