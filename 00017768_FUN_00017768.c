/*
 * Function: FUN_00017768
 * Entry:    00017768
 * Prototype: undefined FUN_00017768()
 */


void FUN_00017768(int param_1,uint param_2,uint param_3)

{
  ...
  if ((uVar1 & **(uint **)(param_1 + 4)) == 0) {
    ...
    FUN_0007e2ec("WEST_TOPDIR/zephyr/include/zephyr/drivers/gpio.h",0x64f);
  }
