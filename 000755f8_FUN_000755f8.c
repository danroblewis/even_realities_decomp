/*
 * Function: FUN_000755f8
 * Entry:    000755f8
 * Prototype: undefined FUN_000755f8()
 */


undefined4 FUN_000755f8(int param_1,int param_2,uint param_3,uint param_4)

{
  ...
  iVar3 = DAT_2000b450;
  iVar5 = DAT_2000b450 + 0x60;
  *(undefined1 *)(DAT_2000b450 + 0x60) = 1;
  *(undefined1 *)(iVar3 + 0x61) = 1;
  ...
  if (uVar8 == 0) {
    if (param_1 == 0) {
      ...
      if (-1 < param_2) {
        uVar4 = FUN_000751d0(param_1,param_2,iVar5,param_3 == 0 && param_4 == 0,param_1,param_2,
                             param_3);
        uVar7 = 0;
        bVar1 = (bool)isCurrentModePrivileged();
        if (bVar1) {
        ...
        iVar5 = FUN_00072040(&DAT_2000b4a0);
        if (iVar5 == 0) {
LAB_000756a0:
          DEBUG_PRINT2("ASSERTION FAIL [%s] @ %s:%d\n","z_spin_lock_valid(l)",
          ...
          if (*(char *)(iVar3 + 0x60) == '\0') {
            FUN_000753ec(param_1,uVar4,uVar7);
            ...
            *(undefined1 *)(iVar3 + 0x60) = 0;
            if ((param_3 | param_4) == 0) {
              ...
              uVar7 = FUN_00073f6c(&DAT_2000b4a0,uVar7,&DAT_20002d04,param_3 | param_4,param_3,
                                   param_4);
              uVar6 = 0;
              bVar1 = (bool)isCurrentModePrivileged();
              if (bVar1) {
              ...
              FUN_00072078(&DAT_2000b4a0);
              FUN_000753ec(param_1,uVar4,uVar6);
              iVar3 = FUN_0007205c(&DAT_2000b4a0);
              if (iVar3 != 0) {
                bVar1 = (bool)isCurrentModePrivileged();
                if (bVar1) {
