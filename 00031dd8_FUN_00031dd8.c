/*
 * Function: FUN_00031dd8
 * Entry:    00031dd8
 * Prototype: undefined FUN_00031dd8()
 */


undefined4
FUN_00031dd8(undefined4 param_1,undefined4 param_2,undefined4 *param_3,undefined1 *param_4)

{
  ...
  *puVar4 = 0x2d;
  ...
  if ((((DAT_20007aa8 == 0 && ATTITUDE_PITCH_VALUE == 0) && DAT_20007aa4 == 0) &&
...
LAB_00031e6e:
  ...
  puVar4[4] = uVar5;
  FUN_00086f00(&local_b0,0,0x14,"base: %d",iVar1);
  iVar1 = get_work_mode();
  cVar6 = '\0';
  *(undefined4 *)(puVar4 + 5) = *(undefined4 *)(iVar1 + 0xf64);
  uVar2 = get_work_mode();
  FUN_00022b00(uVar2,0);
  iVar1 = get_work_mode();
