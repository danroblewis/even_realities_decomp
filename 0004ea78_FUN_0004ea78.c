/*
 * Function: FUN_0004ea78
 * Entry:    0004ea78
 * Prototype: undefined FUN_0004ea78()
 */
...
LAB_0004ebe6:
    ...
    local_38[0] = 0;
    local_36 = 0x2803;
    iVar2 = FUN_00080d3e(*param_2,local_38);
    if (iVar2 != 0) {
    ...
    iVar2 = FUN_0007f386(&DAT_2000a154,*(undefined2 *)(param_2 + 4));
    if (iVar2 == 0) {
      uVar7 = 0xfffffffd;
      goto LAB_0004eaa6;
    }
...
LAB_0004ec80:
    uVar7 = 0xfffffff4;
LAB_0004eaa6:
    FUN_0007f40c(&DAT_2000a154,uVar7);
    return 0;
  }
  if (bVar1 < 4) {
    if (bVar1 != 2) {
      if (param_2 == (undefined4 *)0x0) {
        FUN_0007f438(&DAT_2000a154);
        return 0;
      }
      piVar9 = (int *)param_2[3];
      iVar2 = FUN_0004e9a0(param_2,8);
      local_3c[0] = 0;
      local_3a = 0x2800;
      iVar3 = FUN_00080d3e(*param_2,local_3c);
      if (iVar3 != 0) {
        local_38[0] = 0;
        local_36 = 0x2801;
        iVar3 = FUN_00080d3e(*param_2,local_38);
        if (iVar3 != 0) {
          DEBUG_PRINT2("ASSERTION FAIL [%s] @ %s:%d\n",
...
LAB_0004eb88:
        ...
        *piVar4 = iVar3;
        ...
        uStack_48 = FUN_0005b9cc(DAT_2000a154,&DAT_2000a15c);
        if (uStack_48 == 0) {
          return 0;
        }
    ...
    iVar2 = FUN_00080d3e(*param_2,local_38);
    if (iVar2 == 0) {
      puVar5 = (undefined4 *)FUN_0004e9a0(param_2,8);
      puVar6 = (undefined4 *)FUN_0007f4a0();
      *puVar6 = *puVar5;
      return 1;
    }
    iVar2 = FUN_0004e9a0(param_2,0);
    if (iVar2 != 0) {
      return 1;
    }
...
LAB_0004eb7e:
  ...
  FUN_0007e2ec("WEST_TOPDIR/nrf/subsys/bluetooth/gatt_dm.c",uVar8);
}
