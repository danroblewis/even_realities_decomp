/*
 * Function: FUN_00012080
 * Entry:    00012080
 * Prototype: undefined FUN_00012080()
 */
...

{
  ...
  if ((*(uint *)(DAT_20002168 + 8) & 1) == 0) {
    uVar12 = FUN_00053d70(0xc03,0,local_30);
    if ((int)uVar12 != 0) {
      return (int)uVar12;
    }
  ...
  FUN_0005f24c(local_30[0]);
  iVar3 = FUN_00053d70(0x2002,0,local_30);
  iVar1 = local_30[0];
  if (iVar3 != 0) {
    return iVar3;
  }
  ...
  if ((*(short *)(iVar3 + 1) != 0) && (*(char *)(iVar3 + 3) != '\0')) {
    ...
    FUN_00086534(&DAT_20002108,*(undefined1 *)(iVar3 + 3));
  }
  FUN_0005f24c(iVar1);
  ...
  if ((DAT_2000207c & 0x20) == 0) {
    ...
    *puVar4 = 1;
    ...
    iVar1 = FUN_00053d70(0xc6d,iVar1,uVar10);
    if (iVar1 != 0) {
      return iVar1;
    }
  }
  ...
  if ((int)(DAT_2000207c << 0x1a) < 0) {
    ...
    if (DAT_20002104 == 0) {
      ...
      FUN_00086534(&DAT_20002108,*(undefined2 *)(*(int *)(local_30[0] + 0xc) + 4));
    }
    FUN_0005f24c(local_30[0]);
  }
  ...
  FUN_00080eb8(uVar5,uVar6,uVar2);
  iVar1 = FUN_00053d70(0xc01,iVar1,0);
  if (iVar1 != 0) {
    return iVar1;
  }
  iVar1 = FUN_00053d70(0xfc01,0,&local_34);
  if (iVar1 == 0) {
    ...
    FUN_00080ea2(&DAT_00088138,0x24c0,&local_50);
    ...
    local_58 = 0x1000007;
    FUN_00080ea2(&DAT_00088138,0x3cc0,&local_58);
  ...
  local_20 = 2;
  FUN_00080ea2(&DAT_00088138,0x1080,&local_20);
LAB_000123fe:
  iVar1 = FUN_00081158();
  if (iVar1 != 0) {
    return iVar1;
