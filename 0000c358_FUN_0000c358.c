 ...
 * Entry:    0000c358
 * Prototype: undefined FUN_0000c358()
 */
...

{
  ...
  uVar22 = FUN_0000e954(pfVar7);
  pfVar6 = param_5 + 0x11b;
  pfVar12 = param_5 + 0x11c;
  uVar23 = FUN_0000e9b4(pfVar7);
  uVar24 = FUN_0008693c(fVar37,uVar22);
  fVar25 = (float)FUN_00086902(uVar24,uVar23);
  ...
  local_26c = local_240;
  if (local_240 == 0) {
    local_23c[0] = (float)FUN_0000eb7c(fVar25,pfVar7,param_5 + 0x5be);
    local_26c = 1;
  }
  else if (0 < local_240) {
    pfVar5 = local_23c;
  ...
  FUN_0000ea18(local_258,aiStack_20c,auStack_244);
  if (local_240 == 0) {
    FUN_0000ea70(fVar25,pfVar7,param_5 + 0x5b2,local_254);
    iVar18 = 2;
...
LAB_0000c51e:
    ...
    do {
      ...
      fVar25 = (float)FUN_000868ee(fVar25);
      iVar14 = iVar14 + 1;
      *pfVar5 = fVar25;
      pfVar5 = pfVar5 + 1;
    } while (iVar14 < iVar18);
...
LAB_0000c580:
  ...
  FUN_0000ea18(local_258,aiStack_20c,auStack_244);
  if (local_240 == 0) {
    FUN_0000ea70(fVar25,pfVar7,param_5 + 0x5b8,local_254);
    iVar15 = 4;
    fVar25 = local_254[0];
  }
  else {
  ...
  uVar22 = FUN_0008693c(fVar37,uVar22);
  fVar26 = (float)FUN_00086902(uVar22,uVar23);
  ...
  local_280 = local_240;
  if (local_240 == 0) {
    local_23c[3] = (float)FUN_0000eb7c(fVar26,pfVar7,param_5 + 0x5af);
    local_280 = 1;
  }
  else if (0 < local_240) {
    pfVar12 = local_23c + 3;
  ...
  fVar26 = (float)FUN_000868ee(param_1 - param_5[0x17]);
  fVar27 = (float)FUN_000868ee(param_5[0x15] - param_2);
  uVar41 = FUN_0000d848(fVar27);
  iVar15 = FUN_0000de18((int)uVar41,(int)((ulonglong)uVar41 >> 0x20),0xd2f1a9fc,0x3f70624d);
  if (iVar15 == 0) {
LAB_0000c72a:
    fVar26 = param_5[0x5da];
  }
  else {
    uVar41 = FUN_0000d848(fVar26);
    iVar15 = FUN_0000de18((int)uVar41,(int)((ulonglong)uVar41 >> 0x20),0xd2f1a9fc,0x3f70624d);
  ...
  uVar22 = FUN_00086902(0xbf800000,local_200[iVar18 + 7]);
  fVar40 = param_5[0x5d4];
  fVar33 = (float)FUN_0008693c(0x3f800000,uVar22);
  fVar32 = param_5[0x5d5];
  local_200[(int)fVar40 + 7] = fVar33;
  uVar22 = FUN_00086902(0xbd4ccccd,local_200[(int)fVar32 + 7]);
  fVar40 = param_5[0x5d5];
  fVar33 = (float)FUN_0008693c(0x3f866666,uVar22);
  fVar32 = param_5[0x13];
  pfVar17 = local_200;
  local_200[(int)fVar40 + 7] = fVar33;
  pfVar7 = pfVar17;
...
LAB_0000cc1a:
      fVar33 = (float)FUN_000868fc((fVar32 - fVar33) / fVar34);
  ...
  local_200[2] = 0.0;
  local_200[3] = 0.0;
  fVar33 = (float)FUN_0000e3a0(fVar32,fVar37,param_5 + 0x51,param_5 + 0x329,param_5 + 0x3f2);
  fVar40 = *param_5;
  fVar36 = param_5[1];
  ...
  if (local_280 < 1) {
    local_24c = 1;
    local_248 = local_280;
    iVar15 = FUN_0000ea4c(local_258,&local_24c);
    if (iVar15 != 0) {
      local_200[4] = 0.0;
      local_200[5] = 0.0;
      local_200[6] = 0.0;
  ...
  fVar39 = local_200[5];
  fVar25 = local_200[4];
  uVar22 = FUN_00086902(0xbf800000,local_150[(int)param_5[0x5d4] + -1]);
  fVar35 = param_5[0x5d4];
  fVar32 = (float)FUN_0008693c(0x3f800000,uVar22);
  fVar36 = param_5[0x5d5];
  local_150[(int)fVar35 + -1] = fVar32;
  uVar22 = FUN_00086902(0xbd4ccccd,local_150[(int)fVar36 + -1]);
  fVar35 = param_5[0x5d5];
  fVar32 = (float)FUN_0008693c(0x3f866666,uVar22);
  local_150[(int)fVar35 + -1] = fVar32;
  pfVar6 = param_5;
  do {
    fVar32 = *pfVar12;
  ...
  *param_7 = fVar25 * 3.0;
  ...
  iVar15 = FUN_0000e938(param_5[0x4b]);
  if (iVar15 != 0) goto LAB_0000d162;
  iVar15 = FUN_0000e938(param_2);
  fVar25 = DAT_20002d1c;
  if (iVar15 == 0) {
    if (param_2 < 0.0) {
      fVar25 = -1.0;
...
LAB_0000d162:
  fVar26 = (float)FUN_000868ee(param_2);
  fVar27 = (float)FUN_000868ee(param_5[0x4b]);
  fVar27 = fVar27 * 5.0;
  fVar25 = extraout_s12;
  if (fVar27 < fVar26) {
    fVar25 = 0.0;
