/*
 * Function: remove_ble_connection_with_privilege_control
 * Entry:    00073960
 * Prototype: undefined remove_ble_connection_with_privilege_control()
 */


void remove_ble_connection_with_privilege_control
