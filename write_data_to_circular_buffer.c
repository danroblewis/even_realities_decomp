/*
 * Function: write_data_to_circular_buffer
 * Entry:    00085508
 * Prototype: undefined write_data_to_circular_buffer()
 */


int write_data_to_circular_buffer(int *param_1,uint param_2,undefined4 *param_3,int param_4)
