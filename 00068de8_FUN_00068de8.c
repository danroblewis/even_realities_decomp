/*
 * Function: FUN_00068de8
 * Entry:    00068de8
 * Prototype: undefined FUN_00068de8()
 */


void FUN_00068de8(byte *param_1,undefined4 *param_2,int param_3)

{
  ...
  do {
    fVar6 = (float)FUN_00086976(*param_2,0xf);
    *pfVar2 = fVar6;
    pfVar2 = pfVar2 + 1;
