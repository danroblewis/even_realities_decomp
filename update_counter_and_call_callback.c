/*
 * Function: update_counter_and_call_callback
 * Entry:    0008174c
 * Prototype: undefined update_counter_and_call_callback()
 */


void update_counter_and_call_callback(int param_1,int param_2)
