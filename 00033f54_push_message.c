...

{
  ...
  if (param_1 == 0) {
    ...
    uVar8 = FUN_00033f24(0x14,*(undefined4 *)(param_1 + 8),param_3,0,param_1,param_2,param_3);
...
LAB_00033fb2:
    ...
    uVar8 = FUN_00033f24(0x14,*(undefined4 *)(param_1 + 8),param_3,*(int *)(param_1 + 0x1b0),param_1
                         ,param_2,param_3);
    uVar4 = (undefined4)((ulonglong)uVar8 >> 0x20);
