/*
 * Function: FUN_000698d0
 * Entry:    000698d0
 * Prototype: undefined FUN_000698d0()
 */


bool FUN_000698d0(int param_1,short *param_2,int param_3,int *param_4)

{
  ...
  FUN_0006954c(param_2,param_2 + -0x11,param_3,local_1b0,0x62);
  fVar11 = 0.9948454;
  iVar3 = 0;
  iVar6 = 1;
  iVar9 = iVar9 + -4;
