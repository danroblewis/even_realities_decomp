/*
 * Function: process_ble_attribute_data_in_chunks
 * Entry:    0005c5f0
 * Prototype: undefined process_ble_attribute_data_in_chunks()
 */


void process_ble_attribute_data_in_chunks(int param_1,undefined4 param_2,undefined4 param_3)
  ...
  if (iVar2 != 0) {
    ...
    while (4 < local_30) {
      ...
      if (local_30 < uVar6) {
        ...
        local_50 = 4;
        uStack_48 = uVar6;
        ble_data_processing_wrapper(&DAT_00088128,0x2040,&local_50);
        return;
      }
      piVar5 = *(int **)(iVar2 + 8);
      if (piVar5 != (int *)0x0) {
        ...
        do {
          if ((*(byte *)((int)piVar5 + 0x12) <= *(byte *)(param_1 + 9)) &&
            ...
            manage_ble_attribute_data_operations(param_1,piVar5);
          }
LAB_0005c6a6:
...
LAB_0005c6ac:
      update_buffer_position_and_size_alt(auStack_34,uVar6);
    }
  }
  return;
}
