/*
 * Function: update_ble_connection_state_flags
 * Entry:    00073a78
 * Prototype: undefined update_ble_connection_state_flags()
 */


void update_ble_connection_state_flags
  ...
  if (iVar3 == 0) {
    ...
    if ((int)((uint)*(byte *)(param_1 + 0xd) << 0x1d) < 0) {
      *(byte *)(param_1 + 0xd) = *(byte *)(param_1 + 0xd) & 0xfb;
      ...
      validate_ble_connection_state_with_priority(&DAT_2000b490,uVar4);
      return;
    }
