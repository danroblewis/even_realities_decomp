/*
 * Function: process_audio_buffer_data_alt
 * Entry:    00068d90
 * Prototype: undefined process_audio_buffer_data_alt()
 */


void process_audio_buffer_data_alt(byte *param_1,int param_2,int param_3)
