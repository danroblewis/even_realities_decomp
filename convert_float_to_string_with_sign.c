/*
 * Function: convert_float_to_string_with_sign
 * Entry:    0004a300
 * Prototype: undefined convert_float_to_string_with_sign()
 */


int convert_float_to_string_with_sign(float param_1,char *param_2)
