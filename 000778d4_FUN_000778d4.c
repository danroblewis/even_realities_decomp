/*
 * Function: FUN_000778d4
 * Entry:    000778d4
 * Prototype: undefined FUN_000778d4()
 */


undefined4 FUN_000778d4(undefined4 param_1)

{
  ...
  iVar2 = DAT_20002d20;
  iStack_1c = FUN_0000ef12(param_1);
  ...
  if ((-1 < *(int *)(puVar3 + 100) << 0x1f) && (-1 < (int)((uint)*(ushort *)(puVar3 + 0xc) << 0x16))
    ...
    FUN_000510fc(*(undefined4 *)(puVar3 + 0x58));
  }
  iVar2 = FUN_00077e70(iVar2,puVar3,&local_2c);
  if (iVar2 == 0) {
    uVar4 = 10;
  }
  else {
  ...
  if ((-1 < *(int *)(puVar3 + 100) << 0x1f) && (-1 < (int)((uint)*(ushort *)(puVar3 + 0xc) << 0x16))
    ...
    FUN_00051134(*(undefined4 *)(puVar3 + 0x58));
  }
  return uVar4;
}
