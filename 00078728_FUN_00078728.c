/*
 * Function: FUN_00078728
 * Entry:    00078728
 * Prototype: undefined FUN_00078728(undefined param_1, undefined param_2, undefined param_3, undefined param_4, undefined4 param_5)
 */


void FUN_00078728(undefined4 param_1,int param_2,int param_3,int param_4,undefined4 param_5)

{
  ...
  do {
    if (iVar3 <= iVar2) {
      iVar1 = FUN_000785d4(param_1,iVar1,iVar2,iVar3,iVar6);
      if (iVar1 != 0) {
        ...
        *(undefined4 *)(iVar1 + 0x10) = 1;
        if (param_3 < 10) {
          ...
          do {
            pbVar5 = pbVar4 + 1;
            iVar1 = FUN_00078698(param_1,iVar1,10,*pbVar4 - 0x30);
            pbVar4 = pbVar5;
