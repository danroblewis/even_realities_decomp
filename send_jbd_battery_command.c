/*
 * Function: send_jbd_battery_command
 * Entry:    000476b4
 * Prototype: undefined send_jbd_battery_command()
 */


void send_jbd_battery_command(int param_1,uint param_2,undefined4 param_3,uint param_4)
