/*
 * Function: validate_interrupt_configuration_parameters
 * Entry:    00085316
 * Prototype: undefined validate_interrupt_configuration_parameters()
 */


undefined4 validate_interrupt_configuration_parameters(int param_1,int param_2)
