/*
 * Function: FUN_000583d0
 * Entry:    000583d0
 * Prototype: undefined FUN_000583d0()
 */


undefined4 FUN_000583d0(undefined4 *param_1,uint param_2,int *param_3)

{
  ...
  local_3c[0] = 0;
  local_3a = 0x2801;
  iVar1 = FUN_00080d3e(*param_1,local_3c);
...
LAB_00058420:
    ...
    iVar6 = FUN_00080d9a(local_3c,param_3[3]);
    if (iVar6 == 0) {
      local_74 = "Unable to create UUID: size %u";
      local_70 = (uint)*(byte *)(param_3 + 4);
    }
    else {
      iVar6 = FUN_00080d9a(auStack_50,auStack_60,uVar2 & 0xff);
      if (iVar6 != 0) {
        iVar6 = FUN_00080d3e(local_3c,auStack_50);
        goto LAB_00058534;
      }
