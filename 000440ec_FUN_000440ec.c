/*
 * Function: FUN_000440ec
 * Entry:    000440ec
 * Prototype: undefined FUN_000440ec(undefined param_1, undefined param_2, undefined param_3, undefined param_4, undefined4 param_5, undefined param_6, undefined4 param_7, undefined param_8, undefined4 param_9)
 */


void FUN_000440ec(undefined4 param_1,undefined4 param_2,undefined4 param_3,int param_4,int param_5,
...

{
  ...
  if (iVar2 < 0x21) {
    ...
    iVar4 = param_5 + 0x1b;
    if (iVar2 << 0x1e < 0) {
      _clean_fb_data(DAT_2000a034,0,param_4,iVar4,param_6,param_7 + 0x1b);
    }
    FUN_000432ec();
    ...
    FUN_0007d5f2(DAT_2000a034,param_4,param_5,param_4,iVar4,0x1b,param_6 - param_4);
    iVar2 = FUN_000431a8();
    param_5 = param_7;
  }
  else {
    ...
    FUN_0007d5f2(DAT_2000a034,param_4,param_5 + -0x1b,param_4,param_5,0x1b,param_6 - param_4);
    iVar2 = FUN_000431a8();
    if (iVar2 << 0x1e < 0) {
  ...
  _clean_fb_data(DAT_2000a034,0,param_4,param_5);
  return;
}
