/*
 * Function: initialize_buffer_structure_with_memory
 * Entry:    0004e540
 * Prototype: undefined initialize_buffer_structure_with_memory()
 */


undefined **
initialize_buffer_structure_with_memory(undefined4 param_1,undefined4 *param_2,undefined4 param_3)

{
  ...
  while( true ) {
    if (&PTR_LAB_00051fd8_1_00088328 < ppuVar3) {
      ...
      trigger_system_service_call("WEST_TOPDIR/zephyr/subsys/settings/src/settings.c",0x94);
    }
