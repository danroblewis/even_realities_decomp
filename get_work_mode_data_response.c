/*
 * Function: get_work_mode_data_response
 * Entry:    00031bd8
 * Prototype: undefined get_work_mode_data_response()
 */


undefined4
get_work_mode_data_response(int param_1,undefined4 param_2,undefined4 *param_3,undefined1 *param_4)
