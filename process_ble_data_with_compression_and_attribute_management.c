/*
 * Function: process_ble_data_with_compression_and_attribute_management
 * Entry:    00083370
 * Prototype: undefined process_ble_data_with_compression_and_attribute_management(undefined param_1, undefined param_2, undefined param_3, undefined param_4, undefined2 param_5, undefined4 param_6)
 */


undefined4
process_ble_data_with_compression_and_attribute_management
          (int param_1,undefined4 param_2,int param_3,int param_4,short param_5,int param_6)
...
LAB_00083420:
      ...
      if ((((iVar3 == 0) || (-1 < (int)((uint)*(ushort *)(iVar3 + 0xe) << 0x1f))) ||
        ...
        iVar5 = extract_bit_from_value(iVar8,0xf);
        if (iVar5 != 0) {
          bt_connection_disconnect_with_parameter_validation(param_1,6,2);
        }
        reset_ble_connection_state_and_acquire_mutex(iVar2);
        goto LAB_00083492;
      }
      iVar6 = iVar3 + 0x4a;
      uVar7 = (uint)*(byte *)(iVar3 + 0xc);
