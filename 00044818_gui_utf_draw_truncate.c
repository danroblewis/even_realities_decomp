...

{
  ...
  local_2da = 0;
  local_2d8 = 0;
  puVar1 = (ushort *)FUN_000478d8(param_2,&local_2da);
  local_2d4 = 0;
  local_2d0 = 0;
  if (param_10 == 0) {
              ...
              if ((param_8 <= uVar14) || ((uint)(param_7 - param_5) <= uVar8)) {
                while (uVar12 != 0) {
                  ...
                  if (iVar2 < 0) {
                    ...
                    _clean_fb_data(DAT_2000a034,0,param_4 + uVar10,uVar8 + param_5,
...
LAB_000449e6:
                ...
                FUN_0007d53a(DAT_2000a034,local_2cc,iVar4,iVar2,uVar10 + param_4,uVar8 + param_5);
LAB_00044a68:
                iVar2 = FUN_000431a8();
                if (-1 < iVar2 << 0x1e) {
                  return 0;
              ...
              FUN_0007d53a(DAT_2000a034,local_2cc,iVar3,iVar4,param_4,uVar8 + param_5);
              iVar2 = FUN_00043e58(*puVar1,puVar1[1]);
              uVar10 = local_2d4 + iVar2;
              local_2f0 = uVar10;
            }
            else {
              FUN_0007d53a(DAT_2000a034,local_2cc,iVar3,iVar4,uVar10 + param_4,uVar8 + param_5);
              iVar2 = FUN_00043e58(*puVar1,puVar1[1]);
