/*
 * Function: FUN_000560cc
 * Entry:    000560cc
 * Prototype: undefined FUN_000560cc()
 */


undefined4 FUN_000560cc(ushort *param_1,int param_2,int param_3,ushort param_4)
  ...
  if ((int)uVar9 == 0) {
    ...
    if (*(char *)((int)param_1 + 0xd) == '\a') {
      ...
      *(undefined1 *)(param_3 + 0x18) = 2;
      iStack_38 = FUN_000543c8(param_3);
      if (iStack_38 == 0) {
        return 0;
      }
      ...
      if (puVar7 == (undefined4 *)0x0) {
        if (*(int *)unaff_r10 == 0) {
          ...
          FUN_0007e2ec("WEST_TOPDIR/zephyr/subsys/bluetooth/host/conn.c",0x273);
        }
