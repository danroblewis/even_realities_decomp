/*
 * Function: handle_device_power_state_operations
 * Entry:    00062c54
 * Prototype: undefined handle_device_power_state_operations()
 */


uint handle_device_power_state_operations(int param_1,int param_2)
