/*
 * Function: derive_sha256_key_with_counter_management
 * Entry:    00079cf0
 * Prototype: undefined derive_sha256_key_with_counter_management(undefined param_1, undefined param_2, undefined param_3, undefined param_4, undefined4 param_5)
 */


int derive_sha256_key_with_counter_management
              (char *param_1,int param_2,uint param_3,undefined4 param_4,uint param_5)

{
  ...
  if ((*(int *)(param_1 + 0x1c) < *(int *)(param_1 + 0x10)) || (*(int *)(param_1 + 0x14) != 0)) {
    ...
    if ((iVar2 != 0) && (iVar2 = (*DAT_20002f54)(pcVar4), iVar2 != 0)) {
      return iVar2;
          ...
          ((iVar2 = calculate_sha256_hash_with_padding_and_processing(auStack_58,param_4,param_5),
           iVar2 != 0 ||
           (iVar2 = process_sha256_block_with_counter_increment(param_1,auStack_58), iVar2 != 0))))
  goto LAB_00079e32;
  if (param_3 != 0) {
    do {
      cVar1 = param_1[0xf];
      ...
      iVar2 = process_sha256_hmac_with_validation(param_1 + 0x20,1,param_1,auStack_68);
  ...
  iVar2 = process_sha256_block_with_counter_increment(param_1,auStack_58);
  if (iVar2 == 0) {
