...

{
  ...
  uStack_6c = 0x1a;
  handle_event_processing(&local_70,0x10000);
  local_68 = &DAT_00087b60;
  uStack_64 = 0x19;
  handle_event_processing(&local_68,0x10000);
  local_60 = &DAT_00087b60;
  uStack_5c = 0x1c;
  handle_event_processing(&local_60,0x10000);
  local_58 = &DAT_00087b60;
  uStack_54 = 0x1b;
  handle_event_processing(&local_58,0x10000);
  local_50 = &DAT_00087b60;
  uStack_4c = 0x18;
  handle_event_processing(&local_50,0x30000);
  handle_conditional_event(&DAT_00087b60,0x18,1);
  local_48 = &DAT_00087b60;
  uStack_44 = 0x13;
  handle_event_processing(&local_48,0x30000);
  handle_conditional_event(&DAT_00087b60,0x13,0);
  local_40 = &DAT_00087b60;
  uStack_3c = 0x15;
  handle_event_processing(&local_40,0x30000);
  handle_conditional_event(&DAT_00087b60,0x15,0);
  local_38 = &DAT_00087b60;
  uStack_34 = 0x1e;
  handle_event_processing(&local_38,0x30000);
  handle_conditional_event(&DAT_00087b60,0x1e,1);
  local_30 = &DAT_00087b60;
  uStack_2c = 0x17;
  handle_event_processing(&local_30,0x30000);
  handle_conditional_event(&DAT_00087b60,0x17,0);
  iVar2 = check_driver_ready(&DAT_00087b48);
  if (iVar2 == 0) {
    if (1 < LOG_LEVEL) {
...
LAB_00017b48:
  ...
  if (iVar2 == 0) {
    ...
    if (-1 < iVar2) {
      ...
      handle_bit_pattern_event(&DAT_000889e0,uVar11);
      if (1 < LOG_LEVEL) {
        if (IS_DEBUG == 0) {
          DEBUG_PRINT("%s(): done, pin= %d\n\n","nfc_gpo_init",10);
        }
...
LAB_00017c40:
  bVar1 = handle_state_validated_event(0x1a);
  uVar4 = handle_state_validated_event(0x19);
  uVar5 = handle_state_validated_event(0x1c);
  uVar6 = handle_state_validated_event(0x1b);
  uVar7 = handle_validated_event(&DAT_00087b60,0x18);
  uVar8 = handle_validated_event(&DAT_00087b60,0x13);
  uVar9 = handle_validated_event(&DAT_00087b60,0x15);
  uVar10 = handle_validated_event(&DAT_00087b60,0x1e);
  if (1 < LOG_LEVEL) {
    uVar12 = (uint)bVar1;
    if (IS_DEBUG == 0) {
