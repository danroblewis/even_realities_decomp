/*
 * Function: FUN_0004e780
 * Entry:    0004e780
 * Prototype: undefined FUN_0004e780()
 */


int FUN_0004e780(int param_1,undefined4 param_2)
...
LAB_0004e7d8:
        if (*(short *)(param_1 + 0x38) == sVar5) {
          *(short *)(param_1 + 0x38) = sVar3 + -2;
          FUN_0004c8f8(iVar6,0x8000,(short *)(param_1 + 0x38),2);
        }
    ...
    local_74 = iVar6;
    local_70 = sVar4;
    iVar1 = FUN_0004e604(auStack_6c,iVar2,0x7f211,&local_74,param_2);
    if (iVar1 != 0) {
      return iVar1;
    }
  } while( true );
