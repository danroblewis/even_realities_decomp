/*
 * Function: process_audio_signal_transformation_matrix_alt
 * Entry:    0006c778
 * Prototype: undefined __stdcall process_audio_signal_transformation_matrix_alt(undefined4 audio_mode, undefined4 input_channels, undefined4 input_buffer, undefined4 enable_processing, undefined4 output_parameters, undefined4 interpolation_buffer, undefined4 interpolation_parameters)
 */


/* WARNING: Restarted to delay deadcode elimination for space: stack */

void process_audio_signal_transformation_matrix_alt
               (int audio_mode,int input_channels,float *input_buffer,int enable_processing,
               int *output_parameters,undefined4 interpolation_buffer,
               undefined4 interpolation_parameters)

{
  ...
  iVar13 = *(int *)(&DAT_00090d50 + audio_mode * 0x514 + input_channels * 0x104);
  if (0x3f < iVar13) {
    iVar13 = 0x40;
  }
  iVar3 = 0x40 - iVar13;
  if (iVar3 == 0) {
    ...
    do {
      ...
      *pfVar4 = fVar16;
      pfVar9 = pfVar14;
      pfVar4 = pfVar4 + 2;
    } while (input_buffer + iVar3 != pfVar14);
  }
  memcpy(local_168 + iVar3 * 2,(int)input_buffer + iVar18,(iVar13 - iVar3) * 4);
  fVar21 = 0.0;
  pfVar4 = (float *)(&DAT_0008c94c + input_channels * 0x100);
  pfVar9 = local_168;
  fVar16 = local_168[0];
  fVar20 = local_168[0];
  do {
  ...
  local_168[0x3f] =
       (fVar16 * 0.25 + fVar20 * 0.75) * *(float *)(&DAT_0008ca48 + input_channels * 0x100);
  ...
  if (enable_processing != 0) {
    ...
    fVar30 = (float)((uint)(audio_mode == 0) * 0x3e99999a + (uint)(audio_mode != 0) * 0x3f000000);
  ...
  *output_parameters = 0;
  ...
  do {
    ...
    if (fVar21 < fVar16) {
      *output_parameters = iVar13;
      fVar16 = fVar21;
    }
    if (fVar28 < fVar20) {
      output_parameters[1] = iVar13;
    }
    iVar13 = iVar13 + 1;
    if (fVar28 < fVar20) {
      fVar20 = fVar28;
  ...
  iVar3 = *output_parameters;
  iVar13 = output_parameters[1];
  fVar32 = (float)(&DAT_00090850)[iVar3 * 8];
  fVar31 = (float)(&DAT_00090450)[iVar13 * 8];
  fVar29 = (float)(&AUDIO_FILTER_APPLICATION_AND_SIGNAL_TRANSFORMATION_MATRIX_COMPREHENSIVE)
                  [iVar3 * 8];
  fVar27 = (float)(&AUDIO_FILTER_APPLICATION_AND_SIGNAL_TRANSFORMATION_MATRIX_EXTENDED)[iVar13 * 8];
  fVar25 = (float)(&AUDIO_FILTER_APPLICATION_AND_SIGNAL_TRANSFORMATION_MATRIX_COMPREHENSIVE_ALT)
                  [iVar3 * 8];
  fVar24 = (float)(&AUDIO_FILTER_APPLICATION_AND_SIGNAL_TRANSFORMATION_MATRIX_BASE)[iVar13 * 8];
  fVar23 = (float)(&AUDIO_FILTER_APPLICATION_AND_SIGNAL_TRANSFORMATION_MATRIX_COMPREHENSIVE_EXTENDED
                  )[iVar3 * 8];
  fVar22 = (float)(&AUDIO_FILTER_APPLICATION_AND_SIGNAL_TRANSFORMATION_MATRIX_OFFSET)[iVar13 * 8];
  fVar30 = (float)(&AUDIO_FILTER_APPLICATION_AND_SIGNAL_TRANSFORMATION_MATRIX_COMPREHENSIVE_BASE)
                  [iVar3 * 8];
  fVar26 = (float)(&AUDIO_FILTER_APPLICATION_AND_SIGNAL_TRANSFORMATION_MATRIX_PRIORITY)[iVar13 * 8];
  fVar28 = (float)(&AUDIO_FILTER_APPLICATION_AND_SIGNAL_TRANSFORMATION_MATRIX_COMPREHENSIVE_OFFSET)
                  [iVar3 * 8];
  fVar21 = (float)(&AUDIO_FILTER_APPLICATION_AND_SIGNAL_TRANSFORMATION_MATRIX_TYPE)[iVar13 * 8];
  fVar20 = (float)(&AUDIO_FILTER_APPLICATION_AND_SIGNAL_TRANSFORMATION_MATRIX_COMPREHENSIVE_PRIORITY
                  )[iVar3 * 8];
  fVar16 = (float)(&AUDIO_FILTER_APPLICATION_AND_SIGNAL_TRANSFORMATION_MATRIX_COMPREHENSIVE_TYPE)
                  [iVar3 * 8];
  fVar33 = (float)(&AUDIO_FILTER_APPLICATION_AND_SIGNAL_TRANSFORMATION_MATRIX_MASK)[iVar13 * 8];
  fVar34 = (float)(&AUDIO_FILTER_APPLICATION_AND_SIGNAL_TRANSFORMATION_MATRIX_ENABLE)[iVar13 * 8];
  pfVar9 = local_2e8;
...
LAB_0006e15e:
  ...
  *(int *)((int)local_168 + iVar18 + 0x28) = *(int *)((int)local_168 + iVar18 + 0x28) + 1;
  ...
  iVar18 = output_parameters[2];
  apply_audio_filter_with_bias_and_scaling
            (iVar3,iVar13,local_268 + iVar18 * 0x10,iVar18,output_parameters[3],&local_328);
  if (iVar18 < 2) {
    iVar13 = 0x28;
  }
  else {
  ...
  if (uVar11 == 0) {
    ...
    iVar13 = iVar13 + 2;
    output_parameters[4] = 0;
    *(byte *)(output_parameters + 6) = (byte)(uVar11 >> 0x1f);
...
LAB_0006e820:
      uVar11 = uVar11 >> 0x1f;
      *(byte *)(output_parameters + 6) = (byte)(uVar8 >> 0x1f);
      goto LAB_0006e82c;
    }
    iVar13 = 1;
    iVar10 = 2;
...
LAB_0006e864:
    uVar8 = puVar7[-2];
    if (uVar8 != 0) {
      uVar11 = (uint)*(byte *)(output_parameters + 6) | uVar11 << 1;
      *(byte *)(output_parameters + 6) = (byte)(uVar8 >> 0x1f);
    }
    if ((int)uVar8 < 0) {
      uVar8 = -uVar8;
    ...
    if (iVar13 + 2 < iVar3) {
      uVar17 = puVar7[-3];
      if (uVar17 != 0) {
        uVar11 = (uint)*(byte *)(output_parameters + 6) | uVar11 * 2;
        *(byte *)(output_parameters + 6) = (byte)(uVar17 >> 0x1f);
      }
                      ...
                      if (iVar13 != 5) {
                        ...
                        if (iVar13 != 4) {
                          ...
                          if (iVar13 != 3) {
                            ...
                            if (iVar13 == 1) {
                              if (puVar7[-0xf] != 0) {
                                bVar2 = *(byte *)(output_parameters + 6);
                                *(byte *)(output_parameters + 6) = (byte)(puVar7[-0xf] >> 0x1f);
...
LAB_0006eb52:
  ...
  if (local_168[0xf] == 0.0) {
    ...
    iVar13 = iVar13 + 2;
    output_parameters[5] = 0;
    *(byte *)((int)output_parameters + 0x19) = (byte)((uint)fVar16 >> 0x1f);
...
LAB_0006ee20:
    ...
    *(byte *)((int)output_parameters + 0x19) = (byte)((uint)local_168[0xf] >> 0x1f);
...
LAB_0006ee14:
      uVar11 = (uint)*(byte *)((int)output_parameters + 0x19);
      *(byte *)((int)output_parameters + 0x19) = (byte)((uint)fVar20 >> 0x1f);
      goto LAB_0006ee20;
    }
    iVar13 = 1;
    iVar3 = 2;
...
LAB_0006ee46:
    fVar20 = pfVar9[-2];
    if (fVar20 != 0.0) {
      uVar11 = (uint)*(byte *)((int)output_parameters + 0x19) | uVar11 << 1;
      *(byte *)((int)output_parameters + 0x19) = (byte)((uint)fVar20 >> 0x1f);
    }
    if ((int)fVar20 < 0) {
    ...
    if (iVar13 != 4) {
      fVar21 = pfVar9[-3];
      if (fVar21 != 0.0) {
        uVar11 = (uint)*(byte *)((int)output_parameters + 0x19) | uVar11 * 2;
        *(byte *)((int)output_parameters + 0x19) = (byte)((uint)fVar21 >> 0x1f);
      }
      if ((int)fVar21 < 0) {
      ...
      if (iVar13 != 3) {
        ...
        if (iVar13 == 1) {
          if (pfVar9[-5] != 0.0) {
            bVar2 = *(byte *)((int)output_parameters + 0x19);
            *(byte *)((int)output_parameters + 0x19) = (byte)((uint)pfVar9[-5] >> 0x1f);
            uVar11 = (uint)bVar2 | uVar11 * 2;
          }
  ...
  output_parameters[5] = uVar11;
LAB_0006eb5c:
  process_audio_interpolation_with_polynomial
            (audio_mode,input_channels,&local_328,0,interpolation_buffer,interpolation_parameters);
  return;
}
