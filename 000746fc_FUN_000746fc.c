...

{
  ...
  if (uVar6 == 0) {
    ...
    if ((int)((param_2 + 1) - (uint)(param_1 < 0xfffffffe)) < 0 ==
      ...
      iVar3 = FUN_00086690(param_1,param_2,param_1 + 2);
      uVar6 = param_1 + iVar3;
    }
    else {
      uVar6 = -param_1 - 2;
    ...
    if (iVar3 == 0) {
      ...
      DAT_2000b484 = DAT_2000b450;
      FUN_00073e88();
      FUN_00074bf4(DAT_2000b450 + 0x18,&LAB_00086660_1,param_1,param_2);
      *(byte *)(DAT_2000b450 + 0xd) = *(byte *)(DAT_2000b450 + 0xd) | 0x10;
      iVar3 = FUN_0007205c(&DAT_2000b490);
      if (iVar3 != 0) {
        FUN_000501d4(uVar5);
        if (-1 < (int)((uint)*(byte *)(DAT_2000b450 + 0xd) << 0x1b)) {
          uVar4 = FUN_00086690();
