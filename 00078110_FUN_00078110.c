...

{
  ...
  iVar6 = FUN_0000ef12(&LAB_000aa08e_1);
  ...
  if ((int)uVar23 == 0) {
    ...
    if (iVar7 == 0) {
      ...
      iVar7 = FUN_00087340(pbVar18[iVar6]);
      pbVar11 = pbVar15;
      pbVar17 = pbVar15;
      if (iVar7 != 0) {
        do {
...
LAB_00078192:
    do {
      pbVar17 = pbVar11;
      uVar23 = FUN_00087340(*pbVar17,uVar12,pbVar17 + 1);
      uVar12 = (undefined4)((ulonglong)uVar23 >> 0x20);
      pbVar11 = extraout_r2;
    } while ((int)uVar23 != 0);
...
LAB_0007823c:
    ...
    uVar23 = FUN_00087340(*pbVar10);
    if (((int)uVar23 - 1U & 0xff) < 0x19) {
      while( true ) {
        puVar1 = (undefined1 *)((int)((ulonglong)uVar23 >> 0x20) + 1);
        uVar23 = FUN_00087340(*puVar1,puVar1,(int)uVar23 + -0x10);
    ...
    if ((int)pbVar18 <= (int)pbVar15) {
      ...
      if (iVar6 == 2) {
        ...
        if (iVar6 != 3) {
          ...
          param_6 = FUN_0008768e(iVar7,pbVar18 + -1);
        }
        if (param_6 == 0) {
LAB_000783e8:
...
LAB_000783b6:
    ...
    if (uVar21 == 0) {
      if (pbVar20 != (byte *)0x0) {
        uVar21 = FUN_0008768e(iVar7,pbVar20);
      }
    }
    else {
      uVar21 = 1;
...
LAB_000784b0:
  if (pbVar17 == (byte *)0x2) {
    ...
    goto LAB_000784d6;
          ...
          ((((uint)pbVar18 & 0x1f) != 0 &&
           (iVar6 = FUN_00087510(*(undefined4 *)(iVar8 + 0x14 + iVar16 * 4 + -4)),
