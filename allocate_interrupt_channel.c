/*
 * Function: allocate_interrupt_channel
 * Entry:    00067e8c
 * Prototype: undefined allocate_interrupt_channel()
 */


undefined4 allocate_interrupt_channel(int *param_1,byte *param_2)

{
  ...
  trigger_system_service_call("WEST_TOPDIR/modules/hal/nordic/nrfx/drivers/src/nrfx_wdt.c",uVar6);
}
