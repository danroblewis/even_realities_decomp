...

{
  ...
  while( true ) {
    ...
    fVar8 = (float)complex_float_math_conversion();
    fVar7 = local_40;
...
LAB_00010c00:
  ...
  if (0 < LOG_LEVEL) {
    ...
    uVar11 = float_divide_64bit_complex(local_40);
    uVar12 = float_divide_64bit_complex(local_3c[0]);
    if (IS_DEBUG == 0) {
  ...
  fVar7 = fVar8;
  if (((fVar8 == 0.0) ||
      (DISPLAY_DISPATCH_THREAD_EXTENDED_FINAL_ULTIMATE_COMPREHENSIVE_COMPLETION_STATE == fVar8)) &&
     ((fVar8 < 100.0 &&
      (iVar6 = DISPLAY_DISPATCH_THREAD_FINAL_EXTENDED_ULTIMATE_COMPREHENSIVE_COMPLETION_STATE,
      fVar7 = DISPLAY_DISPATCH_THREAD_EXTENDED_FINAL_ULTIMATE_COMPREHENSIVE_COMPLETION_STATE,
      119999 < (uint)(iVar2 - 
                     DISPLAY_DISPATCH_THREAD_FINAL_EXTENDED_ULTIMATE_COMPREHENSIVE_COMPLETION_STATE)
      )))) {
    DAT_20018d90 = 1;
  }
  DISPLAY_DISPATCH_THREAD_EXTENDED_FINAL_ULTIMATE_COMPREHENSIVE_COMPLETION_STATE = fVar7;
  DISPLAY_DISPATCH_THREAD_FINAL_EXTENDED_ULTIMATE_COMPREHENSIVE_COMPLETION_STATE = iVar6;
  ...
  if (0 < LOG_LEVEL) {
    uVar10 = float_divide_64bit_complex(fVar8);
    uVar5 = (undefined4)((ulonglong)uVar10 >> 0x20);
    uVar11 = float_divide_64bit_complex(fVar7);
    if (IS_DEBUG == 0) {
      uVar3 = get_system_data_alt();
...
LAB_00010d44:
  ...
  *(char *)(iVar6 + 0xfc4) = (0.0 < fVar8) * (char)(int)fVar8;
  if (local_40 == 0.0) {
    ...
    if (5 < DAT_20018da2) {
      DAT_20018da2 = 0;
      uVar10 = float_divide_64bit_complex(local_40);
      uVar10 = float_add_64bit_alt((int)uVar10,(int)((ulonglong)uVar10 >> 0x20),0xd2f1a9fc,
                                   0x3fc0624d);
      uVar10 = float_multiply_64bit_alt((int)uVar10,(int)((ulonglong)uVar10 >> 0x20),0,0x408f4000);
      iVar6 = get_work_mode();
      uVar1 = float_to_int_conversion((int)uVar10,(int)((ulonglong)uVar10 >> 0x20));
    ...
    uVar10 = float_divide_64bit_complex(local_40);
    uVar10 = float_add_64bit_alt((int)uVar10,(int)((ulonglong)uVar10 >> 0x20),0xd2f1a9fc,0x3fc0624d)
    ;
    uVar10 = float_multiply_64bit_alt((int)uVar10,(int)((ulonglong)uVar10 >> 0x20),0,0x408f4000);
    iVar6 = get_work_mode();
    uVar1 = float_to_int_conversion((int)uVar10,(int)((ulonglong)uVar10 >> 0x20));
  ...
  *(short *)(iVar6 + 0xfca) = (short)(int)(local_3c[0] * 100.0);
  if ((((60.0 <= local_3c[0]) && ((int)((uint)(local_3c[0] < 120.0) << 0x1f) < 0)) ||
    ...
    if (*pcVar4 == '\x01') {
      ...
      uVar5 = get_work_mode();
      process_message_and_sync(uVar5,7,0);
    }
    iVar6 = get_work_mode();
