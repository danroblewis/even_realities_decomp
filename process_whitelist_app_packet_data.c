 ...
 * Entry:    00035498
 * Prototype: undefined process_whitelist_app_packet_data()
 */


void process_whitelist_app_packet_data(int param_1,int param_2)

{
  ...
  *(undefined1 *)(param_2 + 1) = 0x6a;
  ...
  uVar2 = create_whitelist_app_json_structure(iVar1);
  if (uVar2 != 0) {
    uVar11 = 0;
    uVar10 = uVar2 % 0x11;
