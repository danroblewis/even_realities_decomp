...

{
  ...
  if (iVar1 < 0) {
    ...
    uVar3 = FUN_000431a8();
    if ((uVar3 & 2) != 0) {
      _clean_fb_data(DAT_2000a034,0,param_2,param_3,local_2c + param_2,local_28 + param_3);
    }
    FUN_0007d53a(DAT_2000a034,local_28 * ((int)(local_2c * (uint)ANIM_FRAME_IDX) / 2) + local_24[0],
