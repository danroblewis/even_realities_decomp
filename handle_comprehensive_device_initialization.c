/*
 * Function: handle_comprehensive_device_initialization
 * Entry:    00060c00
 * Prototype: undefined handle_comprehensive_device_initialization()
 */


/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */

char * handle_comprehensive_device_initialization(int param_1)
...
LAB_00060c8e:
    ...
    if (uVar6 != (uint)((int)pcVar1 << 0x19) >> 0x1f) {
      ...
      local_20 = &local_2c;
      pcVar1 = (char *)validate_device_properties_and_state(param_1,&local_24);
      if (pcVar1 != (char *)0x0) {
        if (-1 < (int)pcVar1) {
          return pcVar1;
        }
LAB_00060cdc:
    ...
    local_2c = (undefined1 *)&local_30;
    local_1c = &local_2c;
    iVar5 = check_device_capabilities_and_state(param_1);
    if (iVar5 == 0) {
      iVar5 = validate_device_properties_and_state(param_1,&local_24,0);
      initialize_device_and_ble_connection(param_1);
      if (iVar5 == 0) {
        iVar4 = *(int *)(param_1 + 4);
