...

{
  ...
  if ((param_2 != (char *)0x0) && (*param_2 != '\0')) {
    ...
    iVar2 = check_and_allocate_memory_with_fallback(iVar4,&local_1c,param_2);
    pcVar1 = local_1c;
    if (local_1c != (char *)0x0) {
      if (iVar2 != 0) {
        mutex_unlock(iVar3);
        process_resource_allocation_with_callback(iVar4,pcVar1,param_2,param_3);
        return;
      }
      safe_string_copy_with_padding(local_1c + 0x40,param_2,0x20);
