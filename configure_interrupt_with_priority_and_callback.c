/*
 * Function: configure_interrupt_with_priority_and_callback
 * Entry:    0006567c
 * Prototype: undefined configure_interrupt_with_priority_and_callback()
 */


int configure_interrupt_with_priority_and_callback
              (uint param_1,uint param_2,byte *param_3,int *param_4)

{
  ...
  pbVar13 = param_3;
  uStack_1c = param_4;
  uVar12 = calculate_bit_offset_with_lookup();
...
LAB_000656ca:
    if (param_3 != (byte *)0x0) {
      ...
      uVar12 = check_interrupt_source_enabled_status
                         (param_1,*(undefined4 *)(param_3 + 4),puVar6,uVar8,uVar3,param_2);
      iVar9 = (int)((ulonglong)uVar12 >> 0x20);
      if ((int)uVar12 == 0) {
        iVar11 = iVar4 + 8;
    ...
    uVar3 = check_interrupt_source_and_get_bit_status(param_1);
    if (uVar3 == 0) {
