/*
 * Function: safe_memory_copy_with_overlap_handling
 * Entry:    0005ec84
 * Prototype: undefined safe_memory_copy_with_overlap_handling()
 */


void safe_memory_copy_with_overlap_handling(undefined1 *param_1,undefined1 *param_2,int param_3)
