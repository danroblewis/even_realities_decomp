/*
 * Function: process_data_with_callback_and_validation
 * Entry:    0004abc0
 * Prototype: undefined process_data_with_callback_and_validation(undefined param_1, undefined param_2, undefined param_3, undefined param_4, undefined4 param_5, undefined4 param_6, undefined4 param_7)
 */


int process_data_with_callback_and_validation
              (byte *param_1,int param_2,code *param_3,undefined4 param_4,uint param_5,int param_6,
              uint param_7)
...
LAB_0004abe4:
  ...
  if (param_2 == 0) {
    ...
    for (uVar10 = 0; uVar10 < bVar8; uVar10 = uVar10 + 1) {
      iVar16 = calculate_string_length(pbVar4 + 1);
  ...
  if ((uVar15 == 0) || (-1 < (int)(param_5 << 0x1f))) {
    ...
    if (local_54 == (code *)0x0) {
      ...
      while (pbVar4 + uVar15 != pbVar14) {
        iVar16 = calculate_string_length(*(undefined4 *)(param_1 + (uint)*pbVar14 * 4));
...
LAB_0004acba:
      while( true ) {
        ...
        if (local_54 != (code *)0x0) {
LAB_0004ad68:
          iVar5 = calculate_string_length(puVar11);
          if ((param_6 != 0) && (uVar10 < param_7)) {
...
LAB_0004ace6:
          ...
          local_90 = 0x1000004;
          uStack_84 = uVar9;
          process_and_compress_data_with_validation(&DAT_00088188,0x2480,&local_90,0);
          param_2 = param_2 + -2;
          pbVar14 = pbVar13;
          goto LAB_0004acba;
        }
      ...
      if (pbVar4 == local_70) {
        ...
        *param_1 = (byte)local_58;
        ...
        while( true ) {
          ...
          if (iVar16 < 0) break;
          if (sVar3 == 0) {
            sVar3 = calculate_string_length(uVar9);
            sVar3 = sVar3 + 1;
          }
