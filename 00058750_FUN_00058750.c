/*
 * Function: FUN_00058750
 * Entry:    00058750
 * Prototype: undefined FUN_00058750()
 */


undefined4 FUN_00058750(undefined4 *param_1,uint param_2,int *param_3,undefined4 param_4)

{
  ...
  local_1c = param_4;
  iVar3 = FUN_00080d3e(*param_1,&local_20,param_3,0x2800,param_1,param_2);
  uVar1 = (undefined2)param_2;
  if (iVar3 != 0) {
    uVar2 = (ushort)local_1c;
    local_1c = CONCAT22(0x2801,uVar2 & 0xff00);
    iVar3 = FUN_00080d3e(*param_1,&local_1c);
    if (iVar3 != 0) {
      iVar3 = param_3[4];
      if (iVar3 == 0) {
        return 1;
  ...
  iVar3 = FUN_00080d3e(*param_1,param_3[1]);
  if (iVar3 != 0) {
    param_3[4] = 0;
    return 1;
  }
