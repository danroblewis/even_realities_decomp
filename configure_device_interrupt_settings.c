/*
 * Function: configure_device_interrupt_settings
 * Entry:    00061624
 * Prototype: undefined configure_device_interrupt_settings()
 */


undefined4
configure_device_interrupt_settings(int param_1,uint param_2,uint param_3,undefined4 param_4)
