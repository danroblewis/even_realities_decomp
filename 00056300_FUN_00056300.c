/*
 * Function: FUN_00056300
 * Entry:    00056300
 * Prototype: undefined FUN_00056300()
 */


void FUN_00056300(int param_1,undefined4 param_2)
  ...
  do {
    do {
      ...
      if (iVar1 == 0) {
        ...
        FUN_0007e2ec("WEST_TOPDIR/zephyr/subsys/bluetooth/host/conn.c",uVar2);
      }
