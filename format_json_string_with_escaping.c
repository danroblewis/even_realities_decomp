/*
 * Function: format_json_string_with_escaping
 * Entry:    000644f8
 * Prototype: undefined format_json_string_with_escaping()
 */


undefined4 format_json_string_with_escaping(byte *param_1,int *param_2,undefined4 param_3)
...
switchD_000645f8_caseD_b:
                  process_string_with_error_handling_and_validation
                            (pbVar2,param_2[1] - ((int)pbVar2 - *param_2),"u%04x");
                  pbVar2 = pbVar3 + 5;
                  goto LAB_000645da;
                case 0xc:
                  bVar5 = 0x66;
