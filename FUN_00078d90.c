...

{
  ...
  if (((int)((uint)*(ushort *)(param_2 + 3) << 0x18) < 0) && (param_2[4] == 0)) {
    iVar1 = memory_allocate(param_1,0x40);
    *param_2 = iVar1;
    param_2[4] = iVar1;
    if (iVar1 == 0) {
      *param_1 = 0xc;
...
LAB_00078f56:
    ...
    if (iVar1 == 0) {
      iVar1 = format_integer_for_printf(param_1,&local_88,param_2,0x87737,&local_8c);
    }
    else {
      iVar1 = format_float_for_printf(param_1,&local_88,param_2,0x87737,&local_8c);
    }
