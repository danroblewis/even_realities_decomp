/*
 * Function: manage_ble_connection_list
 * Entry:    00073ec0
 * Prototype: undefined manage_ble_connection_list()
 */


void manage_ble_connection_list(int *param_1,int *param_2,undefined4 param_3,undefined4 param_4)
