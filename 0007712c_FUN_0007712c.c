/*
 * Function: FUN_0007712c
 * Entry:    0007712c
 * Prototype: undefined FUN_0007712c(undefined param_1, undefined param_2, undefined param_3, undefined param_4, undefined4 param_5)
 */


uint FUN_0007712c(undefined4 param_1,uint *param_2,undefined4 param_3,code *param_4,int *param_5)

{
  ...
  puVar1 = (undefined4 *)FUN_00078590();
  uVar7 = *puVar1;
  uVar2 = FUN_0000ef12(uVar7);
  local_30 = 0;
  ...
  *param_5 = (int)(puVar8 + 2);
  ...
  param_2[0x12] = uVar10;
  param_2[0x13] = uVar11;
  iVar3 = FUN_0000de2c(uVar10,uVar11 & 0x7fffffff,0xffffffff,0x7fefffff);
  if ((iVar3 == 0) &&
     (iVar3 = FUN_0000ddf0(uVar10,uVar11 & 0x7fffffff,0xffffffff,0x7fefffff), iVar3 == 0)) {
    iVar3 = FUN_0000dddc(uVar10,uVar11,0,0);
    if (iVar3 != 0) {
...
LAB_000771b6:
    ...
    *param_2 = uVar13 & 0xfffffffb;
    ...
    iVar3 = FUN_0000de2c(uVar10,uVar11,uVar10,uVar11);
    if (iVar3 != 0) {
      pcVar6 = "NAN";
      if ((int)uVar11 < 0) {
        *(undefined1 *)((int)param_2 + 0x43) = 0x2d;
...
LAB_00077214:
    ...
    uVar13 = uVar13 | 0x400;
    *param_2 = uVar13;
    pcVar6 = (char *)FUN_00086cda(uVar10,param_1,param_2[1],uVar13,&local_35,&local_34,bVar12,
                                  &local_30,0);
    if (bVar12 == 0x67) {
...
LAB_0007728c:
  ...
  iVar3 = FUN_00086e1c(param_1,param_2,local_2c,param_3,param_4);
  uVar13 = local_30;
  if (iVar3 == -1) {
    return 0xffffffff;
  }
...
LAB_0007752c:
        ...
        iVar5 = uVar13 - 1;
        iVar3 = FUN_0000ddc8(param_2[0x12],param_2[0x13],0,0);
        if (iVar3 == 0) {
