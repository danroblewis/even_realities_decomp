 ...
 * Entry:    0000e3a0
 * Prototype: undefined FUN_0000e3a0()
 */


int FUN_0000e3a0(float param_1,float param_2,float *param_3,float *param_4,float *param_5,
                int param_6)
...
LAB_0000e3de:
  ...
  fVar4 = (float)FUN_000868fc((param_1 - fVar4) / fVar6);
