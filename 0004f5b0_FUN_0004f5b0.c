/*
 * Function: FUN_0004f5b0
 * Entry:    0004f5b0
 * Prototype: undefined FUN_0004f5b0()
 */
        ...
        while( true ) {
          ...
          if ((*(int *)(&DAT_2000a2d0 + (uVar5 >> 5) * 4) >> (uVar5 & 0x1f)) << 0x1f < 0) {
            if ((code *)puVar9[3] == (code *)0x0) {
              ...
              local_2c = 0x200;
              local_38 = 0x1000003;
              FUN_0004d944(&DAT_000880f0,0x1cc0,&local_38);
            }
            else {
