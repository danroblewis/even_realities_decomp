/*
 * Function: FUN_00057db0
 * Entry:    00057db0
 * Prototype: undefined FUN_00057db0()
 */
  ...
  if ((uVar14 - 6 & 0xff) < 0x11) {
    ...
    case 0:
      ...
      if (iVar8 == 0) {
        local_40 = puVar15[1];
        local_3e = *puVar15;
        iVar11 = FUN_000573f4(1,uVar17,6);
        if (iVar11 == 0) {
          return 0;
        }
        ...
        *puVar12 = 2;
        ...
        iVar11 = FUN_000573f4(7,uVar17,4);
        if (iVar11 == 0) {
          return 0;
        }
    ...
    case 0xe:
      ...
      if (9 < uVar16) {
        ...
        iVar11 = FUN_000573f4(0x15,uVar17,10);
        if (iVar11 == 0) {
          return 0;
        }
...
LAB_00057f58:
          ...
          if (*(int *)(*(int *)(local_44 + 4) + 0x14) != 0) {
            *(undefined1 *)(local_44 + 0xb9) = *(undefined1 *)(puVar15 + 1);
            iVar9 = FUN_00057874(iVar20,local_44,&LAB_000816ae_1);
            if (iVar9 != 0) {
              FUN_000574ec(iVar8);
