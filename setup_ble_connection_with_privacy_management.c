/*
 * Function: setup_ble_connection_with_privacy_management
 * Entry:    0005de70
 * Prototype: undefined setup_ble_connection_with_privacy_management()
 */


undefined4 setup_ble_connection_with_privacy_management(int param_1,int param_2)

{
  ...
  *(byte *)(param_1 + 0xe9) = *(byte *)(param_1 + 0xe9) & 0xfd;
  ...
  if ((*pcVar6 != '\0') && ((pcVar6[6] & 0xc0U) != 0xc0)) {
    ...
    local_3c = 0x200;
    local_48 = 0x1000003;
    process_and_compress_data_wrapper(&DAT_00088180,0x1c40,&local_48);
  ...
  if ((iVar1 == 0) ||
     (iVar1 = find_ble_uuid_in_table(*(undefined1 *)(iVar5 + 8),pcVar6), iVar1 == 0)) {
LAB_0005df2c:
    iVar1 = extract_bit_from_value(param_1 + 4,0xd);
    if (iVar1 != 0) {
      iVar1 = create_ble_attribute_with_properties(2,*(undefined1 *)(iVar5 + 8),iVar7);
      if (iVar1 == 0) {
        uStack_40 = process_data_with_callback_validation_alt6(iVar7);
      ...
      if ((*pcVar4 == '\x01') && ((pcVar4[6] & 0xc0U) == 0x40)) {
        ...
        *(undefined2 *)(iVar1 + 0x3e) = *(undefined2 *)(pcVar4 + 5);
        if ((*(char *)(iVar5 + 0x90) != '\0') && ((*(byte *)(iVar5 + 0x96) & 0xc0) != 0xc0)) {
          ...
          copy_ble_connection_data(iVar1 + 1,pcVar6);
...
LAB_0005dfe0:
        ...
        trigger_system_service_call("WEST_TOPDIR/zephyr/subsys/bluetooth/host/smp.c",uVar3);
      }
      ...
      if (iVar5 != 0) {
        ...
        local_28 = 2;
        process_and_compress_data_wrapper(&DAT_00088180,0x1080,&local_28);
        return 3;
      }
      iVar5 = bluetooth_hci_command_processing_with_validation_and_callback_and_parameter(iVar1);
      if (iVar5 != 0) {
    ...
    iVar2 = validate_ble_connection_parameters_and_characteristics(param_1,iVar1);
    if (iVar2 != 0) {
      cleanup_ble_attribute(iVar1);
      goto LAB_0005df2c;
    }
LAB_0005df70:
    uVar3 = 8;
