/*
 * Function: FUN_00052bf8
 * Entry:    00052bf8
 * Prototype: undefined FUN_00052bf8()
 */
...
undefined4 FUN_00052bf8(uint param_1,uint param_2)

{
  ...
  if (param_1 == 0) {
    ...
    FUN_0007e2ec("WEST_TOPDIR/nrf/drivers/entropy/entropy_cc3xx.c",0x19);
  }
  uVar4 = 0x400;
  uVar3 = 0;
  while( true ) {
