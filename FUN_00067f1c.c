/*
 * Function: FUN_00067f1c
 * Entry:    00067f1c
 * Prototype: undefined FUN_00067f1c()
 */


void FUN_00067f1c(int *param_1,int param_2,undefined4 param_3,undefined4 param_4)

{
  if ((&DAT_2000b41c)[(uint)*(byte *)(param_1 + 1) * 8] != '\x02') {
    ...
    assertion_failure("WEST_TOPDIR/modules/hal/nordic/nrfx/drivers/src/nrfx_wdt.c",0xb8);
  }
