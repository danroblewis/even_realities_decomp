/*
 * Function: FUN_00076ed4
 * Entry:    00076ed4
 * Prototype: undefined FUN_00076ed4()
 */


/* WARNING: Removing unreachable block (ram,0x0007707c) */

int FUN_00076ed4(int param_1,undefined *param_2,byte *param_3,uint *param_4)
...
LAB_00076f76:
    ...
    if (iVar1 != 0) {
      iVar2 = FUN_00086cb6(param_1,param_2,param_3,iVar1);
      if (iVar2 == -1) {
LAB_000770da:
        if ((-1 < *(int *)(param_2 + 100) << 0x1f) &&
           (-1 < (int)((uint)*(ushort *)(param_2 + 0xc) << 0x16))) {
    ...
    if (iVar1 == 0) {
      iVar1 = FUN_00077594(param_1,&local_88,param_2,0x86cb7,&local_8c);
    }
    else {
      iVar1 = FUN_0007712c(param_1,&local_88,param_2,0x86cb7,&local_8c);
    }
