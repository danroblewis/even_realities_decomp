/*
 * Function: FUN_00078f88
 * Entry:    00078f88
 * Prototype: undefined FUN_00078f88()
 */


/* WARNING: Removing unreachable block (ram,0x00079250) */

int FUN_00078f88(undefined4 param_1,undefined4 *param_2,byte *param_3,undefined4 *param_4)
...
LAB_00078ff8:
  ...
  iVar1 = FUN_00086bc8("hlL",uVar3,3);
  if (iVar1 != 0) {
...
LAB_00079156:
      ...
      if (local_18c < 3) {
        iVar1 = FUN_00079278(param_1,&local_1a4,param_2,&local_2a8);
      }
      else {
        if (4 < local_18c) goto LAB_00078fae;
        iVar1 = FUN_0007932c(param_1,&local_1a4,param_2,&local_2a8);
      }
      if (iVar1 == 1) {
        return local_198;
      }
