/*
 * Function: process_audio_data_with_complex_bit_manipulation
 * Entry:    0006f9c0
 * Prototype: undefined __stdcall process_audio_data_with_complex_bit_manipulation(undefined4 buffer_structure, undefined4 param_2, undefined4 param_3, undefined4 param_4, undefined4 param_5, undefined4 param_6, undefined4 param_7, undefined4 param_8)
 */


void process_audio_data_with_complex_bit_manipulation
               (int buffer_structure,int param_2,int param_3,int param_4,int param_5,ushort *param_6
...
LAB_0006fa98:
    if (iVar18 != 0) {
      uVar10 = *(uint *)(buffer_structure + 0x20);
...
joined_r0x0006fad8:
  if ((int)(uVar10 + 3) < 0x21) {
    *(uint *)(buffer_structure + 0x20) = uVar10 + 3;
    *(uint *)(buffer_structure + 0x1c) =
         *(uint *)(buffer_structure + 0x1c) | uVar7 << (uVar10 & 0xff);
  }
  else {
    write_data_to_buffer_with_bit_manipulation(buffer_structure,uVar7,3);
  }
...
LAB_0006fd54:
            do {
              while( true ) {
                ...
                if ((int)uVar12 < 0x21) {
                  *(uint *)(buffer_structure + 0x20) = uVar12;
                  *(uint *)(buffer_structure + 0x1c) =
                       *(uint *)(buffer_structure + 0x1c) | uVar8 << (uVar5 & 0xff);
                }
                else {
                  write_data_to_buffer_with_bit_manipulation(buffer_structure,uVar8,1);
                  uVar12 = *(uint *)(buffer_structure + 0x20);
                }
                uVar5 = (int)uVar20 >> (uVar21 & 0xff) & 1;
                if ((int)(uVar12 + 1) < 0x21) {
                  *(uint *)(buffer_structure + 0x20) = uVar12 + 1;
                  *(uint *)(buffer_structure + 0x1c) =
                       *(uint *)(buffer_structure + 0x1c) | uVar5 << (uVar12 & 0xff);
                }
                else {
                  write_data_to_buffer_with_bit_manipulation(buffer_structure,uVar5,1);
                }
                uVar5 = uVar21;
                if (2 < (int)uVar21) {
                  uVar5 = 3;
                ...
                bVar1 = pbVar22[uVar5];
                uVar5 = *(uint *)(buffer_structure + 8) >> 10;
                uVar8 = uVar5 * *(ushort *)(&DAT_0008dc90 + (uint)bVar1 * 0x44) +
                        *(int *)(buffer_structure + 4);
                *(uint *)(buffer_structure + 4) = uVar8;
                uVar5 = uVar5 * *(ushort *)(&DAT_0008dc92 + (uint)bVar1 * 0x44);
                *(uint *)(buffer_structure + 4) = uVar8 & 0xffffff;
                *(uint *)(buffer_structure + 8) = uVar5;
                uVar21 = uVar21 + 1;
                *(uint *)(buffer_structure + 0x10) =
                     *(uint *)(buffer_structure + 0x10) | uVar8 >> 0x18;
                uVar17 = (int)uVar17 >> 1;
...
LAB_0006fd7e:
            ...
            bVar1 = *pbVar22;
            uVar21 = *(uint *)(buffer_structure + 8) >> 10;
            uVar11 = uVar21 * *(ushort *)(&DAT_0008dc90 + (uint)bVar1 * 0x44) +
                     *(int *)(buffer_structure + 4);
            *(uint *)(buffer_structure + 4) = uVar11;
            uVar21 = uVar21 * *(ushort *)(&DAT_0008dc92 + (uint)bVar1 * 0x44);
            *(uint *)(buffer_structure + 8) = uVar21;
            *(uint *)(buffer_structure + 0x10) = *(uint *)(buffer_structure + 0x10) | uVar11 >> 0x18
            ;
            *(uint *)(buffer_structure + 4) = uVar11 & 0xffffff;
            if (uVar21 < 0x10000) {
              flush_buffer_data(buffer_structure);
            }
            uVar17 = (int)uVar17 >> 1;
        ...
        if (uVar11 != 0) {
          uVar11 = *(uint *)(buffer_structure + 0x20);
          uVar3 = *puVar4;
          iVar25 = uVar11 + 1;
          if (iVar25 < 0x21) {
            *(int *)(buffer_structure + 0x20) = iVar25;
            *(uint *)(buffer_structure + 0x1c) =
                 *(uint *)(buffer_structure + 0x1c) | (uVar3 & 1) << (uVar11 & 0xff);
          }
          else {
            write_data_to_buffer_with_bit_manipulation(buffer_structure,uVar3 & 1,1);
          }
        }
        if (uVar21 != 0) {
          uVar21 = *(uint *)(buffer_structure + 0x20);
          uVar3 = puVar4[1];
          iVar25 = uVar21 + 1;
          if (iVar25 < 0x21) {
            *(int *)(buffer_structure + 0x20) = iVar25;
            *(uint *)(buffer_structure + 0x1c) =
                 *(uint *)(buffer_structure + 0x1c) | (uVar3 & 1) << (uVar21 & 0xff);
          }
          else {
            write_data_to_buffer_with_bit_manipulation(buffer_structure,uVar3 & 1,1);
          }
    ...
    local_40 = local_40 - 1;
    if (bVar26) {
      uVar29 = calculate_buffer_available_space(buffer_structure);
      iVar25 = (int)uVar29;
      if (uVar15 == 0) {
        if ((0 < iVar16) && (0 < iVar25)) {
          ...
          while( true ) {
            while( true ) {
              ...
              iVar16 = *(uint *)(buffer_structure + 0x20) + 1;
              if (*param_8 < (float)(longlong)(int)uVar15) {
                iVar25 = 0;
              }
              if (iVar16 < 0x21) {
                uVar15 = iVar25 << (*(uint *)(buffer_structure + 0x20) & 0xff);
                *(uint *)(buffer_structure + 0x1c) = *(uint *)(buffer_structure + 0x1c) | uVar15;
                *(int *)(buffer_structure + 0x20) = iVar16;
              }
              else {
                write_data_to_buffer_with_bit_manipulation(buffer_structure,iVar25,1);
                uVar15 = extraout_r1;
              }
              iVar25 = (int)uVar29 + -1;
        ...
        while( true ) {
          ...
          uVar15 = *(uint *)(buffer_structure + 0x20);
          iVar9 = iVar25 + -1;
          iVar16 = uVar15 + 1;
          uVar10 = uVar3 >> 1 & 1;
          if (iVar16 < 0x21) {
            *(int *)(buffer_structure + 0x20) = iVar16;
            *(uint *)(buffer_structure + 0x1c) =
                 *(uint *)(buffer_structure + 0x1c) | uVar10 << (uVar15 & 0xff);
          }
          else {
            write_data_to_buffer_with_bit_manipulation(buffer_structure,uVar10,1);
          }
          if (uVar3 >> 1 == 1) {
            if (iVar9 == 0) {
              return;
            ...
            if (iVar16 < 0x21) {
              *(int *)(buffer_structure + 0x20) = iVar16;
              *(uint *)(buffer_structure + 0x1c) =
                   *(uint *)(buffer_structure + 0x1c) | (uVar3 & 1) << (uVar15 & 0xff);
            }
            else {
              write_data_to_buffer_with_bit_manipulation(buffer_structure,uVar3 & 1,1);
            }
          ...
          if (uVar2 >> 1 == 1) {
            if (0 < iVar25) {
              ...
              if (iVar25 < 0x21) {
                *(int *)(buffer_structure + 0x20) = iVar25;
                *(uint *)(buffer_structure + 0x1c) =
                     *(uint *)(buffer_structure + 0x1c) | (uVar2 & 1) << (uVar15 & 0xff);
              }
              else {
                write_data_to_buffer_with_bit_manipulation(buffer_structure,uVar2 & 1,1);
              }
            }
            iVar25 = iVar9 + -2;
          }
