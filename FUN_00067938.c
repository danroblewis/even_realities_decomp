/*
 * Function: FUN_00067938
 * Entry:    00067938
 * Prototype: undefined FUN_00067938()
 */


undefined4 FUN_00067938(undefined4 *param_1,byte *param_2,uint param_3,undefined4 param_4)
...
LAB_00067968:
      ...
      assertion_failure("WEST_TOPDIR/modules/hal/nordic/nrfx/drivers/src/nrfx_twim.c",uVar2);
    }
    if ((param_3 & 8) != 0) {
      DEBUG_PRINT2("ASSERTION FAIL [%s] @ %s:%d\n","!(flags & (1UL << 3))",
    ...
    param_1[2] = 1;
    do {
      iVar3 = FUN_0008539a(param_1,0x100000);
    } while (iVar3 != 0);
    uVar2 = *(undefined4 *)(&DAT_2000b3e4 + iVar1);
    ...
    if (*param_2 == 1) {
      *param_1 = 1;
      if (iVar6 == 0) {
        ...
        do {
          uVar5 = FUN_0008539a(param_1,0x40202);
          if ((uVar5 & 0x200) != 0) {
            param_1[5] = 1;
          }
...
LAB_00067c96:
        do {
          ...
          uVar5 = FUN_0008539a(param_1,0x40202);
          if ((uVar5 & 0x200) != 0) {
            iVar3 = FUN_0008539a(param_1,0x1000000);
            if (iVar3 == 0) {
              param_1[8] = 1;
              param_1[5] = 1;
            }
...
LAB_00067cee:
  ...
  if (uVar5 == 0) {
    if (((param_3 & 0x40) == 0) && (iVar3 = FUN_00085316(param_1,&DAT_2000b3cc + iVar1), iVar3 == 0)
       ) {
      uVar2 = 0xbad0001;
    }
  }
