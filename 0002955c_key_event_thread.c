      ...
      if (*param_1 == '\x01') {
        ...
        *(undefined1 *)(iVar6 + 0xcb) = *(undefined1 *)(iVar3 + 0xed5);
        ...
        do {
          ...
          uVar7 = FUN_00027448(param_1,6,0);
        } while (499 < uVar7);
        if (0 < LOG_LEVEL) {
...
LAB_00029cf8:
  ...
  case 4:
    if (**(char **)(param_1 + 0x1014) == '\0') {
      DAT_20018d95 = 1;
      if (*param_1 != '\x01') {
        if (((DAT_20018d96 == '\0') && (iVar3 = FUN_00026c28(), iVar3 != 0)) &&
