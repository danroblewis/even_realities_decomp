/*
 * Function: wait_for_and_consume_audio_buffer
 * Entry:    00085b0c
 * Prototype: undefined wait_for_and_consume_audio_buffer()
 */


int * wait_for_and_consume_audio_buffer(int param_1,int *param_2,int param_3)

{
  ...
  iVar1 = param_1 + 0x58;
  while( true ) {
    manage_ble_connection_state_wrapper_alt(iVar1);
    piVar3 = *(int **)(param_1 + 0xb4);
    iVar4 = *(int *)(*(int *)(param_1 + 0xa0) + 0x18);
    if ((piVar3 != (int *)(param_1 + 0xb4)) && (piVar3 != (int *)0x0)) break;
    if (iVar4 == 0) {
      piVar3 = (int *)consume_audio_buffer_descriptor
                                (*(undefined4 *)(param_1 + 0xa8),param_2,(int)&uStack_24 + 2,
                                 *(int *)(param_1 + 0xa0),iVar5);
      if (piVar3 != (int *)0x0) goto LAB_00085b6a;
      if (*(short *)(*(int *)(param_1 + 0xa8) + 0x24) == 0) goto LAB_00085b90;
      piVar3 = (int *)adjust_buffer_pointer_and_size
                                (*(undefined4 *)(param_1 + 0xb0),*(undefined4 *)(param_1 + 0x94));
