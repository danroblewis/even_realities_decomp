/*
 * Function: format_float_with_precision_and_rounding
 * Entry:    00078110
 * Prototype: undefined format_float_with_precision_and_rounding(undefined param_1, undefined param_2, undefined param_3, undefined param_4, undefined4 param_5, undefined4 param_6)
 */


byte * format_float_with_precision_and_rounding
...
LAB_00078272:
  ...
  iVar7 = manage_float_context_with_memory_allocation(param_1,iVar7);
  if (iVar7 == 0) {
    uVar12 = 0xde;
LAB_0007826c:
    process_data_loop_with_validation_and_retry
              ("/__w/_temp/workspace/build/.build/HOST-x86_64-w64-mingw32/arm-zephyr-eabi/src/newlib-nano/newlib/libc/stdlib/gdtoa-gethex.c"
  ...
  *(int *)(iVar7 + 0x10) = iVar16;
  ...
  if ((int)pbVar18 < iVar8) {
    ...
    if (iVar8 < (int)pbVar18) {
      ...
      iVar7 = shift_float_left_with_memory_management(param_1,iVar7,(int)pbVar18 - iVar8);
      puVar19 = (uint *)(iVar7 + 0x14);
    }
    uVar21 = 0;
  }
  ...
  if ((int)pbVar15 < param_3[1]) {
    ...
    if ((int)pbVar18 <= (int)pbVar15) {
      ...
      if (iVar6 == 2) {
        ...
        if (param_6 == 0) {
LAB_000783e8:
          cleanup_float_context_with_memory_management(param_1,iVar7);
          *param_5 = 0;
          return (byte *)0x50;
        }
      }
...
joined_r0x0007846c:
  ...
  if (*(int *)(iVar7 + 8) <= iVar16) {
    iVar8 = manage_float_context_with_memory_allocation(param_1,*(int *)(iVar7 + 4) + 1);
    if (iVar8 == 0) {
      uVar12 = 0x84;
      goto LAB_0007826c;
    }
...
LAB_000782f2:
      cleanup_float_context_with_memory_management(param_1,iVar8);
      *param_5 = 0;
      return (byte *)0xa3;
    }
  }
