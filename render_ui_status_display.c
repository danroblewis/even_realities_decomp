/*
 * Function: render_ui_status_display
 * Entry:    00036d38
 * Prototype: undefined render_ui_status_display()
 */


void render_ui_status_display(void)

{
  ...
  uVar1 = get_system_byte_1_alt();
  if (CURRENT_LANGUAGE_ID != uVar1) {
    CURRENT_LANGUAGE_ID = (byte)uVar1;
    iVar2 = get_work_mode();
