/*
 * Function: manage_ble_connection_state_and_cleanup
 * Entry:    0005a3c4
 * Prototype: undefined manage_ble_connection_state_and_cleanup()
 */


undefined4 manage_ble_connection_state_and_cleanup(int param_1,undefined4 param_2,int param_3)

{
  ...
  if ((*(int *)(param_1 + 8) == 0x5a465) &&
    ...
    if (*(short *)(puVar2 + 8) != 0) {
      puVar3 = puVar2 + 1;
      iVar1 = ble_uuid_comparison_handler(param_3,*puVar2,puVar3);
      if (iVar1 == 0) {
