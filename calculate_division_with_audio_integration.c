/*
 * Function: calculate_division_with_audio_integration
 * Entry:    000869c2
 * Prototype: undefined calculate_division_with_audio_integration()
 */


float calculate_division_with_audio_integration(float param_1,float param_2)

{
  ...
  if (((uint)fVar2 < 0x7f800001) && (fVar3 = ABS(param_1), (uint)fVar3 < 0x7f800001)) {
    if (param_2 == 1.0) {
      fVar2 = (float)calculate_arctangent_function();
      return fVar2;
    }
        ...
        if (fVar3 != INFINITY) {
          ...
          if ((int)fVar3 - (int)fVar2 < 0x1e800000) {
            if (((int)param_2 < 0) && (iVar1 + 0x3c < 0 != SCARRY4(iVar1,0x3c))) {
              ...
              setup_audio_mixing(param_1 / param_2);
              fVar2 = (float)calculate_arctangent_function();
            }
          }
          else {
