/*
 * Function: FUN_00058930
 * Entry:    00058930
 * Prototype: undefined FUN_00058930()
 */


undefined4 FUN_00058930(undefined4 param_1,undefined4 *param_2)
    ...
    *puVar1 = param_1;
    ...
    if (iVar2 == 0) {
      ...
      *(undefined **)(iVar2 + 0xc) = &DAT_200029ac;
      FUN_000864e8(iVar2 + 0x128);
      puVar1 = local_1c;
      uVar3 = local_1c[0x48];
      local_1c[0x48] = 0;
      *local_1c = local_20;
      if (local_20[0xc] == 0) {
        FUN_000864e8(local_20 + 3,0,uVar3);
        local_20[10] = 0;
        local_20[0xb] = 0;
      }
      puVar4 = puVar1 + 100;
