/*
 * Function: FUN_0000ea70
 * Entry:    0000ea70
 * Prototype: undefined FUN_0000ea70()
 */


void FUN_0000ea70(float param_1,float *param_2,undefined4 *param_3,float *param_4)
