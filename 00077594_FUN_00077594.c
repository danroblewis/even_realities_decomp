/*
 * Function: FUN_00077594
 * Entry:    00077594
 * Prototype: undefined FUN_00077594(undefined param_1, undefined param_2, undefined param_3, undefined param_4, undefined4 param_5)
 */


code * FUN_00077594(undefined4 param_1,uint *param_2,undefined4 param_3,code *param_4,int *param_5)
...
LAB_00077776:
    ...
    case 0x73:
      ...
      *param_5 = (int)(puVar12 + 1);
      pcVar8 = (char *)*puVar12;
      iVar3 = FUN_00086bc8(pcVar8,0,param_2[1],puVar12,param_1,param_2,param_3);
      if (iVar3 != 0) {
...
LAB_00077674:
  ...
  pcVar8 = pcVar13;
LAB_000776aa:
  iVar3 = FUN_00086e1c(param_1,param_2,&local_24,param_3,param_4);
