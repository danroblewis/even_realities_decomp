/*
 * Function: FUN_0005b554
 * Entry:    0005b554
 * Prototype: undefined FUN_0005b554()
 */


undefined4 FUN_0005b554(int param_1,undefined4 param_2,int *param_3)

{
  ...
  if (*(int *)(param_1 + 8) == 0x5a465) {
    ...
    if ((*(short *)(puVar6 + 8) != 0) &&
       (iVar2 = FUN_000814e6(iVar5,*puVar6,puVar6 + 1), iVar2 != 0)) {
      local_48 = FUN_00082cba(iVar5,param_1,0x12a);
      if (local_48 != 0) {
        if (local_48 == 3) {
          local_44 = "CCC %p not writable";
          iStack_40 = param_1;
          FUN_00082a42(&DAT_00088128,0x1880,&local_48);
          return 1;
        }
        if (local_48 == 5) {
          uVar7 = 3;
      ...
      FUN_000825c0(param_1,puVar6);
      if (((puVar6 == &DAT_20002a20) &&
          (iVar2 = FUN_00059bcc(*(undefined1 *)(iVar5 + 8),iVar5 + 0x90), iVar2 != 0)) &&
         ((*(short *)(iVar2 + 8) != 0 || (*(short *)(iVar2 + 10) != 0)))) {
        iVar4 = FUN_000569a0(iVar5);
        ...
        *(undefined2 *)(&DAT_2000aed0 + iVar2) = 4;
        iVar5 = FUN_0005b378(iVar5,(short)iVar4 * 0x18 + 0x2000aebc);
        if (iVar5 != 0) {
