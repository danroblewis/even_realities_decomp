/*
 * Function: process_audio_data_with_threshold_calculations
 * Entry:    0006f4a0
 * Prototype: undefined process_audio_data_with_threshold_calculations(undefined param_1, undefined param_2, undefined param_3, undefined param_4, undefined4 param_5, undefined4 param_6, undefined4 param_7, undefined4 param_8, undefined4 param_9)
 */


void process_audio_data_with_threshold_calculations
...

{
  ...
  local_84 = param_1;
  local_78 = param_2;
  iVar2 = calculate_sensor_threshold_value(param_2,iVar7);
  iVar3 = calculate_audio_timing_offset(param_4);
  iVar4 = get_audio_processing_constant();
  iVar5 = calculate_audio_bitrate_from_configuration(param_5);
...
LAB_0006f712:
    ...
    *puVar11 = param_8;
    process_audio_data_with_scaling_and_thresholds(iVar12,iVar10,iVar8,param_7);
    puVar11[1] = 0;
    puVar11[2] = 0;
    *puVar11 = param_9 + 1;
    iVar12 = process_audio_data_with_bitrate_calculation(iVar12,iVar10,local_88,param_8);
    fVar20 = 0.0;
  }
  else {
...
LAB_0006f8ec:
  ...
  puVar11[1] = param_9 + 1;
  *puVar11 = param_8;
  process_audio_data_with_scaling_and_thresholds(local_84,local_78,uVar9,param_7);
...
LAB_0006f7b4:
  ...
  *puVar11 = param_9 + 1;
  puVar11[1] = local_7c;
  process_audio_data_with_bitrate_calculation(local_84,local_78,local_88,param_8);
  return;
}
