/*
 * Function: FUN_000365ec
 * Entry:    000365ec
 * Prototype: undefined FUN_000365ec()
 */
...

{
  ...
  if (iVar2 == 0) {
    ...
    if (iVar2 == 0) {
      ...
      iVar2 = FUN_0007d1c8((int)&uStack_58 + 2);
      iVar4 = FUN_0007d1c8(local_50 + 1);
      iVar5 = FUN_0007d1c8(auStack_48);
      if (local_42 == 1) {
        iVar9 = iVar4 + 7;
        DAT_20009fc4 = 0;
        if (iVar9 < 0) {
        ...
        for (iVar2 = 0; iVar2 < iVar5; iVar2 = iVar2 + 1) {
          ...
          for (iVar6 = 0; iVar6 < iVar9 >> 3; iVar6 = iVar6 + 1) {
            FUN_00036558(~*(byte *)((int)puVar1 + iVar6),iVar4);
          }
          if (DAT_20009fcc != 0) {
            DAT_20009fc8 = 0;
            iVar6 = get_work_mode();
            memcpy(*(undefined4 *)(iVar6 + iVar2 * 4 + 0xb90),DAT_20009fcc,0x140);
          }
