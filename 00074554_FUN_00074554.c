/*
 * Function: FUN_00074554
 * Entry:    00074554
 * Prototype: undefined FUN_00074554()
 */


void FUN_00074554(undefined4 param_1,int param_2)

{
  ...
  if (param_2 + 0x10U < 0x1f) {
    ...
    if (uVar4 == 0) {
      iVar2 = FUN_00074060();
      if ((iVar2 != 0) && (*(char *)(DAT_2000b450 + 0xf) == '\0')) {
        uVar3 = 0;
        bVar1 = (bool)isCurrentModePrivileged();
        if (bVar1) {
  ...
  FUN_0007e2ec("WEST_TOPDIR/zephyr/kernel/sched.c",uVar3);
}
