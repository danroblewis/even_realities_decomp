/*
 * Function: FUN_000745c8
 * Entry:    000745c8
 * Prototype: undefined FUN_000745c8()
 */
...

{
  ...
  if (uVar8 == 0) {
    ...
    if (iVar4 == 0) {
      ...
      *(byte *)((int)DAT_2000b450 + 0xd) = *(byte *)((int)DAT_2000b450 + 0xd) & 0x7f;
      FUN_00073cdc(&DAT_2000b464);
      puVar2 = DAT_2000b450;
      *(byte *)((int)DAT_2000b450 + 0xd) = *(byte *)((int)DAT_2000b450 + 0xd) | 0x80;
