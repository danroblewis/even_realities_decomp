/*
 * Function: manage_ble_memory_with_display_integration
 * Entry:    000719f4
 * Prototype: undefined manage_ble_memory_with_display_integration(undefined param_1, undefined param_2, undefined param_3, undefined param_4, undefined4 param_5)
 */


int manage_ble_memory_with_display_integration
              (int *param_1,uint param_2,uint param_3,undefined4 param_4,uint param_5,uint param_6)

{
  ...
  iVar2 = check_connection_state_validity(piVar6);
  if (iVar2 == 0) {
LAB_00071a32:
    ...
    update_connection_state_flags(piVar6);
    uVar5 = 0;
    bVar1 = (bool)isCurrentModePrivileged();
    if (bVar1) {
    ...
    while ((iVar2 = allocate_heap_memory_with_alignment(param_1,param_2,param_3,uVar5), iVar2 == 0
      ...
      param_6 = uStack_2c;
      param_5 = local_30;
      handle_ble_connection_state_transition(piVar6,uVar7,param_1 + 3,uStack_2c,local_30,uStack_2c);
      uVar7 = 0;
      bVar1 = (bool)isCurrentModePrivileged();
      if (bVar1) {
        uVar7 = getBasePriority();
    ...
    iVar4 = validate_and_clear_connection_state(piVar6);
    if (iVar4 != 0) {
      bVar1 = (bool)isCurrentModePrivileged();
      if (bVar1) {
