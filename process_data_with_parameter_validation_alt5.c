/*
 * Function: process_data_with_parameter_validation_alt5
 * Entry:    000521fc
 * Prototype: undefined process_data_with_parameter_validation_alt5()
 */


/* WARNING: Type propagation algorithm not settling */

undefined4 process_data_with_parameter_validation_alt5(int param_1)

{
  ...
  iVar2 = process_command_table(iVar2 + 4,&local_98,6,&local_f4);
  if (iVar2 != 0) {
    return 3;
  }
  uVar1 = process_data_with_callback_and_parameter_alt2(auStack_d8,local_f0);
  iVar2 = local_d4[0];
  uVar3 = 0;
  if (uVar1 == 0) {
    if (local_e0 == '\0') {
    ...
    process_and_compress_data_with_validation(&DAT_00088208,0x1840,&local_108,0);
LAB_00052300:
    iVar2 = process_data_with_callback_execution_alt2(iVar4 + 4,1,uVar1 & 0xffff);
    process_data_with_validation_and_callback_alt4(1,0,auStack_b8);
    process_data_with_callback_execution_alt4();
    if (iVar2 == 0) {
      uVar3 = 7;
