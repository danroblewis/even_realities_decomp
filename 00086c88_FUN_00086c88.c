/*
 * Function: FUN_00086c88
 * Entry:    00086c88
 * Prototype: undefined FUN_00086c88()
 */


uint FUN_00086c88(int param_1,uint param_2,int *param_3)

{
  ...
  if (((iVar1 < 0) && (uVar2 = param_3[4], uVar2 != 0)) ||
    ...
    if ((iVar4 < param_3[5]) || (iVar4 = FUN_00076ad0(param_1,param_3), iVar4 == 0)) {
      ...
      *puVar3 = (char)param_2;
      ...
      iVar4 = FUN_00076ad0(param_1,param_3);
      if (iVar4 == 0) {
        return uVar2;
      }
    }
