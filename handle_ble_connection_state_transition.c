 ...
 * Entry:    00081b30
 * Prototype: undefined handle_ble_connection_state_transition()
 */
  ...
  if (*param_1 == 0) {
    ...
    *(char *)(param_1 + 0x2e) = (char)uVar1;
    ...
    if (iVar2 == 0) {
      ...
      puVar3 = (undefined2 *)ble_memory_allocation_utility(iVar2 + 0xc,4);
      *puVar3 = (short)param_1[9];
      puVar3[1] = (short)param_1[5];
      handle_ble_connection_state_transition_to_state_5_with_timeout
                (param_1,iVar2,0x10000,0,param_4);
      uVar1 = 0;
