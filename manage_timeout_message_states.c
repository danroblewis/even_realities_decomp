/*
 * Function: manage_timeout_message_states
 * Entry:    00034274
 * Prototype: undefined manage_timeout_message_states()
 */


undefined1 manage_timeout_message_states(void)
