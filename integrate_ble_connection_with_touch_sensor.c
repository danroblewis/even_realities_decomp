/*
 * Function: integrate_ble_connection_with_touch_sensor
 * Entry:    000746fc
 * Prototype: undefined integrate_ble_connection_with_touch_sensor()
 */


int integrate_ble_connection_with_touch_sensor(uint param_1,int param_2)
