...

{
  ...
  if (param_5 == 0) {
    ...
    if (-1 < iVar1) {
      ...
      uVar2 = FUN_000431a8();
      if ((uVar2 & 2) != 0) {
        _clean_fb_data(DAT_2000a034,0,param_2,param_3,local_24 + 2 + param_2,local_20 + param_3);
      }
      FUN_0007d53a(DAT_2000a034,param_4,local_24 / 2,local_20,param_2,param_3);
      iVar1 = FUN_000431a8();
      if (iVar1 << 0x1e < 0) {
        iVar1 = get_work_mode();
