/*
 * Function: FUN_000571e8
 * Entry:    000571e8
 * Prototype: undefined FUN_000571e8()
 */


void FUN_000571e8(int param_1)

{
  ...
  if ((*(char *)(param_1 + 0xd) == '\0') &&
    ...
    FUN_00056300(param_1);
    return;
  }
  iVar2 = FUN_0008652c(param_1 + 0x38);
  if (iVar2 == 0) {
  ...
  if ((DAT_20002104 < *(ushort *)(iVar2 + 0x10)) || (bVar6 != 0)) {
    while (DAT_20002104 < *(ushort *)(iVar2 + 0x10)) {
      iVar5 = FUN_000571dc(0,uVar4,0xffffffff,0xffffffff);
      ...
      *(undefined1 *)(iVar5 + 0x1d) = *(undefined1 *)(iVar2 + 0x1d);
      uVar7 = FUN_000560cc(param_1,iVar2,iVar5,bVar6);
      uVar4 = (undefined4)((ulonglong)uVar7 >> 0x20);
      iVar3 = (int)uVar7;
      if (iVar3 != 0) {
  ...
  iVar3 = FUN_000560cc(param_1,iVar2,0,uVar4);
LAB_000572be:
  FUN_0005f24c(iVar2);
  if (iVar3 == -5) {
