/*
 * Function: FUN_0006ab80
 * Entry:    0006ab80
 * Prototype: undefined FUN_0006ab80(undefined param_1, undefined param_2, undefined param_3, undefined param_4, undefined4 param_5)
 */
...

{
  ...
  if (param_1 == 0) {
    ...
    (*(code *)(&PTR_FUN_0006aa98_1_0008c938)[param_2])(param_3 + 0x10,param_4,pcVar20,0x60);
    ...
    (*(code *)(&PTR_FUN_0006aa98_1_0008c938)[param_2])(param_3 + 0x10,param_4,pcVar20,0x80);
    iVar8 = 0x80;
  ...
  iVar8 = FUN_00086c44(param_3 + 800,param_3 + 800 + iVar8,iVar17);
  ...
  iVar8 = FUN_000698d0(param_3,(char *)(iVar8 + iVar17),local_7c[0],local_7c + 1);
  fVar33 = local_80;
  if (iVar8 == 0) {
    if (*param_3 == '\0') {
      fVar33 = 0.0;
  ...
  *(int *)((int)aiStack_98 + iVar22) = iVar17 + 9;
  FUN_0006954c(pcVar20,pcVar20 + iVar9 * 2,fVar33,local_7c + 2);
  fVar33 = local_80;
  if (iVar17 < 1) {
    iVar17 = 0x10;
  }
...
LAB_0006adce:
  ...
  *(int *)(param_5 + 4) = iVar17;
  FUN_00069468(pcVar20,local_80,0,auStack_90 + iVar15);
  puVar16 = local_8c;
  FUN_00069468(pcVar20 + ((int)uVar21 >> 2) * -2,fVar33,uVar21 & 3,local_8c);
