/*
 * Function: manage_comprehensive_device_configuration
 * Entry:    0005f760
 * Prototype: undefined manage_comprehensive_device_configuration()
 */


/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */

int manage_comprehensive_device_configuration(undefined4 param_1,int *param_2)

{
  ...
  manage_ble_connection_state_comprehensive(&DAT_200021d0,param_2,0xffffffff,0xffffffff);
  uVar9 = param_2[1];
  if (uVar9 - 1 < 0xff) {
    uVar4 = 0;
    uVar6 = 0;
...
LAB_0005f948:
      ...
      iVar3 = manage_ble_connection_state_comprehensive(&DAT_200021e8,uVar5,0xffffffff,0xffffffff);
      iVar8 = DAT_20002200;
      if (iVar3 != 0) {
        iVar8 = iVar3;
        DAT_20002200 = iVar3;
