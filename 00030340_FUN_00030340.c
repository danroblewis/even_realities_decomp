/*
 * Function: FUN_00030340
 * Entry:    00030340
 * Prototype: undefined FUN_00030340()
 */


undefined4 FUN_00030340(uint param_1,uint param_2,byte *param_3,uint param_4)

{
  ...
  *(short *)(puVar3 + 3) = (short)uVar7;
  ...
  iVar9 = FUN_00030178(0x1c10,&DAT_20000800);
  if (iVar9 != 0) {
    return 0xffffffff;
  }
  iVar9 = FUN_00030178(0x4408,0x15);
  if (iVar9 != 0) {
    return 0xffffffff;
  }
  ...
  while( true ) {
    iVar4 = FUN_000302f8(0x4410,&local_24);
    if (iVar4 != 0) {
      return 0xffffffff;
    }
