/*
 * Function: FUN_00059550
 * Entry:    00059550
 * Prototype: undefined FUN_00059550()
 */


undefined4 FUN_00059550(undefined4 param_1,int param_2)

{
  ...
  if (uVar7 != 0) {
    if (uVar2 == 0) {
      ...
      local_36 = puVar4[2];
      iVar5 = FUN_00080d3e(local_38,&local_34);
      if (iVar5 == 0) {
        uVar1 = *(undefined1 *)(param_2 + 0x10);
        fill_memory_buffer(&local_34,0,0x14);
        local_30 = FUN_00058f34(param_1,7,0);
        if (local_30 == 0) {
          return 0x11;
        }
        local_23 = '\n';
        ...
        FUN_0005833c(*(undefined4 *)(local_30 + 0x18));
