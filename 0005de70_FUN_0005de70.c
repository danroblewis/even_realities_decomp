      ...
      if ((*pcVar4 == '\x01') && ((pcVar4[6] & 0xc0U) == 0x40)) {
        ...
        *(undefined2 *)(iVar1 + 0x3e) = *(undefined2 *)(pcVar4 + 5);
        if ((*(char *)(iVar5 + 0x90) != '\0') && ((*(byte *)(iVar5 + 0x96) & 0xc0) != 0xc0)) {
          local_38 = iVar7;
          pcStack_34 = pcVar6;
          FUN_00056960(1,0x831e3,&local_38);
...
LAB_0005dfe0:
        ...
        FUN_0007e2ec("WEST_TOPDIR/zephyr/subsys/bluetooth/host/smp.c",uVar3);
      }
