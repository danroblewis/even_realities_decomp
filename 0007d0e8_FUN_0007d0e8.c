/*
 * Function: FUN_0007d0e8
 * Entry:    0007d0e8
 * Prototype: undefined FUN_0007d0e8()
 */
...
undefined4 FUN_0007d0e8(int param_1,int param_2,undefined4 *param_3,uint *param_4)
  ...
  if ((((param_2 == 0) || (param_3 == (undefined4 *)0x0)) || (param_4 == (uint *)0x0)) ||
    ...
    if (param_1 == 0) {
      if (((param_2 == 0) || (param_3 == (undefined4 *)0x0)) || (param_4 == (uint *)0x0)) {
        ...
        iVar8 = FUN_00025788(param_2,0x2006,&stack0xffffffeb,1);
        if (iVar8 == 0) {
          uVar2 = 0xfffffffd;
        }
        else {
