/*
 * Function: thunk_FUN_00072908
 * Entry:    0007cb48
 * Prototype: undefined thunk_FUN_00072908()
 */


undefined4 thunk_FUN_00072908(int param_1,undefined4 param_2,uint param_3,uint param_4)
    ...
    if (iVar3 == 0) {
      ...
      if (*(int *)(param_1 + 8) == 0) {
        if ((param_3 | param_4) != 0) {
          uVar4 = FUN_00073f6c(&DAT_2000b474,uVar4,param_1,param_3 | param_4,param_3,param_4);
          return uVar4;
        }
        iVar3 = FUN_0007205c(&DAT_2000b474);
        if (iVar3 != 0) {
          bVar1 = (bool)isCurrentModePrivileged();
          if (bVar1) {
