/*
 * Function: configure_comprehensive_interrupt_settings
 * Entry:    00066ec0
 * Prototype: undefined configure_comprehensive_interrupt_settings()
 */


void configure_comprehensive_interrupt_settings(int *param_1,undefined4 *param_2)
...
LAB_00066ef2:
  ...
  if (*(char *)((int)param_2 + 0x23) == '\0') {
    ...
    configure_interrupt_settings(*param_2,1,0,uVar14,1 < *(byte *)(param_2 + 6));
    configure_interrupt_settings(param_2[1],1,0,uVar14,0);
    configure_interrupt_settings(param_2[2],0,*(undefined1 *)((int)param_2 + 0x1a),uVar14,0);
    configure_interrupt_settings(param_2[3],1,0,uVar14,*(byte *)(param_2 + 4) ^ 1);
    configure_interrupt_settings(param_2[7],1,0,uVar14,1);
  }
