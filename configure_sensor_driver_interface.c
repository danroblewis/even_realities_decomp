/*
 * Function: configure_sensor_driver_interface
 * Entry:    000336a0
 * Prototype: undefined configure_sensor_driver_interface()
 */


undefined4 configure_sensor_driver_interface(int param_1,undefined4 param_2,undefined4 param_3)
