/*
 * Function: process_printf_format_comprehensive
 * Entry:    00078d90
 * Prototype: undefined process_printf_format_comprehensive()
 */


/* WARNING: Removing unreachable block (ram,0x00078ef8) */

int process_printf_format_comprehensive
              (undefined4 *param_1,int *param_2,byte *param_3,uint *param_4)

{
  ...
  if (((int)((uint)*(ushort *)(param_2 + 3) << 0x18) < 0) && (param_2[4] == 0)) {
    iVar1 = memory_allocate_with_mutex_protection(param_1,0x40);
    *param_2 = iVar1;
    param_2[4] = iVar1;
    if (iVar1 == 0) {
      *param_1 = 0xc;
...
LAB_00078df0:
    ...
    if (iVar1 != 0) {
      iVar2 = handle_float_underflow(param_1,param_2,param_3,iVar1);
      if (iVar2 == -1) {
LAB_00078f56:
    ...
    if (iVar1 == 0) {
      iVar1 = format_integer_for_printf_with_padding(param_1,&local_88,param_2,0x87737,&local_8c);
    }
    else {
      iVar1 = format_float_for_printf_with_precision(param_1,&local_88,param_2,0x87737,&local_8c);
    }
