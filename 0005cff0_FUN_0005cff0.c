/*
 * Function: FUN_0005cff0
 * Entry:    0005cff0
 * Prototype: undefined FUN_0005cff0()
 */
...

{
  ...
  if (iVar4 != 0) {
    ...
    if (*(int *)(iVar4 + 0xc0) == 0) {
      uVar5 = FUN_0005e6a8(*(undefined1 *)(iVar4 + 8),iVar4 + 0x90);
  ...
  puVar9 = (undefined4 *)FUN_0005f5d0(iVar1 + 0xc,0x40);
  ...
  case 2:
    ...
    piVar3 = (int *)FUN_0005cac0(param_1);
    iVar4 = FUN_00055cb4(param_1 + 0xd8,4);
    if (iVar4 != 0) {
      return 8;
    }
...
LAB_0005cf9a:
  ...
  iVar4 = FUN_0005caa4(8);
  if (iVar4 == 0) {
    iVar4 = FUN_0005cc68(param_1);
  }
  else {
    iVar4 = 0;
  }
