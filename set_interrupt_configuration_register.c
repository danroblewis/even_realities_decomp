/*
 * Function: set_interrupt_configuration_register
 * Entry:    00067548
 * Prototype: undefined set_interrupt_configuration_register()
 */


void set_interrupt_configuration_register(uint param_1,int param_2,int param_3,int param_4)
