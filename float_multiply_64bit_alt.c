/*
 * Function: float_multiply_64bit_alt
 * Entry:    0000d8f8
 * Prototype: undefined float_multiply_64bit_alt()
 */


ulonglong float_multiply_64bit_alt(undefined4 param_1,uint param_2,uint param_3,uint param_4)

{
  ...
  if (bVar10) {
    uVar13 = float_handle_special_cases();
    param_3 = extraout_r2;
    param_4 = extraout_r3;
    uVar8 = extraout_r12;
  }
