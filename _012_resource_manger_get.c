...

{
  ...
  case 0:
    if ((int)resource_id < 0x2714) {
      uVar11 = find_data_structure_by_id_alt3(resource_id & 0xffff,&local_28,&local_24);
...
LAB_00045902:
    ...
    goto LAB_00045912;
  case 1:
    iVar8 = find_data_structure_by_id_alt(resource_id & 0xffff,&local_28,&local_24);
    *resource_data = iVar8;
    if (iVar8 != 0) {
      *width = local_28;
      *height = local_24;
    ...
    break;
  case 2:
    iVar8 = find_data_structure_by_id(resource_id & 0xffff,&local_28,&local_24);
    *resource_data = iVar8;
    if (iVar8 != 0) {
      *width = local_28;
      *height = local_24;
    ...
    break;
  case 3:
    iVar8 = find_data_structure_by_id_alt2(resource_id & 0xffff,&local_28,&local_24);
    *resource_data = iVar8;
    *width = local_28;
    *height = local_24;
    return 0;
