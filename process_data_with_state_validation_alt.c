/*
 * Function: process_data_with_state_validation_alt
 * Entry:    0004f1d0
 * Prototype: undefined process_data_with_state_validation_alt()
 */


void process_data_with_state_validation_alt(int param_1,int param_2,uint param_3)
...
switchD_0004f1f8_caseD_8:
  ...
  case 2:
    ...
    if (0xff < uVar6) {
      ...
      local_20 = 2;
      process_and_compress_data_with_validation(&DAT_000880e8,0x1080,&local_20,0);
      goto LAB_0004f296;
    }
    cVar4 = *(char *)(param_2 + uVar9);
    uVar9 = uVar9 + 1;
