/*
 * Function: FUN_00050c54
 * Entry:    00050c54
 * Prototype: undefined FUN_00050c54()
 */


/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */

uint FUN_00050c54(uint *param_1,int param_2,uint param_3)
...
LAB_00050d22:
  ...
  uVar1 = FUN_00080786(uVar5);
  uVar3 = FUN_00080786(uVar3 + uVar5 + -1);
  if (uVar1 == uVar3) {
    if ((uVar1 != 0xffffffea) && ((int)uVar1 < (int)param_3)) {
      ...
      if ((_DAT_e000ed9c & 0xffffffe0) == uVar3) {
        if (uVar5 == uVar6) {
          FUN_00080798(uVar1 & 0xff,param_1);
          goto LAB_00050d22;
        }
        _DAT_e000ed9c = _DAT_e000ed9c & 0x1f | param_1[1] + uVar3 & 0xffffffe0;
LAB_00050d44:
        iVar2 = FUN_00080798(param_3 & 0xff,param_1);
LAB_00050d48:
        if (iVar2 == -0x16) {
          return 0xffffffea;
        }
        ...
        _DAT_e000ed98 = uVar1;
        iVar2 = FUN_00050bf0(uVar3,local_38);
      }
      param_3 = iVar2 + 1;
      goto LAB_00050d22;
    }
...
LAB_00050cc2:
  local_50 = 3;
  FUN_0004d944(&DAT_00088228,0x1840,&local_50,0);
  return 0xffffffea;
}
