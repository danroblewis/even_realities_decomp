...
LAB_00028cc8:
  do {
    ...
    if ((param_1[0xfe8] == '\0') && (iVar3 = FUN_0002bed0(param_1), iVar3 == 0)) {
      if (1 < LOG_LEVEL) {
        if (IS_DEBUG == 0) {
...
LAB_00028d42:
    ...
    if ((*param_1 == '\x01') && (iStack_34 = iStack_34 + 1, iStack_34 == 5)) {
      if ((param_1[0xf98] == '\0') ||
        ...
        uVar4 = FUN_00010840(param_1 + 0xf80);
        if (uVar4 == 0xff) {
          iStack_34 = 0;
        }
        else {
...
LAB_00028eae:
      ...
      switch(param_1[0xd5]) {
      case '\x02':
        FUN_0003629c(param_1,*(undefined4 *)(param_1 + 0xff0));
        iVar2 = 7;
...
LAB_0002935c:
        ...
        uVar14 = FUN_0000e244((int)lVar15,(int)((ulonglong)lVar15 >> 0x20),1000,0);
      }
      else {
LAB_000294ea:
