/*
 * Function: FUN_000187e8
 * Entry:    000187e8
 * Prototype: undefined FUN_000187e8()
 */


void FUN_000187e8(undefined4 param_1,int param_2)

{
  ...
  if (((*pcVar1 == '\x02') && (iVar2 = get_system_ready_state(), iVar2 != 1)) &&
    ...
    *(undefined1 *)puVar6 = 0x79;
    iVar2 = FUN_0004ed8c(param_1,local_2c,&PTR_FUN_000188d8_1_00088a0c,&DAT_20006ae8);
    if (iVar2 != 0) {
