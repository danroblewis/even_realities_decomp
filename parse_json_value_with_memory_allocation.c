/*
 * Function: parse_json_value_with_memory_allocation
 * Entry:    00064b64
 * Prototype: undefined parse_json_value_with_memory_allocation()
 */


int parse_json_value_with_memory_allocation
              (undefined4 *******param_1,uint param_2,int *param_3,int param_4)
