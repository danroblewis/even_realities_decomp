/*
 * Function: FUN_0005ffa4
 * Entry:    0005ffa4
 * Prototype: undefined FUN_0005ffa4()
 */
...
LAB_00060032:
      ...
      FUN_0004ba38(DAT_2000b008);
      return;
    }
LAB_00060086:
    FUN_00071cf4(DAT_2000b01c);
    if ((DAT_2000b059 != '\0') && (DAT_2000b059 = '\0', (int)((uint)DAT_2000b058 << 0x1f) < 0)) {
      FUN_0004ba38(DAT_2000b008);
    }
  }
  else {
    iVar1 = FUN_00071c20(DAT_2000b01c,local_30,0,0);
    if (iVar1 < 0) {
      local_3c = "Failed to allocate buffer: %d";
    }
    else {
      iVar1 = FUN_00066270(local_30[0],(uint)(DAT_2000b020 << 0xf) >> 0x10);
      if (iVar1 == 0xbad0000) {
        iVar1 = *(int *)(param_1 + 4);
        if (DAT_2000b05a != '\0') {
...
LAB_000600b0:
    ...
    if (iVar1 < 0) {
      ...
      FUN_00071cf4(DAT_2000b01c,*(undefined4 *)(param_1 + 4));
      goto LAB_00060008;
    }
  }
  if (cVar2 == '\0') {
