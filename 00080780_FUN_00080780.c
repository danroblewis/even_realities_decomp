/*
 * Function: FUN_00080780
 * Entry:    00080780
 * Prototype: undefined FUN_00080780()
 */


void FUN_00080780(undefined4 param_1,uint param_2,int param_3)

{
  ...
  if (uVar3 == 0) {
    ...
    uStack_60 = 10;
    uStack_44 = uVar3;
    uStack_50 = FUN_0004abc0(param_3,uVar3,0,&iStack_34);
    if (0x7ff < uStack_50) {
      ...
      uStack_68 = 0x1000004;
      FUN_0004d944(&DAT_000881e0,0x2480,&uStack_68,0);
      return;
    }
    uVar3 = uStack_50 & 0x7ff;
    iVar1 = FUN_0004d55c(((param_2 >> 0x14) + 0x17 + uStack_50 & 0xfffffff8) >> 2);
    ...
    if (iVar1 != 0) {
      ...
      uStack_60 = 10;
      uStack_58 = 4;
      iVar2 = FUN_0004abc0(param_3,uStack_44,0x7ee49,&iStack_34);
      if (iVar2 < 0) {
  ...
  FUN_0007ee74(iVar1,uStack_48,param_2 & 0xfff001ff | uVar3 << 9,uStack_4c);
  return;
}
