/*
 * Function: initialize_interrupt_configuration_structure
 * Entry:    00067794
 * Prototype: undefined initialize_interrupt_configuration_structure()
 */


undefined4
initialize_interrupt_configuration_structure
...
LAB_000677b0:
        ...
        trigger_system_service_call
                  ("WEST_TOPDIR/modules/hal/nordic/nrfx/drivers/src/nrfx_twim.c",uVar4);
      }
      set_interrupt_configuration_register(*param_2,0,3,uVar4,param_4);
      set_interrupt_configuration_register(param_2[1],0,3,uVar4);
    }
    iVar3 = (uint)bVar1 * 0x28;
    (&DAT_2000b3f2)[iVar3] = *(undefined1 *)((int)param_2 + 0xd);
    set_interrupt_configuration_values_simple(param_1,param_2);
    uVar4 = 0xbad0000;
