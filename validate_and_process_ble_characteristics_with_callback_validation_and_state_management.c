...

{
  ...
  *piVar3 = iVar2 + -1;
  ...
  if ((*(short *)(param_1 + 2) == 0x101) && (*piVar3 == 0)) {
    uVar1 = get_ble_characteristic_value(&BLE_CHARACTERISTIC_VALIDATION_BUFFER);
    if (((uVar1 & 0x4000) != 0) &&
       (((iVar2 = get_ble_characteristic_value(&BLE_CHARACTERISTIC_VALIDATION_BUFFER),
         -1 < iVar2 << 0x18 &&
         (iVar2 = get_ble_characteristic_value(&BLE_CHARACTERISTIC_VALIDATION_BUFFER),
         iVar2 << 0x15 < 0)) &&
        (iVar2 = handle_bluetooth_privacy_mode_management_with_callback_execution_and_parameter
                           (&BLE_CHARACTERISTIC_VALIDATION_BUFFER,local_1c), iVar2 == 0)))) {
      uVar4 = handle_bluetooth_privacy_mode_management_with_validation_and_state_management
                        (&BLE_CHARACTERISTIC_VALIDATION_BUFFER);
      iVar2 = get_ble_characteristic_value
                        (&BLE_CHARACTERISTIC_VALIDATION_BUFFER,(int)((ulonglong)uVar4 >> 0x20),
                         (int)uVar4);
      uVar4 = get_ble_characteristic_value
                        (&BLE_CHARACTERISTIC_VALIDATION_BUFFER,(uint)(iVar2 << 0x11) >> 0x1f);
      uVar1 = ((uint)((ulonglong)uVar4 >> 0x20) ^ 1) << 1;
      if ((int)uVar4 << 0x15 < 0) {
        uVar1 = uVar1 | 1;
      }
      uVar4 = get_ble_characteristic_value(&BLE_CHARACTERISTIC_VALIDATION_BUFFER,uVar1);
      uVar1 = (uint)((ulonglong)uVar4 >> 0x20);
      if ((int)uVar4 << 0x12 < 0) {
        uVar1 = uVar1 | 4;
      }
      iStack_28 = handle_bluetooth_privacy_mode_management_with_callback_validation
                            (&BLE_CHARACTERISTIC_VALIDATION_BUFFER,uVar1);
      if (iStack_28 == 0) {
        iVar2 = send_ble_command_0x200a(&BLE_CHARACTERISTIC_VALIDATION_BUFFER,1);
        if (iVar2 == 0) {
          ...
          iVar2 = apply_bitwise_and_mask(&BLE_CHARACTERISTIC_VALIDATION_BUFFER,0xffffbfff);
          validate_and_process_ble_characteristics_with_callback_validation_and_state_management
                    (local_1c[0]);
          if (iVar2 << 0x11 < 0) {
            BLE_CHARACTERISTIC_VALIDATION_BUFFER = BLE_CHARACTERISTIC_VALIDATION_BUFFER | 0x4000;
          }
        }
      }
      else {
