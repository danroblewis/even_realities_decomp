/*
 * Function: set_ble_attribute_property
 * Entry:    0005e9a0
 * Prototype: undefined set_ble_attribute_property()
 */


void set_ble_attribute_property(int param_1,ushort param_2,undefined4 param_3,undefined4 param_4)
