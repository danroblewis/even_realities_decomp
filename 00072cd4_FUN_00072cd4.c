/*
 * Function: FUN_00072cd4
 * Entry:    00072cd4
 * Prototype: undefined FUN_00072cd4()
 */


uint FUN_00072cd4(undefined4 *param_1,int *param_2,undefined4 param_3,undefined4 param_4)
...
LAB_00072d58:
    ...
    if ((int)(param_1[3] << 0x1f) < 0) {
      if (param_1[2] == 0) {
        ...
        FUN_0007e2ec("WEST_TOPDIR/zephyr/kernel/work.c",0x14e);
      }
      uVar4 = 2;
      *param_2 = param_1[2];
    }
