 ...
 * Entry:    00047260
 * Prototype: undefined _reflash_fb_data_to_lcd(undefined param_1, undefined param_2, undefined param_3, undefined param_4, undefined4 param_5, undefined4 param_6)
 */
  ...
  if (*(int *)(iVar2 + 0x35c) == 0) {
    ...
    for (; param_4 <= param_6; param_4 = param_4 + 1) {
      ...
      *(undefined1 *)(iVar8 + iVar7) = 0;
      resource_mutex_acquire(&JBD_DISPLAY_CONFIG);
      iVar4 = (**(code **)(*(int *)(iVar2 + 0x374) + 8))
                        (*(int *)(iVar2 + 0x374),iVar8,iVar7,local_38,1);
