/*
 * Function: FUN_00062d9c
 * Entry:    00062d9c
 * Prototype: undefined FUN_00062d9c()
 */
...

{
  ...
  *piVar5 = param_1;
  ...
  if ((-1 < iVar1) && (iVar1 = FUN_00062ad8(param_1,piVar5 + 1), iVar1 == 0)) {
    if ((int)(puVar7[1] << 0x1e) < 0) {
      iVar2 = FUN_0006540c(piVar5 + 7);
      if (iVar2 != 0xbad0000) {
        local_24 = "Failed to allocate PPI Channel";
        local_28 = 2;
        FUN_0004d944(&DAT_00088290,0x1040,&local_28,0);
        return -5;
      }
    ...
    if (piVar5[3] == 0) {
      ...
      *(undefined4 *)(iVar2 + 0x500) = 8;
      ...
      FUN_00086726(*(int *)(iVar6 + 0xc) + 0x80,0x84b87,0,uVar3);
      *(int *)(*(int *)(iVar6 + 0xc) + 0xb4) = iVar6;
      FUN_00086726(*(int *)(iVar6 + 0xc) + 0x20,&LAB_00084c56_1,0);
