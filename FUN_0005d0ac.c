/*
 * Function: FUN_0005d0ac
 * Entry:    0005d0ac
 * Prototype: undefined FUN_0005d0ac()
 */


undefined4 FUN_0005d0ac(int param_1)

{
  ...
  iVar8 = param_1 + 0x27;
  local_74 = (char *)iVar6;
  iVar1 = FUN_0005ecdc(param_1 + 0x97,iVar7,iVar8,*(int *)(param_1 + 0xf0) + 0x97);
  if (iVar1 == 0) {
    puVar5 = local_58;
    ...
    local_6c = puVar5;
    iVar1 = FUN_00083634(iVar6,iVar8,iVar7,local_48);
    if (iVar1 == 0) {
      ...
      local_78 = param_1 + 10;
      local_6c = auStack_68;
      iVar1 = FUN_00083634(iVar6,iVar7,iVar8,local_48);
      if (iVar1 == 0) {
        ...
        puVar4 = (undefined4 *)FUN_0005f5d0(iVar1 + 0xc,0x10);
        do {
          uVar2 = *puVar5;
          uVar3 = puVar5[1];
          puVar5 = puVar5 + 2;
