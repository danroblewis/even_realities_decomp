...

{
  ...
  iVar1 = validate_ble_connection_parameters(param_2);
  iVar3 = BT_CONNECTION_CALLBACK_LIST_HEAD;
  if (iVar1 == 0) {
LAB_00056c8a:
    iVar1 = 0;
  }
    ...
    for (; iVar3 != 0; iVar3 = *(int *)(iVar3 + 0x20)) {
      if ((*(code **)(iVar3 + 8) != (code *)0x0) &&
         ((iVar2 = (**(code **)(iVar3 + 8))(param_1,param_2), iVar2 == 0 ||
          (iVar2 = validate_ble_connection_parameters(param_2), iVar2 == 0)))) goto LAB_00056c8a;
    }
    puVar4 = &BT_CONNECTION_CALLBACK_LIST_START;
    while( true ) {
      if (&BT_CONNECTION_CALLBACK_LIST_END < puVar4) {
        ...
        trigger_system_service_call("WEST_TOPDIR/zephyr/subsys/bluetooth/host/conn.c",0x676);
      }
      if (&UNK_00088057 < puVar4) break;
      if (((code *)puVar4[2] != (code *)0x0) &&
         ((iVar3 = (*(code *)puVar4[2])(param_1,param_2), iVar3 == 0 ||
          (iVar3 = validate_ble_connection_parameters(param_2), iVar3 == 0)))) goto LAB_00056c8a;
      puVar4 = puVar4 + 9;
    }
  }
  return iVar1;
