/*
 * Function: FUN_00068a10
 * Entry:    00068a10
 * Prototype: undefined FUN_00068a10()
 */


uint FUN_00068a10(int param_1,uint param_2,int param_3)

{
  ...
  if (param_2 != 0) {
    ...
    iVar1 = *(int *)(&DAT_0008bbc0 + (param_1 * 4 + uVar6) * 4);
    afStack_30[3] = 100.0;
    afStack_30[2] = 100.0;
