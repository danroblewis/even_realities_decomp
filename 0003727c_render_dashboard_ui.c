...

{
  ...
  if (dashboard_type != 1) {
    if (dashboard_type == 2) {
      ...
      if (((DAT_2000496c != iVar2) || (DAT_20004969 != '\x02')) ||
         (DAT_2000496a != *(byte *)(dashboard_data + 0x65))) {
        gui_screen_clear();
        DAT_2000496a = *(byte *)(dashboard_data + 0x65);
        DAT_20004969 = *(char *)(dashboard_data + 100);
        DAT_2000496c = iVar2;
        if (2 < LOG_LEVEL) {
          if (IS_DEBUG == 0) {
      ...
      if (iVar2 == 1) {
        ...
        local_7c[1] = 0;
        local_7c[2] = 0;
        FUN_00086f00(&local_80,0,0x10,&LAB_000a9078,uVar4,uVar3,local_90 & 0xffff);
...
LAB_0003acba:
    ...
    if (((DAT_2000496c != iVar2) || (DAT_20004969 != '\0')) ||
       (DAT_2000496a != *(byte *)(dashboard_data + 0x65))) {
      gui_screen_clear();
      DAT_2000496a = *(byte *)(dashboard_data + 0x65);
      DAT_20004969 = *(char *)(dashboard_data + 100);
    ...
    if (iVar2 == 1) {
      ...
      local_9c = 0;
      uStack_98 = 0;
      FUN_00086f00(&local_a4,0,0x10,&LAB_000a9078,uVar4,uVar3,local_ac & 0xffff);
      ...
      if (display_mode == 1) {
        ...
        if (DAT_20004970 != *(char *)(dashboard_data + 0x66)) {
          DAT_20004970 = *(char *)(dashboard_data + 0x66);
          iVar2 = get_ui_x_offset();
          iVar5 = get_ui_y_offset();
          iVar6 = get_ui_x_offset();
          iVar7 = get_ui_y_offset();
        ...
        if (DAT_20004970 == '\0') {
          ...
          if (DAT_20004970 == '\x01') {
            ...
            *(undefined1 *)puVar14 = 0;
            ...
            if (DAT_20004970 != '\x02') {
              if (DAT_20004970 != '\x03') goto LAB_0003741a;
              iVar2 = get_ui_x_offset();
              iVar5 = get_ui_y_offset();
              iVar6 = get_ui_x_offset();
              iVar7 = get_ui_y_offset();
              gui_utf_draw(0,&DAT_2001197a,0,iVar2 + 0x1c,iVar5 + 0x51,iVar6 + 0xf2,iVar7 + 0x6c,1,0
                           ,0,0,0);
              local_80 = 0;
              fill_memory_buffer(local_7c,0,0x54);
              uVar3 = FUN_0000ef12(&DAT_200119ba);
              validate_memory_bounds(&local_80,&DAT_200119ba,uVar3,0x58);
              iVar2 = FUN_0000ef12(&DAT_200119ba);
              *(undefined1 *)((int)local_7c + iVar2 + -4) = 0x20;
              uVar3 = FUN_0000ef12(&DAT_200119da);
              memcpy((int)local_7c + iVar2 + -3,&DAT_200119da,uVar3);
              uVar3 = get_ui_x_offset();
              iVar2 = get_ui_y_offset();
              iVar5 = get_ui_x_offset();
              iVar6 = get_ui_y_offset();
      ...
      if (uVar15 != 0) {
        if (uVar15 == 1) {
          ...
          if (cVar1 != '\0') {
            ...
            uVar15 = (uint)DAT_20004953;
            DAT_20004954 = (undefined1)iVar5;
...
LAB_0003803a:
          ...
          if (DAT_20004971 != *(char *)(dashboard_data + 0x68)) {
            DAT_20004971 = *(char *)(dashboard_data + 0x68);
            iVar2 = get_ui_x_offset();
            iVar6 = get_ui_y_offset();
            iVar7 = get_ui_x_offset();
            iVar8 = get_ui_y_offset();
        ...
        if (cVar1 != '\0') {
          if (cVar1 != '\x01') {
            ...
            if (iVar5 != 0) {
              ...
              FUN_00077914(&local_80,0x20,&LAB_000a9120_1,DAT_20004955 + 1,iVar5);
              iVar2 = (uint)DAT_20004955 * 0x159;
              iVar6 = get_ui_x_offset();
              iVar7 = get_ui_y_offset();
            ...
            iVar2 = FUN_0007d1d0(&DAT_2000a030);
            if ((-1 < iVar2 << 0x1e) || (DAT_20004958 != '\x01')) goto LAB_000385f0;
            DAT_20004958 = (char)iVar5;
            iVar2 = get_work_mode();
            iVar5 = get_ui_x_offset();
            iVar6 = get_ui_y_offset();
            iVar7 = get_ui_x_offset();
...
LAB_00037e16:
      ...
      DAT_20004952 = (char)iVar5;
      iVar2 = get_ui_x_offset();
      iVar6 = get_ui_y_offset();
      gui_bmp_bitmap_draw(0x3b,iVar2 + 0x10a,iVar6 + 2,0,0,0);
      if (iVar5 == 0) {
        iVar2 = FUN_0007d1d0(&DAT_2000a030);
        if ((iVar2 << 0x1e < 0) && (DAT_20004957 == '\x01')) {
          DAT_20004957 = (char)iVar5;
          iVar2 = get_work_mode();
          iVar5 = get_ui_x_offset();
          iVar6 = get_ui_y_offset();
          iVar7 = get_ui_x_offset();
      ...
      DAT_20004957 = '\x01';
      fill_memory_buffer(&local_80,0,0x20);
      FUN_00077914(&local_80,0x20,&LAB_000a9120_1,DAT_20004951 + 1,iVar5);
      uVar15 = (uint)DAT_20004951;
      ...
      local_8c = 0;
      uStack_88 = 0;
      FUN_00086f00(&local_94,0,0x10,&LAB_000a9078,uVar4,uVar3,CONCAT11(uStack_9f,local_a0));
      iVar2 = get_ui_x_offset();
      uVar3 = get_ui_y_offset();
      iVar5 = get_ui_x_offset();
      iVar6 = get_ui_y_offset();
...
LAB_00038e6e:
      ...
      if (iVar5 == 0) {
        ...
        FUN_00037098();
        uVar15 = FUN_00023ee0();
        if (DAT_20004968 != uVar15) {
          DAT_20004968 = (byte)uVar15;
          iVar2 = get_work_mode();
          iVar5 = get_ui_x_offset();
          iVar6 = get_ui_y_offset();
          iVar7 = get_ui_x_offset();
...
LAB_00037d2a:
  ...
  if (((DAT_2000496c != iVar2) || (DAT_20004969 != '\x01')) ||
     (DAT_2000496a != *(byte *)(dashboard_data + 0x65))) {
    gui_screen_clear();
    DAT_2000496a = *(byte *)(dashboard_data + 0x65);
    DAT_20004969 = *(char *)(dashboard_data + 100);
...
LAB_00037e4a:
    ...
    if (iVar5 != 0) {
      ...
      fill_memory_buffer(&local_80,0,0x20);
      FUN_00077914(&local_80,0x20,&LAB_000a9120_1,DAT_20004951 + 1,iVar5);
      iVar11 = (uint)DAT_20004951 * 0x143;
