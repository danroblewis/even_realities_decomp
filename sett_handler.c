...

{
  ...
  iVar1 = compare_byte_arrays(param_1,"ble_whitelist_app");
  if (iVar1 == 0) {
    uVar2 = get_system_timer_value();
    uVar3 = 0x15e2;
LAB_00022232:
...
LAB_00022270:
  ...
  iVar1 = compare_byte_arrays(param_1,"dashboard_ts");
  if (iVar1 == 0) {
    iVar1 = get_work_mode();
...
LAB_000222b6:
    ...
    iVar1 = compare_byte_arrays(param_1,"countdown_ts");
    if (iVar1 != 0) {
      iVar1 = compare_byte_arrays(param_1,"first_enter_flag");
      if (iVar1 == 0) {
        iVar1 = get_work_mode();
      ...
      iVar1 = compare_byte_arrays(param_1,"brightness_level");
      if (iVar1 == 0) {
        iVar1 = get_work_mode();
      ...
      iVar1 = compare_byte_arrays(param_1,"3dof_enable");
      if (iVar1 == 0) {
        iVar1 = get_work_mode();
      ...
      iVar1 = compare_byte_arrays(param_1,"display_mode");
      if (iVar1 == 0) {
        iVar1 = get_work_mode();
      ...
      iVar1 = compare_byte_arrays(param_1,"runtime_mode");
      if (iVar1 == 0) {
        iVar1 = get_work_mode();
      ...
      iVar1 = compare_byte_arrays(param_1,"user_sched_info");
      if (iVar1 != 0) {
        iVar1 = compare_byte_arrays(param_1,"wakeup_angle");
        if (iVar1 != 0) {
          return 0;
        }
        iVar1 = get_work_mode();
