/*
 * Function: FUN_00078698
 * Entry:    00078698
 * Prototype: undefined FUN_00078698()
 */


int FUN_00078698(undefined4 param_1,int param_2,int param_3,uint param_4)

{
  ...
  if (param_4 != 0) {
    if (*(int *)(param_2 + 8) <= iVar5) {
      iVar1 = FUN_000785d4(param_1,*(int *)(param_2 + 4) + 1);
      iVar2 = iVar1;
      if (iVar1 == 0) {
