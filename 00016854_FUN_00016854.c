/*
 * Function: FUN_00016854
 * Entry:    00016854
 * Prototype: undefined FUN_00016854()
 */


uint FUN_00016854(uint param_1,int param_2)
...
LAB_0007c084:
    uVar4 = FUN_00017768(*puVar5,*(undefined1 *)(puVar5 + 1),uVar8);
    return uVar4;
  }
  if (param_2 != 0x20) {
    if (param_2 == 0x40) {
