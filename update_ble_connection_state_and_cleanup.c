/*
 * Function: update_ble_connection_state_and_cleanup
 * Entry:    00059afc
 * Prototype: undefined update_ble_connection_state_and_cleanup()
 */


void update_ble_connection_state_and_cleanup(int param_1,int param_2)
...
LAB_00059b3a:
  ...
  cleanup_ble_connection_and_free_memory(param_2);
  return;
}
