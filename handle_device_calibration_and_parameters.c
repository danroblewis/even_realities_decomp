/*
 * Function: handle_device_calibration_and_parameters
 * Entry:    00062644
 * Prototype: undefined handle_device_calibration_and_parameters()
 */


int handle_device_calibration_and_parameters(int param_1)

{
  ...
  iVar1 = check_driver_ready(*puVar5);
  if (iVar1 == 0) {
    iVar1 = -0x13;
  }
  else {
    ...
    if (iVar1 == 0) {
      ...
      do {
        ...
        if (*piVar7 != 0x7fffffff) {
          uVar2 = float_divide_64bit_complex
                            ((1.0 / ((float)(longlong)*piVar7 / 1e+06 + 273.15) - 0.0033540165) *
                             (float)*(ushort *)(puVar5 + 0xb));
          iVar4 = puVar5[10];
          uVar2 = validate_and_process_data(uVar2);
          uVar8 = int_to_float_64bit(iVar4);
