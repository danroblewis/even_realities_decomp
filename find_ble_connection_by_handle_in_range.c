/*
 * Function: find_ble_connection_by_handle_in_range
 * Entry:    000813e8
 * Prototype: undefined find_ble_connection_by_handle_in_range()
 */


ushort * find_ble_connection_by_handle_in_range(int param_1,int param_2,uint param_3)
