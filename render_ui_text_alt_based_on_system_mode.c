/*
 * Function: render_ui_text_alt_based_on_system_mode
 * Entry:    0003f380
 * Prototype: undefined render_ui_text_alt_based_on_system_mode()
 */


void render_ui_text_alt_based_on_system_mode(void)
