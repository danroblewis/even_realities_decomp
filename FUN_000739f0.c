/*
 * Function: FUN_000739f0
 * Entry:    000739f0
 * Prototype: undefined FUN_000739f0()
 */


void FUN_000739f0(undefined4 param_1,int param_2)

{
  ...
  if (param_2 == 0) {
    ...
    if (uVar4 == 0) {
      if (DAT_2000b460 != DMIC_BUFFER_SIZE) {
        iVar2 = FUN_0007205c();
        if (iVar2 != 0) {
