/*
 * Function: FUN_000646c0
 * Entry:    000646c0
 * Prototype: undefined FUN_000646c0()
 */
...

{
  ...
  uVar10 = (uint)bVar1;
  if (uVar10 == 0x10) {
    uVar10 = FUN_000644f8(*(undefined4 *)(param_1 + 0x10));
    return uVar10;
  }
  if (0x10 < uVar10) {
    if (uVar10 == 0x40) {
      ...
      if (puVar5 != (undefined1 *)0x0) {
        ...
        *(int *)(param_2 + 8) = *(int *)(param_2 + 8) + iVar6;
        for (; piVar11 != (int *)0x0; piVar11 = (int *)*piVar11) {
          ...
          iVar6 = FUN_000644f8(piVar11[8],param_2);
          ...
          *(int *)(param_2 + 8) = *(int *)(param_2 + 8) + iVar6;
          iVar6 = FUN_000646c0(piVar11,param_2);
          if (iVar6 == 0) goto switchD_000646e2_caseD_3;
          FUN_00084f16(param_2);
...
LAB_00064706:
    ...
    if (uVar10 != 0) {
      FUN_0008705a(uVar10,&local_44,*(int *)(param_2 + 4) - *(int *)(param_2 + 8));
LAB_00064728:
      uVar10 = 1;
    }
    break;
  case 8:
    ...
    local_50 = 0;
    uStack_4c = 0;
    iVar6 = FUN_0000de2c(uVar13,uVar10,uVar13,uVar10);
    if (iVar6 == 0) {
      uVar15 = uVar10 & 0x7fffffff;
      iVar6 = FUN_0000de2c(uVar13,uVar15,0xffffffff,0x7fefffff);
      if ((iVar6 == 0) && (iVar6 = FUN_0000ddf0(uVar13,uVar15,0xffffffff,0x7fefffff), iVar6 == 0))
      goto LAB_000647a8;
      uVar14 = uVar13;
      uVar18 = uVar10;
      iVar6 = FUN_00077914(&local_44,0x1a,"%1.15g");
      iVar4 = FUN_000779bc(&local_44,"%lg",&local_50);
      uVar3 = uStack_4c;
      uVar2 = local_50;
      if (iVar4 == 1) {
        uVar12 = uStack_4c & 0x7fffffff;
        iVar4 = FUN_0000dddc(uVar13,uVar15,local_50,uVar12,uVar14,uVar18);
        uVar14 = uVar13;
        if (iVar4 != 0) {
          uVar14 = uVar2;
          uVar15 = uVar12;
        }
        uVar16 = FUN_0000d588(uVar2,uVar3,uVar13,uVar10);
        uVar17 = FUN_0000d8f8(uVar14,uVar15,0,0x3cb00000);
        iVar4 = FUN_0000ddf0((int)uVar16,(uint)((ulonglong)uVar16 >> 0x20) & 0x7fffffff,(int)uVar17,
                             (int)((ulonglong)uVar17 >> 0x20));
        if (iVar4 == 0) goto LAB_00064840;
      }
      else {
LAB_00064840:
        iVar6 = FUN_00077914(&local_44,0x1a,"%1.17g");
      }
