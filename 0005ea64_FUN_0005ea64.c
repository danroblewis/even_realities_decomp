...

{
  ...
  if (param_1 == 0) {
    ...
    local_58 = 2;
    FUN_0004d944(&DAT_00088158,0x1040,&local_58,0);
  }
  else {
    ...
    if (iVar1 < 0) {
      ...
      local_88 = 3;
      iStack_80 = iVar1;
      FUN_0004d944(&DAT_00088158,0x1840,&local_88,0);
    }
    else {
      iVar2 = FUN_00080cf2(param_1,auStack_70);
      if (iVar2 == 0) {
        ...
        if ((local_74 == 0) || (iStack_80 = FUN_00077c1c(local_74,0,10), iStack_80 == 0)) {
          ...
          if (iVar2 != 0) {
            if (iVar1 != 0x50) {
              ...
              local_88 = 4;
              iStack_80 = iVar1;
              FUN_0004d944(&DAT_00088158,0x2040,&local_88,0);
              FUN_0005ea18(iVar2);
              return 0xffffffea;
            }
          ...
          local_7c = CONCAT22(local_7c._2_2_,0x200);
          local_88 = 0x1000003;
          FUN_0004d944(&DAT_00088158,0x1c40,&local_88,0);
          return 0xfffffff4;
        }
      ...
      FUN_0004d944(&DAT_00088158,uVar3,&local_88,0);
    }
  }
  return 0xffffffea;
}
