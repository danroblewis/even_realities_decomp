/*
 * Function: FUN_000641e4
 * Entry:    000641e4
 * Prototype: undefined FUN_000641e4()
 */
...

{
  ...
  iStack_1c = param_2;
  iStack_18 = param_3;
  iVar2 = FUN_0006403c(param_1,&local_20);
  if (iVar2 != 0) {
    return iVar2;
  }
  ...
  if (uVar4 == 2) {
    ...
    if (uVar4 == 3) {
      ...
      iVar3 = FUN_000640e8(param_1,uVar5,bVar6);
      return iVar3;
    }
    if (uVar4 == 1) {
      if (param_2 == 0) {
    ...
    FUN_00076a94("WEST_TOPDIR/bootloader/mcuboot/boot/bootutil/src/bootutil_public.c",0x22e,
                 "boot_set_next","0");
  }
  return 4;
}
