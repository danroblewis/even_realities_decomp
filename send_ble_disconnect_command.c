/*
 * Function: send_ble_disconnect_command
 * Entry:    00080ed8
 * Prototype: undefined send_ble_disconnect_command()
 */


undefined4 send_ble_disconnect_command(undefined2 param_1,undefined1 param_2)
