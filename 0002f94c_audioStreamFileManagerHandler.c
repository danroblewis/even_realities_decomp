...

{
  ...
  if (DAT_20019dab == '\0') {
    ...
    iVar3 = FUN_0008638c(&DAT_00087bf0);
    if (iVar3 == 0) {
LAB_0002f9be:
      if (LOG_LEVEL < 1) {
        return 0;
...
LAB_0002fac2:
          ...
          do {
            ...
            if ((*(int *)(&DAT_20018dbe + uVar7 * 0x14) < iVar3) &&
               ((iVar6 = FUN_0002f940(), iVar1 = extraout_r2, iVar6 == 0 ||
                (iVar6 = FUN_0002f940(), iVar1 = extraout_r2_00, iVar6 - 1U != uVar7)))) {
              iVar3 = *(int *)(iVar1 + 4);
              uVar5 = uVar7 & 0xff;
            }
            uVar7 = uVar7 + 1;
        ...
        if (local_f4[0] == '\x02') {
          ...
          if (0xfff < (int)pcVar2) {
            ...
            if (iVar3 <= (int)((uint)DAT_20019daa * 0x20000 + 0x431000)) {
              ...
              if (pcVar2 == (char *)0x0) {
                DAT_20007bbc = FUN_0002360c(DAT_20007bbc,&DAT_20018daa,0x1000);
...
joined_r0x0002fe02:
            ...
            DAT_20007bbc = FUN_0002360c(DAT_20007bbc,&DAT_20018daa,DAT_20007bb8);
            fill_memory_buffer(&DAT_20018daa,0,0x1000);
            iVar3 = get_work_mode();
            pcVar8 = *(code **)(iVar3 + 0x1030);
            uVar4 = get_work_mode();
