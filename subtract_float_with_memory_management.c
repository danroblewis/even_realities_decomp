/*
 * Function: subtract_float_with_memory_management
 * Entry:    00078ac8
 * Prototype: undefined subtract_float_with_memory_management()
 */


int subtract_float_with_memory_management
...

{
  ...
  bVar16 = iVar1 < 0;
  if (iVar1 == 0) {
    iVar2 = manage_float_context_with_memory_allocation(param_1,0);
    iVar3 = iVar2;
    ...
    iVar2 = manage_float_context_with_memory_allocation(param_1,*(undefined4 *)(param_2 + 4));
    if (iVar2 != 0) {
