...
LAB_0002e040:
      ...
      if (((*param_2 == 2) && (iVar9 = FUN_00023eec(), iVar9 == 0)) ||
         (((int)(DAT_20007b38 << 0x1e) < 0 && (iVar9 = FUN_00023eec(), iVar9 == 1)))) {
...
LAB_0002cd00:
    ...
    case '\x01':
      ...
      while ((*param_2 != 1 && (iVar9 = FUN_00023eec(), iVar9 != 1))) {
...
LAB_0002ca3c:
    ...
    case '\x06':
      ...
      while( true ) {
        ...
        if ((((*param_2 == 1) && (iVar9 = FUN_00023eec(), iVar9 == 0)) ||
            (((int)(DAT_20007b38 << 0x1e) < 0 && (iVar9 = FUN_00023eec(), iVar9 == 1)))) ||
           (((int)(DAT_20007b38 << 0x1e) < 0 && (iVar9 = FUN_00023eec(), iVar9 == 2)))) {
          if ((int)(DAT_20007b38 << 0x1e) < 0) {
            DAT_20007b38 = DAT_20007b38 & 0xfffffffd;
          }
          iVar9 = now_has_persist_task(param_1,param_1[0xd5]);
        ...
        if ((param_1[0x108f] != '\0') && (iVar9 = FUN_00034410(), iVar9 == 1)) {
          FUN_00036030();
          if (*param_1 == '\x01') {
            sync_message_signal_to_slave(1);
            clear_timeout_message(0);
        ...
        if ((DAT_20018d9e != '\0') && (iVar9 = FUN_00033cdc(), iVar9 != 0)) break;
        get_work_mode();
        get_schedule_timing(0x667,0);
      }
      FUN_00036030();
