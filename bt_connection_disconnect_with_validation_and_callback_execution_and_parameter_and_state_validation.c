...

{
  ...
  if (*(ushort *)(param_2 + 0x10) < 4) {
    ...
    uVar4 = find_ble_connection_by_handle(param_1,*(undefined2 *)(iVar1 + 2));
    iVar1 = (int)uVar4;
    if (iVar1 == 0) {
      local_3c = "Ignoring data for unknown channel ID 0x%04x";
      local_40 = 3;
      uStack_38 = (int)((ulonglong)uVar4 >> 0x20);
      process_and_compress_data_with_validation(&DAT_00088160,0x1880,&local_40);
      goto LAB_00057d22;
    }
  ...
  local_20 = 2;
  process_and_compress_data_with_validation(&DAT_00088160,uVar3,&local_20);
LAB_00057d22:
