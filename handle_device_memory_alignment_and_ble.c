...

{
  ...
  uVar1 = get_constant_value_0x1000();
  uVar3 = validate_range_bounds(param_2,param_3);
  if ((int)uVar3 == 0) {
    ...
    if ((param_2 == uVar1 * (param_2 / uVar1)) && (param_3 == uVar1 * (param_3 / uVar1))) {
      if (uVar1 <= param_3) {
        ...
        iVar2 = get_constant_value_0x1000();
        do {
          validate_address_and_perform_hardware_operations(param_2);
