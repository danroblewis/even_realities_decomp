/*
 * Function: handle_clock_control_operation
 * Entry:    000604e4
 * Prototype: undefined handle_clock_control_operation()
 */


undefined4 handle_clock_control_operation(int param_1,byte param_2,uint param_3)
