/*
 * Function: manage_float_context_with_memory_allocation
 * Entry:    000785d4
 * Prototype: undefined manage_float_context_with_memory_allocation()
 */


undefined4 * manage_float_context_with_memory_allocation(int param_1,uint param_2)

{
  ...
  if (*(int *)(iVar4 + 0xc) == 0) {
    uVar2 = check_float_special_values(param_1,4,0x21);
...
LAB_00078602:
    ...
    if (puVar1 == (undefined4 *)0x0) {
      ...
      puVar1 = (undefined4 *)check_float_special_values(param_1,1,(iVar4 + 5) * 4);
