/*
 * Function: FUN_000678d0
 * Entry:    000678d0
 * Prototype: undefined FUN_000678d0()
 */


void FUN_000678d0(int *param_1,undefined4 param_2,undefined4 param_3,undefined4 param_4)

{
  ...
  if ((&DAT_2000b3ee)[iVar1] == '\0') {
    ...
    assertion_failure("WEST_TOPDIR/modules/hal/nordic/nrfx/drivers/src/nrfx_twim.c",0x176);
  }
