/*
 * Function: FUN_00065b9c
 * Entry:    00065b9c
 * Prototype: undefined FUN_00065b9c()
 */
...

{
  ...
  uVar6 = FUN_00065620(_DAT_5000d304 & 0xff | 0x80000000);
  if ((int)uVar6 < 0) {
...
LAB_00065cee:
  for (; uVar6 != 0; uVar6 = uVar6 & ~(1 << iVar12)) {
    ...
    iVar8 = iVar12 * 4;
    FUN_000654c4((uint)(*(int *)(iVar8 + 0x5000d510) << 0x12) >> 0x1a,
                 (uint)(*(int *)(iVar8 + 0x5000d510) << 0xe) >> 0x1e);
  }
  return;
LAB_00065cc8:
  FUN_00065620(0x80000000);
  local_30[0] = _DAT_50842520;
  local_30[1] = _DAT_50842820;
