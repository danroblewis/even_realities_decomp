/*
 * Function: calculate_complex_math_result
 * Entry:    00013e60
 * Prototype: undefined calculate_complex_math_result()
 */


int calculate_complex_math_result(int param_1)

{
  ...
  if (uVar2 == 0) {
    ...
    in_d0 = float_multiply_64bit_alt();
    if (-0xc351 < param_1) {
...
LAB_00013eb6:
  ...
  uVar4 = 0x1a56e1f;
LAB_00013ed6:
  iVar1 = float_multiply_64bit_alt((int)in_d0,(int)(in_d0 >> 0x20),uVar3,uVar4);
  return iVar1;
}
