/*
 * Function: process_complex_data_with_font_rendering_and_callback_execution
 * Entry:    00084b86
 * Prototype: undefined process_complex_data_with_font_rendering_and_callback_execution()
 */


void process_complex_data_with_font_rendering_and_callback_execution
...
LAB_00084bea:
  ...
  prepare_callback_data_and_execute_with_memory_buffer_initialization
            (iVar7,iVar5,iVar4,iVar3,param_4);
  *(int *)(piVar6[3] + 0x60) = *(int *)(piVar6[3] + 0x60) + iVar5;
  *(int *)(piVar6[3] + 0x70) = *(int *)(piVar6[3] + 0x70) + iVar5;
  if (bVar8) {
    setup_font_rendering(piVar6[3] + 0x80);
  }
LAB_00084bd2:
