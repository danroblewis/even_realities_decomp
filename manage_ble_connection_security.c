/*
 * Function: manage_ble_connection_security
 * Entry:    0005e1a8
 * Prototype: undefined manage_ble_connection_security()
 */


void manage_ble_connection_security(int *param_1,int param_2)
  ...
  if ((iVar1 == 0) && ((int)((uint)*(byte *)(param_1 + -2) << 0x1f) < 0)) {
    ...
    if (iVar1 == 0) {
      ...
      if (iVar1 == 0) {
        ...
        iVar3 = ble_memory_allocation_utility(iVar1 + 0xc,0x10);
...
LAB_0005e2f2:
  ...
  uVar8 = 0;
LAB_0005e1fa:
  handle_ble_connection_state_change(piVar9,uVar8);
  return;
}
