...
LAB_0005f874:
      ...
      if ((uint)param_2[3] < uVar4) {
        ...
        FUN_0004d944(&DAT_000880e0,0x2040,&local_40,0);
        iVar8 = -0xc;
        goto LAB_0005f7d6;
      }
...
LAB_0005f948:
        ...
        local_38 = FUN_0000e244((int)lVar2,(int)((ulonglong)lVar2 >> 0x20),"size",0);
...
LAB_0005f7c6:
    local_40 = 3;
    FUN_0004d944(&DAT_000880e0,0x1840,&local_40,0);
  }
  else {
    local_1c = "Invalid selection of channels";
LAB_0005f782:
    local_20 = 2;
    FUN_0004d944(&DAT_000880e0,0x1040,&local_20,0);
  }
  iVar8 = -0x16;
LAB_0005f7d6:
