/*
 * Function: FUN_000250f8
 * Entry:    000250f8
 * Prototype: undefined FUN_000250f8()
 */


int FUN_000250f8(undefined1 *param_1,char *param_2,char *param_3)

{
  ...
  local_154 = 0x20;
  local_14f = param_1[9];
  uVar1 = FUN_00025090(auStack_c8,&local_154);
  ...
  if (*param_2 == '\0') {
    ...
    local_15a = param_2[7];
    local_158 = param_2[8];
    uVar2 = FUN_000250c4(auStack_a8,&local_160);
  ...
  uVar3 = FUN_00024fe8(local_168,local_164);
