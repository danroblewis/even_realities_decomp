/*
 * Function: process_framebuffer_with_ui_overlay
 * Entry:    00035f28
 * Prototype: undefined process_framebuffer_with_ui_overlay()
 */


void process_framebuffer_with_ui_overlay(int param_1,undefined4 param_2,int param_3)

{
  ...
  if (param_3 == 0) {
    ...
    if (param_1 != 0) {
      ...
      iVar5 = 0;
      do {
        render_ui_data_entry_display(param_2,param_3);
        uVar4 = 0;
        do {
          iVar3 = 0;
          do {
