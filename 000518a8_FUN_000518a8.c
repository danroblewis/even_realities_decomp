/*
 * Function: FUN_000518a8
 * Entry:    000518a8
 * Prototype: undefined FUN_000518a8()
 */


undefined4 FUN_000518a8(int *param_1,uint *param_2)

{
  ...
  if (param_1[1] == 0) {
    ...
    *param_2 = param_1[2];
    ...
    iVar1 = FUN_000809f6(uVar3 ^ 1);
    if (iVar1 == 0) {
      uVar3 = FUN_0005169c(uVar3 ^ 1);
      param_2[3] = uVar3;
      if (-1 < (int)uVar3) {
        local_2c = FUN_0004e048(uVar3 & 0xff,&local_24);
        if (local_2c != 0) {
          uStack_30 = param_2[3];
          local_34 = "Failed to open flash area ID %u: %d";
          local_38 = 4;
          FUN_0008096a(&DAT_00088208,0x2040,&local_38);
          return 10;
        }
        ...
        FUN_0007ef7e();
        if ((char)param_1[7] != '\0') {
          iVar1 = FUN_00080a82(auStack_20);
          if (iVar1 != 0) {
            return 0x1a;
          }
          iVar1 = FUN_00080970(auStack_20,piVar4 + 5);
          if (-1 < iVar1) {
            return 0x1b;
          }
        }
