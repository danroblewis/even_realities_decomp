/*
 * Function: memory_allocate_with_mutex_protection
 * Entry:    00076e20
 * Prototype: undefined memory_allocate_with_mutex_protection()
 */


uint memory_allocate_with_mutex_protection
    ...
    *param_1 = 0xc;
    ...
    if (MEMORY_ALLOCATION_FLAG == 0) {
      MEMORY_ALLOCATION_FLAG =
           memory_allocate_wrapper_with_error_handling(param_1,0,puVar1,0,param_4);
    }
    puVar1 = (uint *)memory_allocate_wrapper_with_error_handling(param_1,uVar5);
    if ((puVar1 != (uint *)0xffffffff) &&
       ((puVar4 = (uint *)((int)puVar1 + 3U & 0xfffffffc), puVar1 == puVar4 ||
        (iVar2 = memory_allocate_wrapper_with_error_handling(param_1,(int)puVar4 - (int)puVar1),
        iVar2 != -1)))) {
LAB_00076e84:
      *puVar4 = uVar5;
LAB_00076e92:
