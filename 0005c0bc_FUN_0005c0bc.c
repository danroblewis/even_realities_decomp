...
LAB_0005c1ec:
          ...
          if ((*param_5 != 0) && (iVar3 = FUN_00080d3e(&local_50), iVar3 != 0)) goto LAB_0005c1ec;
          if ((char)param_5[4] == '\x04') {
            local_58[0] = 0;
            local_56 = 0x2800;
            iVar3 = FUN_00080d3e(&local_50,local_58);
            if (iVar3 != 0) {
              local_54[0] = 0;
              local_52 = 0x2801;
              iVar3 = FUN_00080d3e(&local_50,local_54);
              if (iVar3 != 0) {
                local_3c._0_2_ = (ushort)local_3c & 0xff00;
                local_3c = (char *)CONCAT22(0x2802,(ushort)local_3c);
                iVar3 = FUN_00080d3e(&local_50,&local_3c);
                if (iVar3 != 0) {
                  local_3c._0_2_ = (ushort)local_3c & 0xff00;
