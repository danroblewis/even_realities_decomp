...

{
  ...
  if ((BLE_ATTRIBUTE_TABLE == param_1) &&
     (iVar1 = memcmp_byte_arrays(&DAT_2000af4d,param_2,7,(uint)BLE_ATTRIBUTE_TABLE,param_4),
     iVar1 == 0)) {
LAB_0005e66e:
    puVar2 = &BLE_ATTRIBUTE_TABLE + iVar1;
  }
  else {
    iVar1 = memcmp_byte_arrays(&DAT_2000af4d,&DAT_000f2b3a,7);
    uVar3 = (uint)BLE_ATTRIBUTE_TABLE_MANAGEMENT_STATE;
    if (iVar1 == 0) {
      iVar1 = 0;
      if ((uVar3 == param_1) &&
...
LAB_0005e66c:
    ...
    iVar4 = iVar1 * 0x5c;
    (&BLE_ATTRIBUTE_TABLE)[iVar4] = (char)param_1;
    puVar2 = &BLE_ATTRIBUTE_TABLE + iVar4;
