/*
 * Function: handle_interrupt_configuration_and_callback
 * Entry:    00067600
 * Prototype: undefined handle_interrupt_configuration_and_callback()
 */


void handle_interrupt_configuration_and_callback(int param_1,int *param_2)

{
  ...
  if (*param_2 == 0) {
    ...
    trigger_system_service_call("WEST_TOPDIR/modules/hal/nordic/nrfx/drivers/src/nrfx_twim.c",0x297)
    ;
  }
  iVar2 = clear_all_ble_connection_fields(param_1,2);
  iVar3 = clear_all_ble_connection_fields(param_1,0x200);
  if (iVar3 == 0) {
    ...
    if (iVar2 == 0) {
      *(int *)(param_1 + 0x308) = param_2[2];
      param_2[2] = 2;
      *(int *)(param_1 + 0x304) = param_2[2];
      iVar2 = clear_all_ble_connection_fields(param_1,0x1000000);
...
LAB_00067670:
    if ((-1 < param_2[7] << 0x19) && (*(char *)((int)param_2 + 0x23) == '\0')) {
      bVar1 = validate_interrupt_configuration_parameters(param_1,param_2);
