/*
 * Function: map_ble_handle_to_index
 * Entry:    0005a9f4
 * Prototype: undefined map_ble_handle_to_index()
 */


uint map_ble_handle_to_index(uint param_1)

{
  ...
  if ((param_1 != 0) && (uVar1 = (uint)*(ushort *)(param_1 + 0x10), uVar1 == 0)) {
    puVar2 = &BT_CONNECTION_CALLBACK_LIST_END;
    uVar4 = 1;
    while( true ) {
