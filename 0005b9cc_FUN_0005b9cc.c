    ...
    if (*(ushort *)(param_2 + 2) <= *(ushort *)((int)param_2 + 0xe)) {
      ...
      case 4:
        if (*param_2 != 0) {
          local_28[0] = '\0';
          local_26 = 0x2800;
          iVar3 = FUN_00080d3e(*param_2,local_28);
          if (iVar3 == 0) {
            return 0xffffffea;
          }
          local_24[0] = '\0';
          local_22 = 0x2801;
          iVar3 = FUN_00080d3e(*param_2,local_24);
          if (iVar3 == 0) {
            return 0xffffffea;
          }
          local_20[0] = '\0';
          local_1e = 0x2802;
          iVar3 = FUN_00080d3e(*param_2,local_20);
          if (iVar3 == 0) {
            return 0xffffffea;
          }
          local_1c[0] = '\0';
          local_1a = 0x2803;
          iVar3 = FUN_00080d3e(*param_2,local_1c);
          if (iVar3 == 0) {
            return 0xffffffea;
          }
        }
      ...
      case 6:
        ...
        local_26 = 0x2900;
        local_28[0] = cVar1;
        iVar3 = FUN_00080d3e(pcVar2,local_28);
        if (iVar3 != 0) {
          local_22 = 0x2902;
          local_24[0] = cVar1;
          iVar3 = FUN_00080d3e(*param_2,local_24);
...
switchD_0005ba66_caseD_7:
  ...
  FUN_0007e2ec("WEST_TOPDIR/zephyr/subsys/bluetooth/host/gatt.c",uVar4);
}
