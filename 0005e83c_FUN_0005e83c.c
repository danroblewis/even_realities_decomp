...

{
  ...
  if (param_2 == (char *)0x0) {
    ...
    FUN_0007e2ec("WEST_TOPDIR/zephyr/subsys/bluetooth/host/keys.c",0xe9);
  }
...
LAB_0005e904:
      if ((DAT_2000af4c != param_1) || (iVar2 = FUN_00080ca0(&DAT_2000af76,param_2 + 1), iVar2 == 0)
         ) goto LAB_0005e8a2;
      iVar2 = 0;
    }
    else {
...
LAB_0005e8aa:
      if ((DAT_2000afa8 != param_1) || (iVar2 = FUN_00080ca0(&DAT_2000afd2,param_2 + 1), iVar2 == 0)
         ) goto LAB_0005e85e;
      iVar2 = 0x5c;
    }
