/*
 * Function: FUN_00024dac
 * Entry:    00024dac
 * Prototype: undefined FUN_00024dac()
 */


int FUN_00024dac(undefined4 param_1,uint param_2,undefined4 param_3,undefined4 param_4)

{
  ...
  if (iVar2 == 0) {
    if (((byte)((char)local_18 + 0x1fU) < 2) && ((local_18._1_1_ & 0xfc) == 0x40)) {
      ...
      DAT_20007a1a = sVar1;
      while ((iVar2 = FUN_00025788(DAT_20007a44,DAT_20007a20,&local_1c,4,param_1), iVar2 == 0 &&
             (DAT_20007a20 < uVar4))) {
        if ((local_1c & 0xff) == 3) {
          if (local_1c._1_1_ == 0) {
            local_1c._0_1_ = 1;
