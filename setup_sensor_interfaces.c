/*
 * Function: setup_sensor_interfaces
 * Entry:    00086596
 * Prototype: undefined setup_sensor_interfaces()
 */


uint setup_sensor_interfaces(undefined4 *param_1)

{
  ...
  if (-1 < iVar6 << 0x1e) {
    iVar8 = param_1[2];
    iVar2 = initialize_ble_protocol(param_1 + 3,2);
    if (iVar2 != 0) {
