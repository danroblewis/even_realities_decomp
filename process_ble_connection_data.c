/*
 * Function: process_ble_connection_data
 * Entry:    00071c20
 * Prototype: undefined process_ble_connection_data()
 */


int process_ble_connection_data(int param_1,int *param_2,int param_3,int param_4)

{
  ...
  piVar9 = param_2;
  iVar5 = param_3;
  iVar3 = check_connection_state_validity(iVar6);
  if (iVar3 == 0) {
    ...
    if (puVar4 == (undefined4 *)0x0) {
      if (param_3 != 0 || param_4 != 0) {
        iVar6 = handle_ble_connection_state_transition(iVar6,uVar7,param_1,0,param_3,param_4,iVar5);
        if (iVar6 != 0) {
          return iVar6;
        }
    ...
    iVar3 = validate_and_clear_connection_state(iVar6);
    if (iVar3 != 0) {
      bVar1 = (bool)isCurrentModePrivileged();
      if (bVar1) {
