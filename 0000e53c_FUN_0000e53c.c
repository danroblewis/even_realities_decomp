/*
 * Function: FUN_0000e53c
 * Entry:    0000e53c
 * Prototype: undefined FUN_0000e53c()
 */


void FUN_0000e53c(float param_1,float param_2,float param_3,undefined4 param_4,undefined4 param_5,
...

{
  ...
  *(undefined1 *)(param_8 + 0x5d3) = uVar6;
  uVar12 = FUN_0000e954(iVar10);
  uVar12 = FUN_0008693c(fVar15,uVar12);
  uVar13 = FUN_0000e9b4(iVar10);
  fVar16 = (float)FUN_00086902(uVar12,uVar13);
  local_54 = *(float *)(param_7 + 0x324) == fVar16;
  local_53 = *(float *)(param_7 + 0x328) == fVar16;
  local_52 = *(float *)(param_7 + 0x32c) == fVar16;
  FUN_0000ea18(&local_54,aiStack_3c,auStack_50);
  if (local_4c == 0) {
    fVar16 = (float)FUN_0000eb7c(fVar16,iVar10,param_7 + 0x1578);
  }
  else {
    fVar16 = local_48[0];
    if (0 < local_4c) {
...
LAB_0000e8ae:
  ...
  fVar14 = (float)FUN_000868fc((param_1 - fVar14) / fVar18);
