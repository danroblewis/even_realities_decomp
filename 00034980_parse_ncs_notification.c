...

{
  ...
  if (iVar1 != 0) {
    ...
    if (iVar3 != 0) {
      FUN_0008705a(param_2 + 4,*(undefined4 *)(iVar3 + 0x10),0x1f);
      iVar3 = FUN_0000eefe(*(undefined4 *)(iVar3 + 0x10),"com.android.phone_incall");
      if (iVar3 == 0) {
        uVar10 = FUN_0007d224();
        param_2[1] = uVar10;
      }
    ...
    if (iVar4 != 0) {
      FUN_0008705a(param_2 + 0x14,*(undefined4 *)(iVar4 + 0x10),0x1f);
    }
    if (iVar6 != 0) {
      FUN_0008705a(param_2 + 0x24,*(undefined4 *)(iVar6 + 0x10),0xff);
    }
    if (iVar5 != 0) {
      FUN_0008705a(param_2 + 0x1c,*(undefined4 *)(iVar5 + 0x10),0x1f);
    }
    if (iVar7 != 0) {
      FUN_0008705a(param_2 + 100,*(undefined4 *)(iVar7 + 0x10),0x20);
    }
    if (iVar8 != 0) {
      FUN_0008705a(param_2 + 0xc,*(undefined4 *)(iVar8 + 0x10),0x1f);
    }
    if (iVar9 != 0) {
    ...
    *param_2 = uVar10;
    FUN_00064b1c(iVar1);
    FUN_0004a3d0("#device-receiver",param_2);
    return;
  }
  if (0 < LOG_LEVEL) {
    if (IS_DEBUG != 0) {
