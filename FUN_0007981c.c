/*
 * Function: FUN_0007981c
 * Entry:    0007981c
 * Prototype: undefined FUN_0007981c()
 */


/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */

int FUN_0007981c(int param_1,undefined4 param_2,uint param_3)

{
  ...
  if (param_3 < 0x181) {
    ...
    *(undefined1 *)((int)&DAT_2000ce18 + param_3) = 0x80;
    ...
    iVar1 = FUN_0007ab2c(auStack_9c,local_ec,0x100);
    if (iVar1 == 0) {
      puVar3 = auStack_cc;
      do {
        ...
        do {
          ...
          iVar1 = FUN_0007ab70(auStack_9c,1,&local_fc);
          if (uVar5 < 0x11) {
            uVar5 = 0;
          }
          else {
      ...
      iVar1 = FUN_0007ab2c(auStack_9c,auStack_cc,0x100);
      if (iVar1 == 0) {
        iVar2 = param_1;
        while (iVar1 = FUN_0007ab70(auStack_9c,1,auStack_ac), iVar1 == 0) {
          iVar1 = iVar2 + 0x10;
          memcpy(iVar2,auStack_ac);
          iVar2 = iVar1;
          if (param_1 + 0x30 == iVar1) {
            FUN_0007ab20(auStack_9c);
