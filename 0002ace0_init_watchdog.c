...

{
  ...
  iVar1 = FUN_0008638c(&DAT_00087cc8);
  if (iVar1 == 0) {
    if (0 < LOG_LEVEL) {
      if (IS_DEBUG == 0) {
    ...
    DAT_20007b50 = FUN_00063984(&DAT_00087cc8,&uStack_30);
    if (DAT_20007b50 == -0x86) {
      if (0 < LOG_LEVEL) {
        if (IS_DEBUG == 0) {
    ...
    if (DAT_20007b50 < 0) {
      ...
      iVar1 = FUN_00084cb0(&DAT_00087cc8,2);
      if (iVar1 < 0) {
        if (LOG_LEVEL < 1) {
          return 0;
        }
        ...
        do {
          ...
          iVar2 = FUN_00084c7e(&DAT_00087cc8,DAT_20007b50);
          if (iVar2 == 0) break;
