/*
 * Function: FUN_00058f80
 * Entry:    00058f80
 * Prototype: undefined FUN_00058f80()
 */


undefined4 FUN_00058f80(int *param_1,int param_2)

{
  ...
  do {
    if (*(int *)(*param_1 + 0x28) == 0) {
      if (iVar6 == 0) {
        iVar6 = FUN_00058f34(param_1,0x19,0);
        if (iVar6 == 0) {
          return 0xe;
        }
...
LAB_000590a6:
    ...
    if (cVar1 == '\x01') {
      iVar6 = FUN_00058c34(param_1,0x18,0,sVar3,*(undefined2 *)(iVar4 + 0x1a),DAT_200029a0,
                           DAT_200029a4);
      if (iVar6 != 0) {
