/*
 * Function: FUN_0004f0ec
 * Entry:    0004f0ec
 * Prototype: undefined FUN_0004f0ec()
 */


int FUN_0004f0ec(undefined4 *param_1,int param_2,undefined4 param_3,undefined4 param_4)
    ...
    if (iVar1 == 0) {
      ...
      *(undefined2 *)((int)param_1 + 0x856) = *(undefined2 *)(param_1 + 4);
      ...
      if (iVar1 != 0) {
        ...
        local_30 = 3;
        iStack_28 = iVar1;
        FUN_0004d944(&DAT_000880e8,0x1840,&local_30,0);
      }
    }
    else {
      iVar1 = -0x78;
