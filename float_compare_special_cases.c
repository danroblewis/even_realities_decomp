/*
 * Function: float_compare_special_cases
 * Entry:    0000dcba
 * Prototype: undefined float_compare_special_cases()
 */


ulonglong float_compare_special_cases(uint param_1,uint param_2,uint param_3,uint param_4)
