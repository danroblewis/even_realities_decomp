/*
 * Function: FUN_00054dd8
 * Entry:    00054dd8
 * Prototype: undefined FUN_00054dd8()
 */
...

{
    ...
    if (iVar4 == 0) {
      ...
      if (-1 < (int)((uint)*(byte *)(iVar4 + 8) << 0x1d)) {
        if ((param_2[1] == 0) && ((int)((uint)*(byte *)(param_1 + 8) << 0x1d) < 0)) {
          iVar1 = FUN_00080fa4(iVar4 + 1,param_1 + 1);
  ...
  FUN_0007e2ec("WEST_TOPDIR/zephyr/subsys/bluetooth/host/id.c",uVar3);
}
