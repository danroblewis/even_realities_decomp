/*
 * Function: set_interrupt_configuration_values_simple
 * Entry:    000675c0
 * Prototype: undefined set_interrupt_configuration_values_simple()
 */


void set_interrupt_configuration_values_simple(int *param_1,undefined4 *param_2)
