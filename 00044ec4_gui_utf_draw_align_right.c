        ...
        if (iVar3 == 0) {
          ...
          if (iVar4 < 0) {
            ...
            if (param_6 - param_4 < local_2f4) {
              ...
              FUN_0007d53a(DAT_2000a034,local_2cc,iVar4,iVar1,local_2e8,uVar8 + param_5);
              iVar3 = FUN_00043e58(*puVar2,*puVar13);
              local_2f8 = iVar3 + local_2d4;
              local_2f4 = local_2f8;
            }
            else {
              FUN_0007d53a(DAT_2000a034,local_2cc,iVar4,iVar1,local_2e8 + local_2f8,uVar8 + param_5)
              ;
              iVar3 = FUN_00043e58(*puVar2,*puVar13);
