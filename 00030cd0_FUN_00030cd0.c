/*
 * Function: FUN_00030cd0
 * Entry:    00030cd0
 * Prototype: undefined FUN_00030cd0()
 */


undefined4 FUN_00030cd0(int param_1,int param_2,undefined1 *param_3,int param_4)

{
  ...
  if (iVar1 == 0) {
    if ((uStack_14 & 0x6000000) == 0) {
      iVar1 = FUN_000256dc(param_2,0x2008,param_3,param_4);
      if (iVar1 == 0) {
