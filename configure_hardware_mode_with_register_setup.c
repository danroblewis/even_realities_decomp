/*
 * Function: configure_hardware_mode_with_register_setup
 * Entry:    00065324
 * Prototype: undefined __stdcall configure_hardware_mode_with_register_setup(undefined4 hardware_mode, undefined4 status_pointer)
 */


/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */

void configure_hardware_mode_with_register_setup(undefined4 hardware_mode,undefined4 status_pointer)

{
  ...
  case 3:
    ...
    break;
  default:
    uStack_14 = status_pointer;
    DEBUG_PRINT2("ASSERTION FAIL [%s] @ %s:%d\n","0",
                 "WEST_TOPDIR/modules/hal/nordic/nrfx/drivers/src/nrfx_clock.c",0xd8,hardware_mode);
    uVar3 = 0xd8;
  ...
  pbVar4 = (byte *)0x0;
LAB_0006503e:
  uStack_14 = CONCAT13(1,(int3)status_pointer);
  switch(hardware_mode) {
  case 0:
    iVar5 = 10000;
    do {
      ...
      handle_ble_uart_packet_processing_completion(cVar1);
      iVar5 = iVar5 + -1;
    } while (iVar5 != 0);
    break;
  case 1:
  ...
  default:
    DEBUG_PRINT2("ASSERTION FAIL [%s] @ %s:%d\n","0",
                 "WEST_TOPDIR/modules/hal/nordic/nrfx/hal/nrf_clock.h",0x3cb,hardware_mode);
    uVar3 = 0x3cb;
