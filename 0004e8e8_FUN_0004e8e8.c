/*
 * Function: FUN_0004e8e8
 * Entry:    0004e8e8
 * Prototype: undefined FUN_0004e8e8()
 */


int FUN_0004e8e8(int param_1,undefined4 param_2,undefined4 param_3,undefined4 param_4)

{
  ...
  if (0x74 < uVar4) {
    ...
    FUN_0007e2ec("WEST_TOPDIR/nrf/subsys/bluetooth/gatt_dm.c",0x5b);
  }
  puVar3 = DAT_2000a2a4;
  if ((DAT_2000a2a4 == (undefined4 *)0x0) ||
     (puVar3 = (undefined4 *)(DAT_2000a2ac + uVar4), &DAT_00000074 < puVar3)) {
    puVar3 = (undefined4 *)FUN_000868ca(1,0x78,param_3,puVar3,param_4);
