...

{
  ...
  local_30 = 0;
  local_2c[0] = 0;
  iVar1 = FUN_0000ef12(str_buffer);
  iVar2 = FUN_000431a8();
  if (iVar2 << 0x1e < 0) {
    _clean_fb_data(DAT_2000a034,0,param_3,param_4,param_5,param_6);
  }
  iVar2 = param_3;
  pbVar5 = str_buffer;
  do {
...
LAB_00045688:
      ...
      if ((local_2c[0] == 0) || (iVar3 != 0)) {
        ...
        FUN_0007d53a(DAT_2000a034,local_2c[0],local_34 / 2,local_30,iVar2,param_4);
        if ((*pbVar5 - 0x20 < 0x5f) && (param_1 == 3)) {
          iVar2 = local_34 + iVar2 + 3;
        }
        else {
          iVar2 = iVar2 + local_34;
          iVar3 = FUN_00043e58((uint)*pbVar5,pbVar5[1]);
          iVar2 = iVar2 + iVar3;
        }
      }
    }
