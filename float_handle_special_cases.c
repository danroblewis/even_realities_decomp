/*
 * Function: float_handle_special_cases
 * Entry:    0000dad4
 * Prototype: undefined float_handle_special_cases()
 */


ulonglong float_handle_special_cases(uint param_1,uint param_2,uint param_3,uint param_4)
