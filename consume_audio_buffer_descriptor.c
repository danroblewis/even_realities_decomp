/*
 * Function: consume_audio_buffer_descriptor
 * Entry:    00085734
 * Prototype: undefined consume_audio_buffer_descriptor()
 */


int consume_audio_buffer_descriptor(int param_1,undefined4 *param_2,undefined2 *param_3)
