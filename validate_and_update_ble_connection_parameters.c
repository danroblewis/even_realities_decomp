/*
 * Function: validate_and_update_ble_connection_parameters
 * Entry:    0008157a
 * Prototype: undefined validate_and_update_ble_connection_parameters()
 */


uint validate_and_update_ble_connection_parameters(int param_1,ushort *param_2)

{
  ...
  if ((((*(ushort *)(param_1 + 0xa6) < *param_2) || (param_2[1] < *(ushort *)(param_1 + 0xa6))) ||
    ...
    if ((int)(*puVar1 << 0x18) < 0) {
      uVar2 = bt_connection_disconnect_with_validation_and_state_management(param_1);
      return uVar2;
    }
