/*
 * Function: initialize_ble_attribute_with_properties
 * Entry:    0005e47c
 * Prototype: undefined initialize_ble_attribute_with_properties()
 */


void initialize_ble_attribute_with_properties(int param_1)

{
  ...
  if (*(int *)(param_1 + 0xc0) != 0) {
    cleanup_ble_attribute();
  }
  iVar2 = initialize_ble_attribute(*(undefined1 *)(param_1 + 8),param_1 + 0x90);
