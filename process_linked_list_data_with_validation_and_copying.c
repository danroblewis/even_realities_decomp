/*
 * Function: process_linked_list_data_with_validation_and_copying
 * Entry:    0007c77e
 * Prototype: undefined process_linked_list_data_with_validation_and_copying()
 */


int process_linked_list_data_with_validation_and_copying
...

{
  ...
  if ((param_2 == (int *)0x0) || (*param_2 == 0)) {
    ...
    iVar2 = calculate_total_value_and_count_from_linked_list(param_1,&local_28);
    piVar1 = local_28;
    if ((iVar2 == 0) && (piVar5 = (int *)param_2[1], local_28 <= piVar5)) {
      ...
      if (param_1 != (int *)0x0) {
        ...
        for (iVar2 = *param_1; iVar2 != 0; iVar2 = *(int *)(iVar2 + 0x18)) {
          ...
          local_1c = piVar5;
          iVar3 = process_data_with_conditional_copying_and_validation(iVar2,&local_20);
          if (iVar3 != 0) {
