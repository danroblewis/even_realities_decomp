...
LAB_0003d4ba:
    ...
    lVar17 = FUN_0000e1a4(DAT_200049b0 - uVar6,(DAT_200049b4 - iVar5) - (uint)(DAT_200049b0 < uVar6)
                          ,1000,0);
  ...
  case 2:
    ...
    if (param_3 == 1) {
      ...
      if (TELEPROMPTER_ACTIVE_FLAG == '\x01') {
        ...
        iVar12 = get_ui_x_offset();
        iVar13 = get_ui_y_offset();
        FUN_000440ec(0,&DAT_200049b8,0,iVar8 + 0x58,iVar11 + 1,iVar12 + 0x230,iVar13 + 0x88,5,uVar4)
        ;
      }
      else {
        iVar8 = get_ui_x_offset();
