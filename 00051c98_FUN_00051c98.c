/*
 * Function: FUN_00051c98
 * Entry:    00051c98
 * Prototype: undefined FUN_00051c98()
 */


undefined4 FUN_00051c98(int param_1,uint param_2,undefined4 param_3,undefined4 param_4)

{
  ...
  uStack_24 = param_2;
  uVar2 = FUN_0008099e(iVar6,"images",6,param_4,param_1);
  if (uVar2 != 0) {
...
LAB_00051cde:
    ...
    if (iVar7 == 2) {
      ...
      if (((iVar7 != 0) && (iVar7 = FUN_0008099e(iVar6,"splitStatus",0xb), iVar7 != 0)) &&
