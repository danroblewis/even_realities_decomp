/*
 * Function: manage_timer_interrupt_state_and_driver
 * Entry:    000639d4
 * Prototype: undefined manage_timer_interrupt_state_and_driver()
 */


undefined4 manage_timer_interrupt_state_and_driver(int param_1)
