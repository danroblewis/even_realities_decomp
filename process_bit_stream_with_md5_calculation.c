/*
 * Function: process_bit_stream_with_md5_calculation
 * Entry:    0007d8f4
 * Prototype: undefined process_bit_stream_with_md5_calculation()
 */


void process_bit_stream_with_md5_calculation
               (uint *param_1,int param_2,uint param_3,undefined4 param_4)
