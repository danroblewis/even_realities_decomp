/*
 * Function: FUN_0007a50c
 * Entry:    0007a50c
 * Prototype: undefined FUN_0007a50c(undefined param_1, undefined param_2, undefined param_3, undefined param_4, undefined4 param_5)
 */


/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */

int FUN_0007a50c(uint *param_1,int param_2,int param_3,int *param_4,int param_5)

{
  ...
  if (((param_1 != (uint *)0x0) && (param_2 != 0)) && (param_4 != (int *)0x0)) {
    ...
    if (*param_4 == 0) {
      ...
      iVar1 = FUN_0007b0ec(param_2,param_4);
      if ((iVar1 == 0) && (iVar1 = FUN_0007b0b8(*param_4,param_2), iVar1 == 0)) {
        iVar1 = *param_4;
        if (iVar1 == 8) {
          _DAT_5084510c = 3;
        }
