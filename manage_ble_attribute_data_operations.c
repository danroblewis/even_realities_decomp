/*
 * Function: manage_ble_attribute_data_operations
 * Entry:    0005c4f0
 * Prototype: undefined manage_ble_attribute_data_operations()
 */


int manage_ble_attribute_data_operations
          ...
          if (bVar4) {
            ...
            if (bVar6) {
              ...
              *(undefined2 *)(param_2 + 4) = 0;
              iVar2 = initialize_ble_attribute_data(param_1,param_2);
              if (iVar2 != 0) {
                return iVar2;
              }
              FUN_00082ab8(iVar1 + 8,param_2 + 6);
