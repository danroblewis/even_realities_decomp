/*
 * Function: FUN_000767c8
 * Entry:    000767c8
 * Prototype: undefined FUN_000767c8()
 */


uint FUN_000767c8(undefined4 param_1,undefined4 param_2,undefined4 param_3)

{
  ...
  if ((int)uVar5 < 0x14) {
    if ((int)uVar5 < 0) {
      ...
      uVar8 = FUN_0000d58c(uVar6,uVar7);
      uVar2 = FUN_0000d588((int)uVar8,(int)((ulonglong)uVar8 >> 0x20),uVar6,uVar7);
      return uVar2;
    }
  ...
  uVar6 = *(undefined4 *)(&DAT_000888a8 + iVar1);
  uVar7 = *(undefined4 *)(&DAT_000888ac + iVar1);
  uVar8 = FUN_0000d58c(uVar6,uVar7,uVar3,uVar4,param_1,param_2,param_3);
  uVar2 = FUN_0000d588((int)uVar8,(int)((ulonglong)uVar8 >> 0x20),uVar6,uVar7);
  return uVar2;
}
