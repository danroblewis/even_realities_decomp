/*
 * Function: process_audio_data_with_callback_execution
 * Entry:    00070e28
 * Prototype: undefined process_audio_data_with_callback_execution(undefined param_1, undefined param_2, undefined param_3, undefined param_4, undefined4 param_5)
 */


int process_audio_data_with_callback_execution
  ...
  if (param_1 == 0) {
    ...
    if (*(uint *)(param_1 + 0x28) < param_3) {
      ...
      for (uVar4 = 0; uVar4 != param_3; uVar4 = uVar4 + 1) {
        ...
        iVar1 = initialize_buffer_descriptor
                          (param_1,uVar4 & 0xffff,*(undefined4 *)(param_4 + uVar4 * 4),iVar1 + 4,
