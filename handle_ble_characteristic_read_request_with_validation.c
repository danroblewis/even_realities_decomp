/*
 * Function: handle_ble_characteristic_read_request_with_validation
 * Entry:    00082e04
 * Prototype: undefined handle_ble_characteristic_read_request_with_validation(undefined param_1, undefined param_2, undefined param_3, undefined param_4, undefined4 param_5)
 */


void handle_ble_characteristic_read_request_with_validation
...
LAB_0005c326:
  ...
  iVar2 = handle_ble_connection_state_change_with_characteristic_processing
                    (param_1,&DAT_00082603,param_5,uVar3,0x18,1);
LAB_0005c34c:
  if (iVar2 != 0) {
