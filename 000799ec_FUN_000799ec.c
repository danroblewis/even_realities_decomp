/*
 * Function: FUN_000799ec
 * Entry:    000799ec
 * Prototype: undefined FUN_000799ec()
 */


int FUN_000799ec(char *param_1,uint *param_2)

{
  ...
  do {
    ...
    iVar2 = FUN_0007ab70(param_1 + 0x20,1,param_1,puVar3);
  ...
  iVar2 = FUN_0007ab2c(param_1 + 0x20,&local_48,0x100);
  if (iVar2 == 0) {
