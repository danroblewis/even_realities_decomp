...

{
  ...
  uVar7 = FUN_000232b0();
  FUN_00086ffe(&DAT_2000ff74,uVar7,0x13);
  iVar6 = get_work_mode();
...
LAB_000194c0:
        FUN_00086f00(&DAT_2000ff87,0,0x20,pcVar9,"Even G1",uVar1,uVar2,uVar3);
        goto LAB_000193e4;
      }
      iVar6 = get_work_mode();
...
LAB_00019492:
      FUN_00086f00(&DAT_2000ff87,0,0x20,pcVar9,"Even G1",uVar1,uVar2,uVar3,uVar4);
      goto LAB_000193e4;
    }
    iVar6 = get_work_mode();
    if (*(char *)(iVar6 + 2) == -1) {
...
LAB_00019452:
      FUN_00086f00(&DAT_2000ff87,0,0x20,pcVar9,"Even G1",1,4,5,uVar1,uVar2,uVar3);
      goto LAB_000193e4;
    }
    iVar6 = get_work_mode();
    uVar1 = *(undefined1 *)(iVar6 + 2);
  ...
  FUN_00086f00(&DAT_2000ff87,0,0x20,pcVar9,"Even G1",1,4,5,uVar1,uVar2,uVar3,uVar4);
LAB_000193e4:
  DAT_20002354 = &DAT_2000ff87;
  DAT_20002351 = FUN_0000ef12(&DAT_2000ff87);
  iVar6 = FUN_00054c74(&DAT_2000ff87);
  if (iVar6 == 0) {
    local_34 = 0;
    uStack_30 = 1;
    uStack_2c = 0x160;
    uStack_28 = 0x1e0;
    local_24 = 0;
    iVar6 = FUN_00055998(&local_34,&DAT_20002358,2,&DAT_20002350,1);
    if (iVar6 == 0) {
      iVar8 = get_work_mode();
