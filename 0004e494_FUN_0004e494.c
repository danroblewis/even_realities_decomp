/*
 * Function: FUN_0004e494
 * Entry:    0004e494
 * Prototype: undefined FUN_0004e494()
 */


undefined4 FUN_0004e494(undefined4 *param_1,undefined4 param_2)

{
  ...
  while( true ) {
    if (&PTR_LAB_00051fd8_1_00088328 < ppuVar2) {
      ...
      FUN_0007e2ec("WEST_TOPDIR/zephyr/subsys/settings/src/settings.c",0x2b);
    }
    if (&UNK_00088327 < ppuVar2) break;
    uVar5 = FUN_0000eefe(*param_1,*ppuVar2);
...
LAB_0004e502:
    ...
    iVar1 = FUN_0000eefe(*param_1,puVar3[-5]);
    if (iVar1 == 0) {
      uVar4 = 0xffffffef;
      goto LAB_0004e502;
    }
