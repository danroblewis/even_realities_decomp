/*
 * Function: handle_device_data_transmission
 * Entry:    00062fe8
 * Prototype: undefined handle_device_data_transmission()
 */


undefined4 handle_device_data_transmission(int param_1,int param_2,uint param_3,int param_4)
