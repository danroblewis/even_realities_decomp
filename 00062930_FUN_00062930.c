/*
 * Function: FUN_00062930
 * Entry:    00062930
 * Prototype: undefined FUN_00062930()
 */


undefined4 FUN_00062930(int param_1)

{
  ...
  iVar1 = FUN_0008638c(**(undefined4 **)(param_1 + 4));
  if (iVar1 == 0) {
    local_14 = "Bus device is not ready";
LAB_0006294c:
    local_18 = 2;
    FUN_0004d944(&DAT_00088250,0x1040,&local_18,0);
  }
  else {
    ...
    local_40 = 3;
    FUN_0004d944(&DAT_00088250,0x1840,&local_40);
  }
  return 0xffffffea;
}
