/*
 * Function: FUN_0005bd18
 * Entry:    0005bd18
 * Prototype: undefined FUN_0005bd18(undefined param_1, undefined param_2, undefined param_3, undefined param_4, undefined4 param_5)
 */
...
LAB_0005bd6e:
      ...
      for (uVar9 = param_4 - 1; uVar9 = uVar9 & 0xffff, *param_3 <= uVar9; uVar9 = uVar9 - *param_3)
      {
        ...
        if ((*param_5 == 0) || (iVar2 = FUN_00080d3e(local_50), iVar2 == 0)) {
          local_5c[0] = 0;
          local_5a = 0x2802;
