 ...
 * Entry:    000585f0
 * Prototype: undefined FUN_000585f0()
 */


int FUN_000585f0(uint param_1,uint param_2,int param_3)
  ...
  if (iVar1 == 2) {
    ...
    if (*(int *)(param_1 + 0x148) == 0) {
      ...
      if (*(int *)(param_1 + 0x144) == 0) {
        ...
        FUN_0007e2ec("WEST_TOPDIR/zephyr/subsys/bluetooth/host/att.c",0x2cd);
      }
      iVar1 = FUN_0005f2d4();
      FUN_0005ee6c();
