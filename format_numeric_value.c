/*
 * Function: format_numeric_value
 * Entry:    000873b6
 * Prototype: undefined format_numeric_value()
 */


undefined4 format_numeric_value(int *param_1,uint *param_2,uint *param_3)
...
LAB_000873e6:
  while( true ) {
    ...
    bVar1 = *(byte *)(iVar4 + 1);
    if (bVar1 == 0) break;
    uVar2 = process_format_flags(bVar1);
    if (uVar2 != 0) {
      iVar12 = iVar12 + 1;
      iVar14 = iVar14 + 1;
    ...
    if (local_38 < iVar14) {
      if ((puVar11 < puVar5) && (iVar12 < 8)) {
        apply_format_precision(puVar11,puVar5,iVar12);
      }
      if (param_3 < puVar11) {
        puVar5 = puVar11 + -1;
        puVar11[-1] = 0;
