/*
 * Function: validate_and_process_ble_connection_parameters
 * Entry:    0005dce0
 * Prototype: undefined validate_and_process_ble_connection_parameters()
 */


undefined4 validate_and_process_ble_connection_parameters(int param_1,int param_2)

{
  ...
  if (iVar2 == 0) {
    if (uVar3 < 0xf) {
      ...
      update_ble_connection_parameters(iVar4,iVar2);
      return 0;
    }
