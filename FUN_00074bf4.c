/*
 * Function: FUN_00074bf4
 * Entry:    00074bf4
 * Prototype: undefined FUN_00074bf4()
 */


void FUN_00074bf4(int *param_1,int param_2,uint param_3,int param_4)

{
  ...
  if (*param_1 == 0) {
    ...
    iVar4 = FUN_00072040(&DAT_2000b498);
    if (iVar4 == 0) {
...
LAB_00074cf0:
      if (((int **)DAT_20002cfc != &DAT_20002cfc) && (param_1 == DAT_20002cfc)) {
        uVar5 = FUN_00074b7c();
        FUN_000638dc(uVar5,0);
      }
      iVar4 = FUN_0007205c(&DAT_2000b498);
      if (iVar4 != 0) {
        bVar1 = (bool)isCurrentModePrivileged();
        if (bVar1) {
