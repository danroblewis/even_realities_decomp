/*
 * Function: FUN_0007932c
 * Entry:    0007932c
 * Prototype: undefined FUN_0007932c()
 */


undefined4 FUN_0007932c(undefined4 param_1,uint *param_2,int *param_3,undefined4 *param_4)
...
LAB_00079384:
  do {
    iVar1 = FUN_00086bc8(local_34[iVar12],*(undefined1 *)*param_3,2);
    puVar8 = puVar11;
    if (iVar1 != 0) {
      if (iVar12 == 1) {
        if (param_2[1] == 0) {
  ...
  iVar12 = 0;
  FUN_0008789c(param_2[5],"A-Fa-f8901234567]" + (0x10 - param_2[1]));
  while( true ) {
    puVar8 = puVar11;
