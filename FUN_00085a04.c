/*
 * Function: FUN_00085a04
 * Entry:    00085a04
 * Prototype: undefined FUN_00085a04()
 */


undefined4 FUN_00085a04(int param_1,int param_2,int param_3)

{
  ...
  if (param_3 == 0x28) {
    ...
    FUN_00085496(piVar1,uVar3,auStack_38,0x20);
    iVar6 = iVar5 + 0x58;
    uVar7 = *(undefined4 *)(param_2 + 0x20);
    FUN_000859b6(iVar6);
    iVar2 = FUN_00085900(iVar5,auStack_38,0xffffffff,uVar7);
