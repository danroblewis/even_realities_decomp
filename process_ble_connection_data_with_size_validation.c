/*
 * Function: process_ble_connection_data_with_size_validation
 * Entry:    00081852
 * Prototype: undefined process_ble_connection_data_with_size_validation()
 */


uint process_ble_connection_data_with_size_validation(int param_1,int *param_2,uint param_3)

{
  ...
  iVar2 = *param_2;
  uVar4 = calculate_total_linked_list_size(iVar2);
