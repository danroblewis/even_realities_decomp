/*
 * Function: format_integer_with_sign
 * Entry:    00086daa
 * Prototype: undefined format_integer_with_sign()
 */


int format_integer_with_sign(undefined1 *param_1,uint param_2,undefined4 param_3)
