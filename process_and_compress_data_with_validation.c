/*
 * Function: process_and_compress_data_with_validation
 * Entry:    0004d944
 * Prototype: undefined process_and_compress_data_with_validation()
 */


void process_and_compress_data_with_validation
...

{
  ...
  local_48 = param_1;
  if (uVar3 == 0) {
    iVar1 = allocate_memory_with_priority_management(((param_2 >> 0x14) + 0x17 & 0xfffffff8) >> 2);
    uVar3 = 0;
  }
  else {
    local_5c = auStack_3c;
    ...
    local_60 = 10;
    local_44 = uVar3;
    local_50 = process_data_with_callback_and_validation(param_3,uVar3,0,&local_34);
    if (0x7ff < local_50) {
      ...
      local_68 = 0x1000004;
      process_and_compress_data_with_validation(&DAT_000881e0,0x2480,&local_68,0);
      return;
    }
    uVar3 = local_50 & 0x7ff;
    iVar1 = allocate_memory_with_priority_management
                      (((param_2 >> 0x14) + 0x17 + local_50 & 0xfffffff8) >> 2);
    ...
    if (iVar1 != 0) {
      ...
      local_60 = 10;
      local_58 = 4;
      iVar2 = process_data_with_callback_and_validation(param_3,local_44,0x7ee49,&local_34);
      if (iVar2 < 0) {
