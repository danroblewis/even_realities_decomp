/*
 * Function: allocate_buffer_block
 * Entry:    00076c3c
 * Prototype: undefined allocate_buffer_block()
 */


undefined4 * allocate_buffer_block(undefined4 *param_1)

{
  ...
  if (DAT_20002d3c == 0) {
    initialize_buffer_structure(&DAT_20002d24);
  }
  piVar3 = &DAT_20002d6c;
  do {
    iVar1 = piVar3[1];
