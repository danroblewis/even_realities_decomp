/*
 * Function: initialize_data_structure_with_configuration
 * Entry:    0007f6b6
 * Prototype: undefined initialize_data_structure_with_configuration()
 */


undefined4
initialize_data_structure_with_configuration
...

{
  ...
  if ((*(byte *)(param_2 + 1) < 3) && (*(byte *)((int)param_2 + 6) < 0xc)) {
    *(undefined1 *)(param_1 + 0x908) = 0;
    uVar6 = *param_2;
    iVar2 = set_bit_and_return_previous_state(param_1 + 4,2);
    if (iVar2 == 0) {
