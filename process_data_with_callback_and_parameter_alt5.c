/*
 * Function: process_data_with_callback_and_parameter_alt5
 * Entry:    00052880
 * Prototype: undefined process_data_with_callback_and_parameter_alt5()
 */


undefined4 process_data_with_callback_and_parameter_alt5(int param_1)

{
  ...
  local_58 = 0x80c8d;
  if (((iVar8 != 0) &&
      (iVar3 = bt_connection_disconnect_with_state_management_and_callback(iVar8,auStack_50),
      iVar3 == 0)) && (local_2c == '\x02')) {
    uVar4 = calculate_offset(param_1);
    if (uVar4 == 0) {
LAB_000528e0:
      uVar6 = 1;
      goto LAB_000528aa;
