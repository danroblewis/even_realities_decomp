/*
 * Function: manage_hardware_timer
 * Entry:    00063654
 * Prototype: undefined manage_hardware_timer(undefined param_1, undefined param_2, undefined param_3, undefined param_4, undefined4 param_5, undefined4 param_6, undefined1 param_7)
 */
...
manage_hardware_timer
          (uint param_1,undefined4 param_2,uint param_3,uint param_4,undefined4 param_5,int param_6,
          char param_7)

{
  ...
  uVar1 = control_timer_interrupt();
  uVar10 = get_high_resolution_timer();
...
LAB_00063722:
  ...
  param_6 = iVar6;
LAB_00063726:
  enable_timer_interrupt(param_1,uVar1,puVar5,param_6);
  return uVar7;
}
